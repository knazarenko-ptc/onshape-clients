...
/*
 * OAIBTPExpressionVarReference-245.h
 *
 * 
 */

#ifndef OAIBTPExpressionVarReference-245_H_
#define OAIBTPExpressionVarReference-245_H_
...
class OAIBTPExpressionVarReference-245: public OAIObject {
public:
    OAIBTPExpressionVarReference-245();
    OAIBTPExpressionVarReference-245(QString json);
    ~OAIBTPExpressionVarReference-245();
    void init();
    void cleanup();
    ...
    OAIBTPExpressionVarReference-245* fromJson(QString jsonString) override;
    ...
    OAIBTPName-261* getName();
    void setName(OAIBTPName-261* name);
...
#endif /* OAIBTPExpressionVarReference-245_H_ */

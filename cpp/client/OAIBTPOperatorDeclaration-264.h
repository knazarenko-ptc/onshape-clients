...
/*
 * OAIBTPOperatorDeclaration-264.h
 *
 * 
 */

#ifndef OAIBTPOperatorDeclaration-264_H_
#define OAIBTPOperatorDeclaration-264_H_
...
class OAIBTPOperatorDeclaration-264: public OAIObject {
public:
    OAIBTPOperatorDeclaration-264();
    OAIBTPOperatorDeclaration-264(QString json);
    ~OAIBTPOperatorDeclaration-264();
    void init();
    void cleanup();
    ...
    OAIBTPOperatorDeclaration-264* fromJson(QString jsonString) override;
...
#endif /* OAIBTPOperatorDeclaration-264_H_ */

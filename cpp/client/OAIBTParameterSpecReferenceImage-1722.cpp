...
OAIBTParameterSpecReferenceImage-1722::OAIBTParameterSpecReferenceImage-1722(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecReferenceImage-1722::OAIBTParameterSpecReferenceImage-1722() {
    init();
}
...
void
OAIBTParameterSpecReferenceImage-1722::init() {
...
void
OAIBTParameterSpecReferenceImage-1722::cleanup() {
...
OAIBTParameterSpecReferenceImage-1722*
OAIBTParameterSpecReferenceImage-1722::fromJson(QString json) {
...
void
OAIBTParameterSpecReferenceImage-1722::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTParameterSpecReferenceImage-1722::asJson ()
{
...
QJsonObject
OAIBTParameterSpecReferenceImage-1722::asJsonObject() {
    QJsonObject obj;
...
qint32
OAIBTParameterSpecReferenceImage-1722::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecReferenceImage-1722::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecReferenceImage-1722::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecReferenceImage-1722::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecReferenceImage-1722::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecReferenceImage-1722::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecReferenceImage-1722::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecReferenceImage-1722::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecReferenceImage-1722::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecReferenceImage-1722::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecReferenceImage-1722::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecReferenceImage-1722::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceImage-1722::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecReferenceImage-1722::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceImage-1722::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecReferenceImage-1722::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecReferenceImage-1722::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecReferenceImage-1722::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceImage-1722::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecReferenceImage-1722::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecReferenceImage-1722::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecReferenceImage-1722::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceImage-1722::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecReferenceImage-1722::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecReferenceImage-1722::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecReferenceImage-1722::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
...
bool
OAIBTParameterSpecReferenceImage-1722::isSet(){

...
/*
 * OAIBTParameterSpecArray-2600.h
 *
 * 
 */

#ifndef OAIBTParameterSpecArray-2600_H_
#define OAIBTParameterSpecArray-2600_H_
...
class OAIBTParameterSpecArray-2600: public OAIObject {
public:
    OAIBTParameterSpecArray-2600();
    OAIBTParameterSpecArray-2600(QString json);
    ~OAIBTParameterSpecArray-2600();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecArray-2600* fromJson(QString jsonString) override;
    ...
    QString* getItemLabelTemplate();
    void setItemLabelTemplate(QString* item_label_template);

    QString* getDrivenQuery();
    void setDrivenQuery(QString* driven_query);
...
private:
    ...
    QString* item_label_template;
    bool m_item_label_template_isSet;

    QString* driven_query;
    bool m_driven_query_isSet;

};

}

#endif /* OAIBTParameterSpecArray-2600_H_ */

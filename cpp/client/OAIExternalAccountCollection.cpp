...
OAIExternalAccountCollection::OAIExternalAccountCollection(QString json) {
    init();
    this->fromJson(json);
}

OAIExternalAccountCollection::OAIExternalAccountCollection() {
    init();
}
...
void
OAIExternalAccountCollection::init() {
    count = 0;
    m_count_isSet = false;
    data = new QList<OAIExternalAccount*>();
    m_data_isSet = false;
    has_more = false;
...
void
OAIExternalAccountCollection::cleanup() {
...
OAIExternalAccountCollection::fromJson(QString json) {
...
void
OAIExternalAccountCollection::fromJsonObject(QJsonObject pJson) {
    ::OpenAPI::setValue(&count, pJson["count"], "qint32", "");
    
    
    ::OpenAPI::setValue(&data, pJson["data"], "QList", "OAIExternalAccount");
...
QString
OAIExternalAccountCollection::asJson ()
{
...
QJsonObject
OAIExternalAccountCollection::asJsonObject() {
    QJsonObject obj;
    if(m_count_isSet){
        obj.insert("count", QJsonValue(count));
    }
    if(data->size() > 0){
        toJsonArray((QList<void*>*)data, obj, "data", "OAIExternalAccount");
    }
    if(m_has_more_isSet){
...
qint32
OAIExternalAccountCollection::getCount() {
    return count;
}
void
OAIExternalAccountCollection::setCount(qint32 count) {
    this->count = count;
    this->m_count_isSet = true;
}

QList<OAIExternalAccount*>*
OAIExternalAccountCollection::getData() {
    return data;
}
void
OAIExternalAccountCollection::setData(QList<OAIExternalAccount*>* data) {
    this->data = data;
    this->m_data_isSet = true;
}

bool
OAIExternalAccountCollection::isHasMore() {
    return has_more;
}
void
OAIExternalAccountCollection::setHasMore(bool has_more) {
    this->has_more = has_more;
    this->m_has_more_isSet = true;
}

OAIRequestOptions*
OAIExternalAccountCollection::getRequestOptions() {
    return request_options;
}
void
OAIExternalAccountCollection::setRequestOptions(OAIRequestOptions* request_options) {
    this->request_options = request_options;
    this->m_request_options_isSet = true;
}

QMap<QString, OAIObject*>*
OAIExternalAccountCollection::getRequestParams() {
    return request_params;
}
void
OAIExternalAccountCollection::setRequestParams(QMap<QString, OAIObject*>* request_params) {
    this->request_params = request_params;
    this->m_request_params_isSet = true;
}

qint32
OAIExternalAccountCollection::getTotalCount() {
    return total_count;
}
void
OAIExternalAccountCollection::setTotalCount(qint32 total_count) {
    this->total_count = total_count;
    this->m_total_count_isSet = true;
}

QString*
OAIExternalAccountCollection::getUrl() {
    return url;
}
void
OAIExternalAccountCollection::setUrl(QString* url) {
    this->url = url;
...
bool
OAIExternalAccountCollection::isSet(){

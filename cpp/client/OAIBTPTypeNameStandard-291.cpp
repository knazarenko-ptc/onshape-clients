...
OAIBTPTypeNameStandard-291::OAIBTPTypeNameStandard-291(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPTypeNameStandard-291::OAIBTPTypeNameStandard-291() {
    init();
}
...
void
OAIBTPTypeNameStandard-291::init() {
    atomic = false;
...
void
OAIBTPTypeNameStandard-291::cleanup() {
...
OAIBTPTypeNameStandard-291::fromJson(QString json) {
...
void
OAIBTPTypeNameStandard-291::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPTypeNameStandard-291::asJson ()
{
...
QJsonObject
OAIBTPTypeNameStandard-291::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPTypeNameStandard-291::isAtomic() {
    return atomic;
}
void
OAIBTPTypeNameStandard-291::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPTypeNameStandard-291::getBtType() {
    return bt_type;
}
void
OAIBTPTypeNameStandard-291::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPTypeNameStandard-291::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPTypeNameStandard-291::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPTypeNameStandard-291::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPTypeNameStandard-291::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPTypeNameStandard-291::getNodeId() {
    return node_id;
}
void
OAIBTPTypeNameStandard-291::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPTypeNameStandard-291::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPTypeNameStandard-291::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPTypeNameStandard-291::getSpaceAfter() {
    return space_after;
}
void
OAIBTPTypeNameStandard-291::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPTypeNameStandard-291::getSpaceBefore() {
    return space_before;
}
void
OAIBTPTypeNameStandard-291::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPTypeNameStandard-291::isSpaceDefault() {
    return space_default;
}
void
OAIBTPTypeNameStandard-291::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPTypeNameStandard-291::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPTypeNameStandard-291::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

QString*
OAIBTPTypeNameStandard-291::getType() {
    return type;
}
void
OAIBTPTypeNameStandard-291::setType(QString* type) {
    this->type = type;
...
bool
OAIBTPTypeNameStandard-291::isSet(){

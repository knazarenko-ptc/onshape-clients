...
/*
 * OAIBTParameterSpecReferenceCADImport-1792.h
 *
 * 
 */

#ifndef OAIBTParameterSpecReferenceCADImport-1792_H_
#define OAIBTParameterSpecReferenceCADImport-1792_H_
...
class OAIBTParameterSpecReferenceCADImport-1792: public OAIObject {
public:
    OAIBTParameterSpecReferenceCADImport-1792();
    OAIBTParameterSpecReferenceCADImport-1792(QString json);
    ~OAIBTParameterSpecReferenceCADImport-1792();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecReferenceCADImport-1792* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecReferenceCADImport-1792_H_ */

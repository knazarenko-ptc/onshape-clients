...
/*
 * OAIBTFeatureApiBase-1430.h
 *
 * 
 */

#ifndef OAIBTFeatureApiBase-1430_H_
#define OAIBTFeatureApiBase-1430_H_
...
class OAIBTFeatureApiBase-1430: public OAIObject {
public:
    OAIBTFeatureApiBase-1430();
    OAIBTFeatureApiBase-1430(QString json);
    ~OAIBTFeatureApiBase-1430();
    void init();
    void cleanup();
    ...
    OAIBTFeatureApiBase-1430* fromJson(QString jsonString) override;
...
#endif /* OAIBTFeatureApiBase-1430_H_ */

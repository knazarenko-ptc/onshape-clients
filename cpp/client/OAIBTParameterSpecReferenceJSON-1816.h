...
/*
 * OAIBTParameterSpecReferenceJSON-1816.h
 *
 * 
 */

#ifndef OAIBTParameterSpecReferenceJSON-1816_H_
#define OAIBTParameterSpecReferenceJSON-1816_H_
...
class OAIBTParameterSpecReferenceJSON-1816: public OAIObject {
public:
    OAIBTParameterSpecReferenceJSON-1816();
    OAIBTParameterSpecReferenceJSON-1816(QString json);
    ~OAIBTParameterSpecReferenceJSON-1816();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecReferenceJSON-1816* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecReferenceJSON-1816_H_ */

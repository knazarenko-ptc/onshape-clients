...
OAIBTPExpressionNew-243::OAIBTPExpressionNew-243(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPExpressionNew-243::OAIBTPExpressionNew-243() {
    init();
}
...
OAIBTPExpressionNew-243::init() {
    ...
    space_between_new_box = new OAIBTPSpace-10();
    m_space_between_new_box_isSet = false;
    space_after_box = new OAIBTPSpace-10();
    m_space_after_box_isSet = false;
    value = new OAIBTPExpression-9();
    m_value_isSet = false;
}

void
OAIBTPExpressionNew-243::cleanup() {
    ...
    if(space_between_new_box != nullptr) { 
        delete space_between_new_box;
    }
    if(space_after_box != nullptr) { 
        delete space_after_box;
    }
    if(value != nullptr) { 
        delete value;
    }
...
OAIBTPExpressionNew-243*
OAIBTPExpressionNew-243::fromJson(QString json) {
...
void
OAIBTPExpressionNew-243::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&space_between_new_box, pJson["spaceBetweenNewBox"], "OAIBTPSpace-10", "OAIBTPSpace-10");
    
    ::OpenAPI::setValue(&space_after_box, pJson["spaceAfterBox"], "OAIBTPSpace-10", "OAIBTPSpace-10");
...
QString
OAIBTPExpressionNew-243::asJson ()
{
...
QJsonObject
OAIBTPExpressionNew-243::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
    ...
    if((space_between_new_box != nullptr) && (space_between_new_box->isSet())){
        toJsonValue(QString("spaceBetweenNewBox"), space_between_new_box, obj, QString("OAIBTPSpace-10"));
    }
    if((space_after_box != nullptr) && (space_after_box->isSet())){
        toJsonValue(QString("spaceAfterBox"), space_after_box, obj, QString("OAIBTPSpace-10"));
    }
...
bool
OAIBTPExpressionNew-243::isAtomic() {
    return atomic;
}
void
OAIBTPExpressionNew-243::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPExpressionNew-243::getBtType() {
    return bt_type;
}
void
OAIBTPExpressionNew-243::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPExpressionNew-243::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPExpressionNew-243::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPExpressionNew-243::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPExpressionNew-243::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPExpressionNew-243::getNodeId() {
    return node_id;
}
void
OAIBTPExpressionNew-243::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPExpressionNew-243::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPExpressionNew-243::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpressionNew-243::getSpaceAfter() {
    return space_after;
}
void
OAIBTPExpressionNew-243::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpressionNew-243::getSpaceBefore() {
    return space_before;
}
void
OAIBTPExpressionNew-243::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPExpressionNew-243::isSpaceDefault() {
    return space_default;
}
void
OAIBTPExpressionNew-243::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPExpressionNew-243::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPExpressionNew-243::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpressionNew-243::getSpaceBetweenNewBox() {
    return space_between_new_box;
}
void
OAIBTPExpressionNew-243::setSpaceBetweenNewBox(OAIBTPSpace-10* space_between_new_box) {
    this->space_between_new_box = space_between_new_box;
    this->m_space_between_new_box_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpressionNew-243::getSpaceAfterBox() {
    return space_after_box;
}
void
OAIBTPExpressionNew-243::setSpaceAfterBox(OAIBTPSpace-10* space_after_box) {
    this->space_after_box = space_after_box;
    this->m_space_after_box_isSet = true;
}

OAIBTPExpression-9*
OAIBTPExpressionNew-243::getValue() {
    return value;
}
void
OAIBTPExpressionNew-243::setValue(OAIBTPExpression-9* value) {
    this->value = value;
...
OAIBTPExpressionNew-243::isSet(){
    ...
    do{
        ...
        if(space_between_new_box != nullptr && space_between_new_box->isSet()){ isObjectUpdated = true; break;}
        if(space_after_box != nullptr && space_after_box->isSet()){ isObjectUpdated = true; break;}

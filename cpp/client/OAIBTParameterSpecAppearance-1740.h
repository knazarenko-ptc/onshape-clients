...
/*
 * OAIBTParameterSpecAppearance-1740.h
 *
 * 
 */

#ifndef OAIBTParameterSpecAppearance-1740_H_
#define OAIBTParameterSpecAppearance-1740_H_
...
class OAIBTParameterSpecAppearance-1740: public OAIObject {
public:
    OAIBTParameterSpecAppearance-1740();
    OAIBTParameterSpecAppearance-1740(QString json);
    ~OAIBTParameterSpecAppearance-1740();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecAppearance-1740* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecAppearance-1740_H_ */

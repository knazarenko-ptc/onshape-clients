...
/*
 * OAIBTParameterSpecReference-2789.h
 *
 * 
 */

#ifndef OAIBTParameterSpecReference-2789_H_
#define OAIBTParameterSpecReference-2789_H_
...
class OAIBTParameterSpecReference-2789: public OAIObject {
public:
    OAIBTParameterSpecReference-2789();
    OAIBTParameterSpecReference-2789(QString json);
    ~OAIBTParameterSpecReference-2789();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecReference-2789* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecReference-2789_H_ */

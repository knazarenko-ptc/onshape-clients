...
/*
 * OAIBTPTypeName-290.h
 *
 * 
 */

#ifndef OAIBTPTypeName-290_H_
#define OAIBTPTypeName-290_H_
...
class OAIBTPTypeName-290: public OAIObject {
public:
    OAIBTPTypeName-290();
    OAIBTPTypeName-290(QString json);
    ~OAIBTPTypeName-290();
    void init();
    void cleanup();
    ...
    OAIBTPTypeName-290* fromJson(QString jsonString) override;

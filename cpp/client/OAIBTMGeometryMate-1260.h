...
/*
 * OAIBTMGeometryMate-1260.h
 *
 * 
 */

#ifndef OAIBTMGeometryMate-1260_H_
#define OAIBTMGeometryMate-1260_H_
...
class OAIBTMGeometryMate-1260: public OAIObject {
public:
    OAIBTMGeometryMate-1260();
    OAIBTMGeometryMate-1260(QString json);
    ~OAIBTMGeometryMate-1260();
    void init();
    void cleanup();
    ...
    OAIBTMGeometryMate-1260* fromJson(QString jsonString) override;
...
#endif /* OAIBTMGeometryMate-1260_H_ */

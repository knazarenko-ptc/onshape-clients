...
/*
 * OAIBTPArgumentDeclaration-232.h
 *
 * 
 */

#ifndef OAIBTPArgumentDeclaration-232_H_
#define OAIBTPArgumentDeclaration-232_H_
...
class OAIBTPArgumentDeclaration-232: public OAIObject {
public:
    OAIBTPArgumentDeclaration-232();
    OAIBTPArgumentDeclaration-232(QString json);
    ~OAIBTPArgumentDeclaration-232();
    void init();
    void cleanup();
    ...
    OAIBTPArgumentDeclaration-232* fromJson(QString jsonString) override;
...
#endif /* OAIBTPArgumentDeclaration-232_H_ */

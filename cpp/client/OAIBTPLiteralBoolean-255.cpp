...
OAIBTPLiteralBoolean-255::OAIBTPLiteralBoolean-255(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLiteralBoolean-255::OAIBTPLiteralBoolean-255() {
    init();
}
...
void
OAIBTPLiteralBoolean-255::cleanup() {
...
OAIBTPLiteralBoolean-255*
OAIBTPLiteralBoolean-255::fromJson(QString json) {
...
void
OAIBTPLiteralBoolean-255::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPLiteralBoolean-255::asJson ()
{
...
QJsonObject
OAIBTPLiteralBoolean-255::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPLiteralBoolean-255::isAtomic() {
    return atomic;
}
void
OAIBTPLiteralBoolean-255::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLiteralBoolean-255::getBtType() {
    return bt_type;
}
void
OAIBTPLiteralBoolean-255::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLiteralBoolean-255::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLiteralBoolean-255::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLiteralBoolean-255::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLiteralBoolean-255::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPLiteralBoolean-255::getNodeId() {
    return node_id;
}
void
OAIBTPLiteralBoolean-255::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLiteralBoolean-255::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLiteralBoolean-255::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralBoolean-255::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLiteralBoolean-255::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralBoolean-255::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLiteralBoolean-255::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLiteralBoolean-255::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLiteralBoolean-255::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPLiteralBoolean-255::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLiteralBoolean-255::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

bool
OAIBTPLiteralBoolean-255::isValue() {
    return value;
}
void
OAIBTPLiteralBoolean-255::setValue(bool value) {
    this->value = value;
...
bool
OAIBTPLiteralBoolean-255::isSet(){

...
OAIBTPLiteralString-259::OAIBTPLiteralString-259(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLiteralString-259::OAIBTPLiteralString-259() {
    init();
}
...
void
OAIBTPLiteralString-259::cleanup() {
...
OAIBTPLiteralString-259::fromJson(QString json) {
...
void
OAIBTPLiteralString-259::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPLiteralString-259::asJson ()
{
...
QJsonObject
OAIBTPLiteralString-259::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPLiteralString-259::isAtomic() {
    return atomic;
}
void
OAIBTPLiteralString-259::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLiteralString-259::getBtType() {
    return bt_type;
}
void
OAIBTPLiteralString-259::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLiteralString-259::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLiteralString-259::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLiteralString-259::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLiteralString-259::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPLiteralString-259::getNodeId() {
    return node_id;
}
void
OAIBTPLiteralString-259::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLiteralString-259::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLiteralString-259::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralString-259::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLiteralString-259::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralString-259::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLiteralString-259::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLiteralString-259::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLiteralString-259::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPLiteralString-259::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLiteralString-259::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

QString*
OAIBTPLiteralString-259::getText() {
    return text;
}
void
OAIBTPLiteralString-259::setText(QString* text) {
    this->text = text;
    this->m_text_isSet = true;
}

QString*
OAIBTPLiteralString-259::getValue() {
    return value;
}
void
OAIBTPLiteralString-259::setValue(QString* value) {
    this->value = value;

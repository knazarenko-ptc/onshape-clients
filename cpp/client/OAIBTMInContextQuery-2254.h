...
/*
 * OAIBTMInContextQuery-2254.h
 *
 * 
 */

#ifndef OAIBTMInContextQuery-2254_H_
#define OAIBTMInContextQuery-2254_H_
...
class OAIBTMInContextQuery-2254: public OAIObject {
public:
    OAIBTMInContextQuery-2254();
    OAIBTMInContextQuery-2254(QString json);
    ~OAIBTMInContextQuery-2254();
    void init();
    void cleanup();
    ...
    OAIBTMInContextQuery-2254* fromJson(QString jsonString) override;
...
#endif /* OAIBTMInContextQuery-2254_H_ */

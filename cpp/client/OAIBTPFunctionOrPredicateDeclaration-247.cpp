...
OAIBTPFunctionOrPredicateDeclaration-247::OAIBTPFunctionOrPredicateDeclaration-247(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPFunctionOrPredicateDeclaration-247::OAIBTPFunctionOrPredicateDeclaration-247() {
    init();
}
...
void
OAIBTPFunctionOrPredicateDeclaration-247::init() {
    atomic = false;
...
void
OAIBTPFunctionOrPredicateDeclaration-247::cleanup() {
...
OAIBTPFunctionOrPredicateDeclaration-247*
OAIBTPFunctionOrPredicateDeclaration-247::fromJson(QString json) {
...
void
OAIBTPFunctionOrPredicateDeclaration-247::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPFunctionOrPredicateDeclaration-247::asJson ()
{
...
QJsonObject
OAIBTPFunctionOrPredicateDeclaration-247::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPFunctionOrPredicateDeclaration-247::isAtomic() {
    return atomic;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPFunctionOrPredicateDeclaration-247::getBtType() {
    return bt_type;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPFunctionOrPredicateDeclaration-247::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPFunctionOrPredicateDeclaration-247::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPFunctionOrPredicateDeclaration-247::getNodeId() {
    return node_id;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPFunctionOrPredicateDeclaration-247::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPFunctionOrPredicateDeclaration-247::getSpaceAfter() {
    return space_after;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPFunctionOrPredicateDeclaration-247::getSpaceBefore() {
    return space_before;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPFunctionOrPredicateDeclaration-247::isSpaceDefault() {
    return space_default;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPFunctionOrPredicateDeclaration-247::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

bool
OAIBTPFunctionOrPredicateDeclaration-247::isDeprecated() {
    return deprecated;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setDeprecated(bool deprecated) {
    this->deprecated = deprecated;
    this->m_deprecated_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPFunctionOrPredicateDeclaration-247::getSymbolName() {
    return symbol_name;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setSymbolName(OAIBTPIdentifier-8* symbol_name) {
    this->symbol_name = symbol_name;
    this->m_symbol_name_isSet = true;
}

QList<OAIBTPArgumentDeclaration-232*>*
OAIBTPFunctionOrPredicateDeclaration-247::getArgumentsToDocument() {
    return arguments_to_document;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setArgumentsToDocument(QList<OAIBTPArgumentDeclaration-232*>* arguments_to_document) {
    this->arguments_to_document = arguments_to_document;
    this->m_arguments_to_document_isSet = true;
}

QString*
OAIBTPFunctionOrPredicateDeclaration-247::getDeprecatedExplanation() {
    return deprecated_explanation;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setDeprecatedExplanation(QString* deprecated_explanation) {
    this->deprecated_explanation = deprecated_explanation;
    this->m_deprecated_explanation_isSet = true;
}

bool
OAIBTPFunctionOrPredicateDeclaration-247::isForExport() {
    return for_export;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setForExport(bool for_export) {
    this->for_export = for_export;
    this->m_for_export_isSet = true;
}

OAIBTPSpace-10*
OAIBTPFunctionOrPredicateDeclaration-247::getSpaceAfterExport() {
    return space_after_export;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setSpaceAfterExport(OAIBTPSpace-10* space_after_export) {
    this->space_after_export = space_after_export;
    this->m_space_after_export_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPFunctionOrPredicateDeclaration-247::getAnnotation() {
    return annotation;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setAnnotation(OAIBTPAnnotation-231* annotation) {
    this->annotation = annotation;
    this->m_annotation_isSet = true;
}

OAIBTPStatementBlock-271*
OAIBTPFunctionOrPredicateDeclaration-247::getBody() {
    return body;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setBody(OAIBTPStatementBlock-271* body) {
    this->body = body;
    this->m_body_isSet = true;
}

QList<OAIBTPArgumentDeclaration-232*>*
OAIBTPFunctionOrPredicateDeclaration-247::getArguments() {
    return arguments;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setArguments(QList<OAIBTPArgumentDeclaration-232*>* arguments) {
    this->arguments = arguments;
    this->m_arguments_isSet = true;
}

OAIBTPStatement-269*
OAIBTPFunctionOrPredicateDeclaration-247::getPrecondition() {
    return precondition;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setPrecondition(OAIBTPStatement-269* precondition) {
    this->precondition = precondition;
    this->m_precondition_isSet = true;
}

OAIBTPSpace-10*
OAIBTPFunctionOrPredicateDeclaration-247::getSpaceAfterArglist() {
    return space_after_arglist;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setSpaceAfterArglist(OAIBTPSpace-10* space_after_arglist) {
    this->space_after_arglist = space_after_arglist;
    this->m_space_after_arglist_isSet = true;
}

OAIBTPSpace-10*
OAIBTPFunctionOrPredicateDeclaration-247::getSpaceInEmptyList() {
    return space_in_empty_list;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setSpaceInEmptyList(OAIBTPSpace-10* space_in_empty_list) {
    this->space_in_empty_list = space_in_empty_list;
    this->m_space_in_empty_list_isSet = true;
}

OAIBTPTypeName-290*
OAIBTPFunctionOrPredicateDeclaration-247::getReturnType() {
    return return_type;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setReturnType(OAIBTPTypeName-290* return_type) {
    this->return_type = return_type;
    this->m_return_type_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPFunctionOrPredicateDeclaration-247::getName() {
    return name;
}
void
OAIBTPFunctionOrPredicateDeclaration-247::setName(OAIBTPIdentifier-8* name) {
    this->name = name;
...
bool
OAIBTPFunctionOrPredicateDeclaration-247::isSet(){

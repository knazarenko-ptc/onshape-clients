...
OAIBTParameterSpecQuery-174::OAIBTParameterSpecQuery-174(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecQuery-174::OAIBTParameterSpecQuery-174() {
    init();
}
...
void
OAIBTParameterSpecQuery-174::init() {
    ...
    additional_box_select_filter = new OAIBTQueryFilter-183();
    m_additional_box_select_filter_isSet = false;
    filter = new OAIBTQueryFilter-183();
    m_filter_isSet = false;
}

void
OAIBTParameterSpecQuery-174::cleanup() {
    ...
    if(additional_box_select_filter != nullptr) { 
        delete additional_box_select_filter;
    }
    if(filter != nullptr) { 
        delete filter;
    }
...
OAIBTParameterSpecQuery-174::fromJson(QString json) {
...
void
OAIBTParameterSpecQuery-174::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&additional_box_select_filter, pJson["additionalBoxSelectFilter"], "OAIBTQueryFilter-183", "OAIBTQueryFilter-183");
    
    ::OpenAPI::setValue(&filter, pJson["filter"], "OAIBTQueryFilter-183", "OAIBTQueryFilter-183");
    
}

QString
OAIBTParameterSpecQuery-174::asJson ()
{
...
QJsonObject
OAIBTParameterSpecQuery-174::asJsonObject() {
    QJsonObject obj;
    ...
    if((additional_box_select_filter != nullptr) && (additional_box_select_filter->isSet())){
        toJsonValue(QString("additionalBoxSelectFilter"), additional_box_select_filter, obj, QString("OAIBTQueryFilter-183"));
    }
    if((filter != nullptr) && (filter->isSet())){
        toJsonValue(QString("filter"), filter, obj, QString("OAIBTQueryFilter-183"));
    }
...
qint32
OAIBTParameterSpecQuery-174::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecQuery-174::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecQuery-174::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecQuery-174::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecQuery-174::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecQuery-174::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecQuery-174::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecQuery-174::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecQuery-174::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecQuery-174::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecQuery-174::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecQuery-174::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecQuery-174::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecQuery-174::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecQuery-174::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecQuery-174::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecQuery-174::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecQuery-174::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecQuery-174::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecQuery-174::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecQuery-174::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecQuery-174::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecQuery-174::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecQuery-174::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecQuery-174::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecQuery-174::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
    this->visibility_condition = visibility_condition;
    this->m_visibility_condition_isSet = true;
}

qint32
OAIBTParameterSpecQuery-174::getMaxNumberOfPicks() {
    return max_number_of_picks;
}
void
OAIBTParameterSpecQuery-174::setMaxNumberOfPicks(qint32 max_number_of_picks) {
    this->max_number_of_picks = max_number_of_picks;
    this->m_max_number_of_picks_isSet = true;
}

OAIBTQueryFilter-183*
OAIBTParameterSpecQuery-174::getAdditionalBoxSelectFilter() {
    return additional_box_select_filter;
}
void
OAIBTParameterSpecQuery-174::setAdditionalBoxSelectFilter(OAIBTQueryFilter-183* additional_box_select_filter) {
    this->additional_box_select_filter = additional_box_select_filter;
    this->m_additional_box_select_filter_isSet = true;
}

OAIBTQueryFilter-183*
OAIBTParameterSpecQuery-174::getFilter() {
    return filter;
}
void
OAIBTParameterSpecQuery-174::setFilter(OAIBTQueryFilter-183* filter) {
    this->filter = filter;
...
bool
OAIBTParameterSpecQuery-174::isSet(){
    ...
    do{
        ...
        if(additional_box_select_filter != nullptr && additional_box_select_filter->isSet()){ isObjectUpdated = true; break;}
        if(filter != nullptr && filter->isSet()){ isObjectUpdated = true; break;}
    }while(false);

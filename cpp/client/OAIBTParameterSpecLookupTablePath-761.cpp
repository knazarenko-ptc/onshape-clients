...
OAIBTParameterSpecLookupTablePath-761::OAIBTParameterSpecLookupTablePath-761(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecLookupTablePath-761::OAIBTParameterSpecLookupTablePath-761() {
    init();
}
...
void
OAIBTParameterSpecLookupTablePath-761::init() {
    ...
    lookup_table = new OAIBTParameterLookupTableListEntry-1916();
    m_lookup_table_isSet = false;
}

void
OAIBTParameterSpecLookupTablePath-761::cleanup() {
...
OAIBTParameterSpecLookupTablePath-761::fromJson(QString json) {
...
void
OAIBTParameterSpecLookupTablePath-761::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&lookup_table, pJson["lookupTable"], "OAIBTParameterLookupTableListEntry-1916", "OAIBTParameterLookupTableListEntry-1916");
    
}

QString
OAIBTParameterSpecLookupTablePath-761::asJson ()
{
...
QJsonObject
OAIBTParameterSpecLookupTablePath-761::asJsonObject() {
    QJsonObject obj;
    ...
    if((lookup_table != nullptr) && (lookup_table->isSet())){
        toJsonValue(QString("lookupTable"), lookup_table, obj, QString("OAIBTParameterLookupTableListEntry-1916"));
    }
...
qint32
OAIBTParameterSpecLookupTablePath-761::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecLookupTablePath-761::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecLookupTablePath-761::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecLookupTablePath-761::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecLookupTablePath-761::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecLookupTablePath-761::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecLookupTablePath-761::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecLookupTablePath-761::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecLookupTablePath-761::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecLookupTablePath-761::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecLookupTablePath-761::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecLookupTablePath-761::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecLookupTablePath-761::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecLookupTablePath-761::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecLookupTablePath-761::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecLookupTablePath-761::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecLookupTablePath-761::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecLookupTablePath-761::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecLookupTablePath-761::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecLookupTablePath-761::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecLookupTablePath-761::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecLookupTablePath-761::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecLookupTablePath-761::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecLookupTablePath-761::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecLookupTablePath-761::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecLookupTablePath-761::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
...
OAIBTParameterSpecLookupTablePath-761::getLookupTable() {
    return lookup_table;
}
void
OAIBTParameterSpecLookupTablePath-761::setLookupTable(OAIBTParameterLookupTableListEntry-1916* lookup_table) {
    this->lookup_table = lookup_table;
    this->m_lookup_table_isSet = true;
}


bool
OAIBTParameterSpecLookupTablePath-761::isSet(){
    ...
    do{
        ...
        if(lookup_table != nullptr && lookup_table->isSet()){ isObjectUpdated = true; break;}
    }while(false);

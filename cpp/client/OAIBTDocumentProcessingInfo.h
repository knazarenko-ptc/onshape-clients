...
/*
 * OAIBTDocumentProcessingInfo.h
 *
 * 
 */

#ifndef OAIBTDocumentProcessingInfo_H_
#define OAIBTDocumentProcessingInfo_H_
...
class OAIBTDocumentProcessingInfo: public OAIObject {
public:
    OAIBTDocumentProcessingInfo();
    OAIBTDocumentProcessingInfo(QString json);
    ~OAIBTDocumentProcessingInfo();
    void init();
    void cleanup();
    ...
    OAIBTDocumentProcessingInfo* fromJson(QString jsonString) override;
    ...
    QString* getTranslationEventKey();
    void setTranslationEventKey(QString* translation_event_key);

    QString* getTranslationId();
    void setTranslationId(QString* translation_id);
...
private:
    ...
    QString* translation_event_key;
    bool m_translation_event_key_isSet;

    QString* translation_id;
    bool m_translation_id_isSet;

};

}

#endif /* OAIBTDocumentProcessingInfo_H_ */

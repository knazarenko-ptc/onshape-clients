...
/*
 * OAIBTParameterSpecReferenceBlob-1367.h
 *
 * 
 */

#ifndef OAIBTParameterSpecReferenceBlob-1367_H_
#define OAIBTParameterSpecReferenceBlob-1367_H_
...
class OAIBTParameterSpecReferenceBlob-1367: public OAIObject {
public:
    OAIBTParameterSpecReferenceBlob-1367();
    OAIBTParameterSpecReferenceBlob-1367(QString json);
    ~OAIBTParameterSpecReferenceBlob-1367();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecReferenceBlob-1367* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecReferenceBlob-1367_H_ */

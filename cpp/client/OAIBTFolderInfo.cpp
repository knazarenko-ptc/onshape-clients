...
OAIBTFolderInfo::OAIBTFolderInfo(QString json) {
    init();
    this->fromJson(json);
}

OAIBTFolderInfo::OAIBTFolderInfo() {
    init();
}
...
OAIBTFolderInfo*
OAIBTFolderInfo::fromJson(QString json) {
...
void
OAIBTFolderInfo::fromJsonObject(QJsonObject pJson) {
...
bool
OAIBTFolderInfo::isCanMove() {
    return can_move;
}
void
OAIBTFolderInfo::setCanMove(bool can_move) {
    this->can_move = can_move;
    this->m_can_move_isSet = true;
}

QDateTime*
OAIBTFolderInfo::getCreatedAt() {
    return created_at;
}
void
OAIBTFolderInfo::setCreatedAt(QDateTime* created_at) {
    this->created_at = created_at;
    this->m_created_at_isSet = true;
}

OAIBTUserBasicSummaryInfo*
OAIBTFolderInfo::getCreatedBy() {
    return created_by;
}
void
OAIBTFolderInfo::setCreatedBy(OAIBTUserBasicSummaryInfo* created_by) {
    this->created_by = created_by;
    this->m_created_by_isSet = true;
}

QString*
OAIBTFolderInfo::getDescription() {
    return description;
}
void
OAIBTFolderInfo::setDescription(QString* description) {
    this->description = description;
    this->m_description_isSet = true;
}

bool
OAIBTFolderInfo::isHasPendingOwner() {
    return has_pending_owner;
}
void
OAIBTFolderInfo::setHasPendingOwner(bool has_pending_owner) {
    this->has_pending_owner = has_pending_owner;
    this->m_has_pending_owner_isSet = true;
}

QString*
OAIBTFolderInfo::getHref() {
    return href;
}
void
OAIBTFolderInfo::setHref(QString* href) {
    this->href = href;
    this->m_href_isSet = true;
}

QString*
OAIBTFolderInfo::getId() {
    return id;
}
void
OAIBTFolderInfo::setId(QString* id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool
OAIBTFolderInfo::isIsContainer() {
    return is_container;
}
void
OAIBTFolderInfo::setIsContainer(bool is_container) {
    this->is_container = is_container;
    this->m_is_container_isSet = true;
}

bool
OAIBTFolderInfo::isIsEnterpriseOwned() {
    return is_enterprise_owned;
}
void
OAIBTFolderInfo::setIsEnterpriseOwned(bool is_enterprise_owned) {
    this->is_enterprise_owned = is_enterprise_owned;
    this->m_is_enterprise_owned_isSet = true;
}

bool
OAIBTFolderInfo::isIsMutable() {
    return is_mutable;
}
void
OAIBTFolderInfo::setIsMutable(bool is_mutable) {
    this->is_mutable = is_mutable;
    this->m_is_mutable_isSet = true;
}

QString*
OAIBTFolderInfo::getJsonType() {
    return json_type;
}
void
OAIBTFolderInfo::setJsonType(QString* json_type) {
    this->json_type = json_type;
    this->m_json_type_isSet = true;
}

QDateTime*
OAIBTFolderInfo::getModifiedAt() {
    return modified_at;
}
void
OAIBTFolderInfo::setModifiedAt(QDateTime* modified_at) {
    this->modified_at = modified_at;
    this->m_modified_at_isSet = true;
}

OAIBTUserBasicSummaryInfo*
OAIBTFolderInfo::getModifiedBy() {
    return modified_by;
}
void
OAIBTFolderInfo::setModifiedBy(OAIBTUserBasicSummaryInfo* modified_by) {
    this->modified_by = modified_by;
    this->m_modified_by_isSet = true;
}

QString*
OAIBTFolderInfo::getName() {
    return name;
}
void
OAIBTFolderInfo::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

OAIBTOwnerInfo*
OAIBTFolderInfo::getOwner() {
    return owner;
}
void
OAIBTFolderInfo::setOwner(OAIBTOwnerInfo* owner) {
    this->owner = owner;
    this->m_owner_isSet = true;
}

QString*
OAIBTFolderInfo::getProjectId() {
    return project_id;
}
void
OAIBTFolderInfo::setProjectId(QString* project_id) {
    this->project_id = project_id;
    this->m_project_id_isSet = true;
}

QString*
OAIBTFolderInfo::getResourceType() {
    return resource_type;
}
void
OAIBTFolderInfo::setResourceType(QString* resource_type) {
    this->resource_type = resource_type;
    this->m_resource_type_isSet = true;
}

QString*
OAIBTFolderInfo::getTreeHref() {
    return tree_href;
}
void
OAIBTFolderInfo::setTreeHref(QString* tree_href) {
    this->tree_href = tree_href;
    this->m_tree_href_isSet = true;
}

QString*
OAIBTFolderInfo::getViewRef() {
    return view_ref;
}
void
OAIBTFolderInfo::setViewRef(QString* view_ref) {
    this->view_ref = view_ref;
    this->m_view_ref_isSet = true;
}

QString*
OAIBTFolderInfo::getParentId() {
    return parent_id;
}
void
OAIBTFolderInfo::setParentId(QString* parent_id) {
    this->parent_id = parent_id;
    this->m_parent_id_isSet = true;
}

OAIBTPermissionSet*
OAIBTFolderInfo::getPermissionSet() {
    return permission_set;
}
void
OAIBTFolderInfo::setPermissionSet(OAIBTPermissionSet* permission_set) {
    this->permission_set = permission_set;
    this->m_permission_set_isSet = true;
}

bool
OAIBTFolderInfo::isTrash() {
    return trash;
}
void
OAIBTFolderInfo::setTrash(bool trash) {
    this->trash = trash;
    this->m_trash_isSet = true;
}

bool
OAIBTFolderInfo::isCanUnshare() {
    return can_unshare;
}
void
OAIBTFolderInfo::setCanUnshare(bool can_unshare) {
    this->can_unshare = can_unshare;
    this->m_can_unshare_isSet = true;
}

bool
OAIBTFolderInfo::isActive() {
    return active;
}
void
OAIBTFolderInfo::setActive(bool active) {
    this->active = active;
    this->m_active_isSet = true;
}

QDateTime*
OAIBTFolderInfo::getTrashedAt() {
    return trashed_at;
}
void
OAIBTFolderInfo::setTrashedAt(QDateTime* trashed_at) {
    this->trashed_at = trashed_at;
    this->m_trashed_at_isSet = true;
}

bool
OAIBTFolderInfo::isIsOrphaned() {
    return is_orphaned;
}
void
OAIBTFolderInfo::setIsOrphaned(bool is_orphaned) {

...
OAIBTMFeature-134::OAIBTMFeature-134(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMFeature-134::OAIBTMFeature-134() {
    init();
}
...
OAIBTMFeature-134*
OAIBTMFeature-134::fromJson(QString json) {
...
void
OAIBTMFeature-134::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIBTMFeature-134::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMFeature-134::getBtType() {
    return bt_type;
}
void
OAIBTMFeature-134::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMFeature-134::getFeatureId() {
    return feature_id;
}
void
OAIBTMFeature-134::setFeatureId(QString* feature_id) {
    this->feature_id = feature_id;
    this->m_feature_id_isSet = true;
}

QString*
OAIBTMFeature-134::getFeatureType() {
    return feature_type;
}
void
OAIBTMFeature-134::setFeatureType(QString* feature_type) {
    this->feature_type = feature_type;
    this->m_feature_type_isSet = true;
}

QString*
OAIBTMFeature-134::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMFeature-134::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMFeature-134::getName() {
    return name;
}
void
OAIBTMFeature-134::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString*
OAIBTMFeature-134::getNamespace() {
    return _namespace;
}
void
OAIBTMFeature-134::setNamespace(QString* _namespace) {
    this->_namespace = _namespace;
    this->m__namespace_isSet = true;
}

QString*
OAIBTMFeature-134::getNodeId() {
    return node_id;
}
void
OAIBTMFeature-134::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QList<OAIBTMParameter-1*>*
OAIBTMFeature-134::getParameters() {
    return parameters;
}
void
OAIBTMFeature-134::setParameters(QList<OAIBTMParameter-1*>* parameters) {
    this->parameters = parameters;
    this->m_parameters_isSet = true;
}

bool
OAIBTMFeature-134::isReturnAfterSubfeatures() {
    return return_after_subfeatures;
}
void
OAIBTMFeature-134::setReturnAfterSubfeatures(bool return_after_subfeatures) {
    this->return_after_subfeatures = return_after_subfeatures;
    this->m_return_after_subfeatures_isSet = true;
}

QList<OAIBTMFeature-134*>*
OAIBTMFeature-134::getSubFeatures() {
    return sub_features;
}
void
OAIBTMFeature-134::setSubFeatures(QList<OAIBTMFeature-134*>* sub_features) {
    this->sub_features = sub_features;
    this->m_sub_features_isSet = true;
}

bool
OAIBTMFeature-134::isSuppressed() {
    return suppressed;
}
void
OAIBTMFeature-134::setSuppressed(bool suppressed) {

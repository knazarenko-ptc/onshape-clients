...
/*
 * OAIBTTeamSummaryInfo.h
 *
 * 
 */

#ifndef OAIBTTeamSummaryInfo_H_
#define OAIBTTeamSummaryInfo_H_
...
class OAIBTTeamSummaryInfo: public OAIObject {
public:
    OAIBTTeamSummaryInfo();
    OAIBTTeamSummaryInfo(QString json);
    ~OAIBTTeamSummaryInfo();
    void init();
    void cleanup();
    ...
    OAIBTTeamSummaryInfo* fromJson(QString jsonString) override;

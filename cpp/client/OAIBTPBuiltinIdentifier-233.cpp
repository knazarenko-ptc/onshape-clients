...
OAIBTPBuiltinIdentifier-233::OAIBTPBuiltinIdentifier-233(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPBuiltinIdentifier-233::OAIBTPBuiltinIdentifier-233() {
    init();
}
...
void
OAIBTPBuiltinIdentifier-233::init() {
    atomic = false;
...
void
OAIBTPBuiltinIdentifier-233::cleanup() {
...
OAIBTPBuiltinIdentifier-233::fromJson(QString json) {
...
void
OAIBTPBuiltinIdentifier-233::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPBuiltinIdentifier-233::asJson ()
{
...
QJsonObject
OAIBTPBuiltinIdentifier-233::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPBuiltinIdentifier-233::isAtomic() {
    return atomic;
}
void
OAIBTPBuiltinIdentifier-233::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPBuiltinIdentifier-233::getBtType() {
    return bt_type;
}
void
OAIBTPBuiltinIdentifier-233::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPBuiltinIdentifier-233::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPBuiltinIdentifier-233::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPBuiltinIdentifier-233::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPBuiltinIdentifier-233::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPBuiltinIdentifier-233::getNodeId() {
    return node_id;
}
void
OAIBTPBuiltinIdentifier-233::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPBuiltinIdentifier-233::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPBuiltinIdentifier-233::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPBuiltinIdentifier-233::getSpaceAfter() {
    return space_after;
}
void
OAIBTPBuiltinIdentifier-233::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPBuiltinIdentifier-233::getSpaceBefore() {
    return space_before;
}
void
OAIBTPBuiltinIdentifier-233::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPBuiltinIdentifier-233::isSpaceDefault() {
    return space_default;
}
void
OAIBTPBuiltinIdentifier-233::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPBuiltinIdentifier-233::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPBuiltinIdentifier-233::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

QString*
OAIBTPBuiltinIdentifier-233::getIdentifier() {
    return identifier;
}
void
OAIBTPBuiltinIdentifier-233::setIdentifier(QString* identifier) {
...
bool
OAIBTPBuiltinIdentifier-233::isSet(){

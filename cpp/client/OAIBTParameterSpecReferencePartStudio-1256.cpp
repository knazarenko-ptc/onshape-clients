...
OAIBTParameterSpecReferencePartStudio-1256::OAIBTParameterSpecReferencePartStudio-1256(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecReferencePartStudio-1256::OAIBTParameterSpecReferencePartStudio-1256() {
    init();
}
...
void
OAIBTParameterSpecReferencePartStudio-1256::init() {
    ...
    computed_configuration_inputs = new QList<OAIBTComputedConfigurationInputSpec-2525*>();
    m_computed_configuration_inputs_isSet = false;
}

void
OAIBTParameterSpecReferencePartStudio-1256::cleanup() {
    ...
    if(computed_configuration_inputs != nullptr) { 
        auto arr = computed_configuration_inputs;
        for(auto o: *arr) { 
            delete o;
        }
        delete computed_configuration_inputs;
    }
}

OAIBTParameterSpecReferencePartStudio-1256*
OAIBTParameterSpecReferencePartStudio-1256::fromJson(QString json) {
...
void
OAIBTParameterSpecReferencePartStudio-1256::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&computed_configuration_inputs, pJson["computedConfigurationInputs"], "QList", "OAIBTComputedConfigurationInputSpec-2525");
}

QString
OAIBTParameterSpecReferencePartStudio-1256::asJson ()
{
...
QJsonObject
OAIBTParameterSpecReferencePartStudio-1256::asJsonObject() {
    QJsonObject obj;
    ...
    if(computed_configuration_inputs->size() > 0){
        toJsonArray((QList<void*>*)computed_configuration_inputs, obj, "computedConfigurationInputs", "OAIBTComputedConfigurationInputSpec-2525");
    }
...
qint32
OAIBTParameterSpecReferencePartStudio-1256::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecReferencePartStudio-1256::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecReferencePartStudio-1256::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecReferencePartStudio-1256::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecReferencePartStudio-1256::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecReferencePartStudio-1256::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecReferencePartStudio-1256::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecReferencePartStudio-1256::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecReferencePartStudio-1256::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferencePartStudio-1256::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecReferencePartStudio-1256::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferencePartStudio-1256::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecReferencePartStudio-1256::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
    this->visibility_condition = visibility_condition;
    this->m_visibility_condition_isSet = true;
}

qint32
OAIBTParameterSpecReferencePartStudio-1256::getMaxNumberOfPicks() {
    return max_number_of_picks;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setMaxNumberOfPicks(qint32 max_number_of_picks) {
    this->max_number_of_picks = max_number_of_picks;
    this->m_max_number_of_picks_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferencePartStudio-1256::getAllowedInsertableTypes() {
    return allowed_insertable_types;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setAllowedInsertableTypes(QList<QString*>* allowed_insertable_types) {
    this->allowed_insertable_types = allowed_insertable_types;
    this->m_allowed_insertable_types_isSet = true;
}

QList<OAIBTComputedConfigurationInputSpec-2525*>*
OAIBTParameterSpecReferencePartStudio-1256::getComputedConfigurationInputs() {
    return computed_configuration_inputs;
}
void
OAIBTParameterSpecReferencePartStudio-1256::setComputedConfigurationInputs(QList<OAIBTComputedConfigurationInputSpec-2525*>* computed_configuration_inputs) {
    this->computed_configuration_inputs = computed_configuration_inputs;
    this->m_computed_configuration_inputs_isSet = true;
}


bool
OAIBTParameterSpecReferencePartStudio-1256::isSet(){
    ...
    do{
        ...
        if(computed_configuration_inputs->size() > 0){ isObjectUpdated = true; break;}
    }while(false);

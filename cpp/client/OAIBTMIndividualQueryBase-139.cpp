...
OAIBTMIndividualQueryBase-139::OAIBTMIndividualQueryBase-139(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMIndividualQueryBase-139::OAIBTMIndividualQueryBase-139() {
    init();
}
...
void
OAIBTMIndividualQueryBase-139::init() {
    bt_type = new QString("");
...
void
OAIBTMIndividualQueryBase-139::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMIndividualQueryBase-139::fromJson(QString json) {
...
void
OAIBTMIndividualQueryBase-139::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTMIndividualQueryBase-139::asJson ()
{
...
QJsonObject
OAIBTMIndividualQueryBase-139::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMIndividualQueryBase-139::getBtType() {
    return bt_type;
}
void
OAIBTMIndividualQueryBase-139::setBtType(QString* bt_type) {
...
void
OAIBTMIndividualQueryBase-139::setDeterministicIdList(OAIBTMIndividualQueryBase-139* deterministic_id_list) {
    this->deterministic_id_list = deterministic_id_list;
    this->m_deterministic_id_list_isSet = true;
}

QList<QString*>*
OAIBTMIndividualQueryBase-139::getDeterministicIds() {
    return deterministic_ids;
}
void
OAIBTMIndividualQueryBase-139::setDeterministicIds(QList<QString*>* deterministic_ids) {
    this->deterministic_ids = deterministic_ids;
    this->m_deterministic_ids_isSet = true;
}

QString*
OAIBTMIndividualQueryBase-139::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMIndividualQueryBase-139::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMIndividualQueryBase-139::getNodeId() {
    return node_id;
}
void
OAIBTMIndividualQueryBase-139::setNodeId(QString* node_id) {
...
void
OAIBTMIndividualQueryBase-139::setQuery(OAIBTMIndividualQueryBase-139* query) {
    this->query = query;
    this->m_query_isSet = true;
}

QString*
OAIBTMIndividualQueryBase-139::getQueryString() {
    return query_string;
}
void
OAIBTMIndividualQueryBase-139::setQueryString(QString* query_string) {
...
bool
OAIBTMIndividualQueryBase-139::isSet(){

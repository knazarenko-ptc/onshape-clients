...
/*
 * OAIBTPTopLevelConstantDeclaration-283.h
 *
 * 
 */

#ifndef OAIBTPTopLevelConstantDeclaration-283_H_
#define OAIBTPTopLevelConstantDeclaration-283_H_
...
class OAIBTPTopLevelConstantDeclaration-283: public OAIObject {
public:
    OAIBTPTopLevelConstantDeclaration-283();
    OAIBTPTopLevelConstantDeclaration-283(QString json);
    ~OAIBTPTopLevelConstantDeclaration-283();
    void init();
    void cleanup();
    ...
    OAIBTPTopLevelConstantDeclaration-283* fromJson(QString jsonString) override;
    ...
    OAIBTPStatementConstantDeclaration-273* getDeclaration();
    void setDeclaration(OAIBTPStatementConstantDeclaration-273* declaration);
...
private:
    ...
    OAIBTPStatementConstantDeclaration-273* declaration;
...
#endif /* OAIBTPTopLevelConstantDeclaration-283_H_ */

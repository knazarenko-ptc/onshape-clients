...
/*
 * OAIBTPStatementVarDeclaration-282.h
 *
 * 
 */

#ifndef OAIBTPStatementVarDeclaration-282_H_
#define OAIBTPStatementVarDeclaration-282_H_
...
class OAIBTPStatementVarDeclaration-282: public OAIObject {
public:
    OAIBTPStatementVarDeclaration-282();
    OAIBTPStatementVarDeclaration-282(QString json);
    ~OAIBTPStatementVarDeclaration-282();
    void init();
    void cleanup();
    ...
    OAIBTPStatementVarDeclaration-282* fromJson(QString jsonString) override;
...
#endif /* OAIBTPStatementVarDeclaration-282_H_ */

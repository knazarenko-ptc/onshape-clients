...
/*
 * OAIBTPTopLevelUserTypeDeclaration-288.h
 *
 * 
 */

#ifndef OAIBTPTopLevelUserTypeDeclaration-288_H_
#define OAIBTPTopLevelUserTypeDeclaration-288_H_
...
class OAIBTPTopLevelUserTypeDeclaration-288: public OAIObject {
public:
    OAIBTPTopLevelUserTypeDeclaration-288();
    OAIBTPTopLevelUserTypeDeclaration-288(QString json);
    ~OAIBTPTopLevelUserTypeDeclaration-288();
    void init();
    void cleanup();
    ...
    OAIBTPTopLevelUserTypeDeclaration-288* fromJson(QString jsonString) override;
    ...
    OAIBTPName-261* getTypecheck();
    void setTypecheck(OAIBTPName-261* typecheck);
...
private:
    ...
    OAIBTPName-261* typecheck;
    bool m_typecheck_isSet;

};

}

#endif /* OAIBTPTopLevelUserTypeDeclaration-288_H_ */

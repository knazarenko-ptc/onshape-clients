...
OAIBTMNonGeometricItem-1864::OAIBTMNonGeometricItem-1864(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMNonGeometricItem-1864::OAIBTMNonGeometricItem-1864() {
    init();
}
...
void
OAIBTMNonGeometricItem-1864::init() {
    bt_type = new QString("");
...
void
OAIBTMNonGeometricItem-1864::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMNonGeometricItem-1864::fromJson(QString json) {
...
void
OAIBTMNonGeometricItem-1864::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTMNonGeometricItem-1864::asJson ()
{
...
QJsonObject
OAIBTMNonGeometricItem-1864::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMNonGeometricItem-1864::getBtType() {
    return bt_type;
}
void
OAIBTMNonGeometricItem-1864::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMNonGeometricItem-1864::getFeatureId() {
    return feature_id;
}
void
OAIBTMNonGeometricItem-1864::setFeatureId(QString* feature_id) {
    this->feature_id = feature_id;
    this->m_feature_id_isSet = true;
}

QString*
OAIBTMNonGeometricItem-1864::getFeatureType() {
    return feature_type;
}
void
OAIBTMNonGeometricItem-1864::setFeatureType(QString* feature_type) {
    this->feature_type = feature_type;
    this->m_feature_type_isSet = true;
}

QString*
OAIBTMNonGeometricItem-1864::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMNonGeometricItem-1864::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMNonGeometricItem-1864::getName() {
    return name;
}
void
OAIBTMNonGeometricItem-1864::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString*
OAIBTMNonGeometricItem-1864::getNamespace() {
    return _namespace;
}
void
OAIBTMNonGeometricItem-1864::setNamespace(QString* _namespace) {
    this->_namespace = _namespace;
    this->m__namespace_isSet = true;
}

QString*
OAIBTMNonGeometricItem-1864::getNodeId() {
    return node_id;
}
void
OAIBTMNonGeometricItem-1864::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QList<OAIBTMParameter-1*>*
OAIBTMNonGeometricItem-1864::getParameters() {
    return parameters;
}
void
OAIBTMNonGeometricItem-1864::setParameters(QList<OAIBTMParameter-1*>* parameters) {
    this->parameters = parameters;
    this->m_parameters_isSet = true;
}

bool
OAIBTMNonGeometricItem-1864::isReturnAfterSubfeatures() {
    return return_after_subfeatures;
}
void
OAIBTMNonGeometricItem-1864::setReturnAfterSubfeatures(bool return_after_subfeatures) {
    this->return_after_subfeatures = return_after_subfeatures;
    this->m_return_after_subfeatures_isSet = true;
}

QList<OAIBTMFeature-134*>*
OAIBTMNonGeometricItem-1864::getSubFeatures() {
    return sub_features;
}
void
OAIBTMNonGeometricItem-1864::setSubFeatures(QList<OAIBTMFeature-134*>* sub_features) {
    this->sub_features = sub_features;
    this->m_sub_features_isSet = true;
}

bool
OAIBTMNonGeometricItem-1864::isSuppressed() {
    return suppressed;
}
void
OAIBTMNonGeometricItem-1864::setSuppressed(bool suppressed) {
    this->suppressed = suppressed;
    this->m_suppressed_isSet = true;
}

bool
OAIBTMNonGeometricItem-1864::isAuxiliaryAssemblyFeature() {
    return auxiliary_assembly_feature;
}
void
OAIBTMNonGeometricItem-1864::setAuxiliaryAssemblyFeature(bool auxiliary_assembly_feature) {
    this->auxiliary_assembly_feature = auxiliary_assembly_feature;
    this->m_auxiliary_assembly_feature_isSet = true;
}

qint32
OAIBTMNonGeometricItem-1864::getFeatureListFieldIndex() {
    return feature_list_field_index;
}
void
OAIBTMNonGeometricItem-1864::setFeatureListFieldIndex(qint32 feature_list_field_index) {
...
OAIBTMNonGeometricItem-1864::getOccurrenceQueriesFromAllConfigurations() {
    return occurrence_queries_from_all_configurations;
}
void
OAIBTMNonGeometricItem-1864::setOccurrenceQueriesFromAllConfigurations(QList<OAIBTMIndividualQueryWithOccurrenceBase-904*>* occurrence_queries_from_all_configurations) {
...
qint32
OAIBTMNonGeometricItem-1864::getVersion() {
    return version;
}
void
OAIBTMNonGeometricItem-1864::setVersion(qint32 version) {
    this->version = version;
    this->m_version_isSet = true;
}

QString*
OAIBTMNonGeometricItem-1864::getItemDefinitionId() {
    return item_definition_id;
}
void
OAIBTMNonGeometricItem-1864::setItemDefinitionId(QString* item_definition_id) {
...
bool
OAIBTMNonGeometricItem-1864::isSet(){

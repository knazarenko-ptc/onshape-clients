...
/*
 * OAIBTParameterSpecMaterial-2700.h
 *
 * 
 */

#ifndef OAIBTParameterSpecMaterial-2700_H_
#define OAIBTParameterSpecMaterial-2700_H_
...
class OAIBTParameterSpecMaterial-2700: public OAIObject {
public:
    OAIBTParameterSpecMaterial-2700();
    OAIBTParameterSpecMaterial-2700(QString json);
    ~OAIBTParameterSpecMaterial-2700();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecMaterial-2700* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecMaterial-2700_H_ */

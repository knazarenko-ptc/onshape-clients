...
/*
 * OAIBTPStatementCompressedQuery-1237.h
 *
 * 
 */

#ifndef OAIBTPStatementCompressedQuery-1237_H_
#define OAIBTPStatementCompressedQuery-1237_H_
...
class OAIBTPStatementCompressedQuery-1237: public OAIObject {
public:
    OAIBTPStatementCompressedQuery-1237();
    OAIBTPStatementCompressedQuery-1237(QString json);
    ~OAIBTPStatementCompressedQuery-1237();
    void init();
    void cleanup();
    ...
    OAIBTPStatementCompressedQuery-1237* fromJson(QString jsonString) override;
...
#endif /* OAIBTPStatementCompressedQuery-1237_H_ */

...
/*
 * OAIBTParameterSpecReferenceImage-1722.h
 *
 * 
 */

#ifndef OAIBTParameterSpecReferenceImage-1722_H_
#define OAIBTParameterSpecReferenceImage-1722_H_
...
class OAIBTParameterSpecReferenceImage-1722: public OAIObject {
public:
    OAIBTParameterSpecReferenceImage-1722();
    OAIBTParameterSpecReferenceImage-1722(QString json);
    ~OAIBTParameterSpecReferenceImage-1722();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecReferenceImage-1722* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecReferenceImage-1722_H_ */

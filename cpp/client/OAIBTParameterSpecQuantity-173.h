...
/*
 * OAIBTParameterSpecQuantity-173.h
 *
 * 
 */

#ifndef OAIBTParameterSpecQuantity-173_H_
#define OAIBTParameterSpecQuantity-173_H_
...
class OAIBTParameterSpecQuantity-173: public OAIObject {
public:
    OAIBTParameterSpecQuantity-173();
    OAIBTParameterSpecQuantity-173(QString json);
    ~OAIBTParameterSpecQuantity-173();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecQuantity-173* fromJson(QString jsonString) override;
    ...
    QList<OAIBTQuantityRange-181*>* getRanges();
    void setRanges(QList<OAIBTQuantityRange-181*>* ranges);
...
private:
    ...
    QList<OAIBTQuantityRange-181*>* ranges;
    bool m_ranges_isSet;
...
#endif /* OAIBTParameterSpecQuantity-173_H_ */

...
OAIBTTeamSummaryInfo::OAIBTTeamSummaryInfo(QString json) {
    init();
    this->fromJson(json);
}

OAIBTTeamSummaryInfo::OAIBTTeamSummaryInfo() {
    init();
}
...
OAIBTTeamSummaryInfo::fromJson(QString json) {
...
void
OAIBTTeamSummaryInfo::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIBTTeamSummaryInfo::asJsonObject() {
    QJsonObject obj;
    if(m_active_isSet){
...
bool
OAIBTTeamSummaryInfo::isActive() {
    return active;
}
void
OAIBTTeamSummaryInfo::setActive(bool active) {
    this->active = active;
    this->m_active_isSet = true;
}

bool
OAIBTTeamSummaryInfo::isCanMove() {
    return can_move;
}
void
OAIBTTeamSummaryInfo::setCanMove(bool can_move) {
    this->can_move = can_move;
    this->m_can_move_isSet = true;
}

QDateTime*
OAIBTTeamSummaryInfo::getCreatedAt() {
    return created_at;
}
void
OAIBTTeamSummaryInfo::setCreatedAt(QDateTime* created_at) {
    this->created_at = created_at;
    this->m_created_at_isSet = true;
}

OAIBTUserBasicSummaryInfo*
OAIBTTeamSummaryInfo::getCreatedBy() {
    return created_by;
}
void
OAIBTTeamSummaryInfo::setCreatedBy(OAIBTUserBasicSummaryInfo* created_by) {
    this->created_by = created_by;
    this->m_created_by_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getDescription() {
    return description;
}
void
OAIBTTeamSummaryInfo::setDescription(QString* description) {
    this->description = description;
    this->m_description_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getHref() {
    return href;
}
void
OAIBTTeamSummaryInfo::setHref(QString* href) {
    this->href = href;
    this->m_href_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getId() {
    return id;
}
void
OAIBTTeamSummaryInfo::setId(QString* id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool
OAIBTTeamSummaryInfo::isIsContainer() {
    return is_container;
}
void
OAIBTTeamSummaryInfo::setIsContainer(bool is_container) {
    this->is_container = is_container;
    this->m_is_container_isSet = true;
}

bool
OAIBTTeamSummaryInfo::isIsEnterpriseOwned() {
    return is_enterprise_owned;
}
void
OAIBTTeamSummaryInfo::setIsEnterpriseOwned(bool is_enterprise_owned) {
    this->is_enterprise_owned = is_enterprise_owned;
    this->m_is_enterprise_owned_isSet = true;
}

bool
OAIBTTeamSummaryInfo::isIsMutable() {
    return is_mutable;
}
void
OAIBTTeamSummaryInfo::setIsMutable(bool is_mutable) {
    this->is_mutable = is_mutable;
    this->m_is_mutable_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getJsonType() {
    return json_type;
}
void
OAIBTTeamSummaryInfo::setJsonType(QString* json_type) {
    this->json_type = json_type;
    this->m_json_type_isSet = true;
}

QDateTime*
OAIBTTeamSummaryInfo::getModifiedAt() {
    return modified_at;
}
void
OAIBTTeamSummaryInfo::setModifiedAt(QDateTime* modified_at) {
    this->modified_at = modified_at;
    this->m_modified_at_isSet = true;
}

OAIBTUserBasicSummaryInfo*
OAIBTTeamSummaryInfo::getModifiedBy() {
    return modified_by;
}
void
OAIBTTeamSummaryInfo::setModifiedBy(OAIBTUserBasicSummaryInfo* modified_by) {
    this->modified_by = modified_by;
    this->m_modified_by_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getName() {
    return name;
}
void
OAIBTTeamSummaryInfo::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

OAIBTOwnerInfo*
OAIBTTeamSummaryInfo::getOwner() {
    return owner;
}
void
OAIBTTeamSummaryInfo::setOwner(OAIBTOwnerInfo* owner) {
    this->owner = owner;
    this->m_owner_isSet = true;
}

qint32
OAIBTTeamSummaryInfo::getPredefinedTeam() {
    return predefined_team;
}
void
OAIBTTeamSummaryInfo::setPredefinedTeam(qint32 predefined_team) {
    this->predefined_team = predefined_team;
    this->m_predefined_team_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getProjectId() {
    return project_id;
}
void
OAIBTTeamSummaryInfo::setProjectId(QString* project_id) {
    this->project_id = project_id;
    this->m_project_id_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getResourceType() {
    return resource_type;
}
void
OAIBTTeamSummaryInfo::setResourceType(QString* resource_type) {
    this->resource_type = resource_type;
    this->m_resource_type_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getTreeHref() {
    return tree_href;
}
void
OAIBTTeamSummaryInfo::setTreeHref(QString* tree_href) {
    this->tree_href = tree_href;
    this->m_tree_href_isSet = true;
}

QString*
OAIBTTeamSummaryInfo::getViewRef() {
    return view_ref;
}
void
OAIBTTeamSummaryInfo::setViewRef(QString* view_ref) {

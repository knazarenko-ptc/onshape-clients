...
OAISubscriptionItemCollection::OAISubscriptionItemCollection(QString json) {
    init();
    this->fromJson(json);
}

OAISubscriptionItemCollection::OAISubscriptionItemCollection() {
    init();
}
...
void
OAISubscriptionItemCollection::init() {
    count = 0;
    m_count_isSet = false;
    data = new QList<OAISubscriptionItem*>();
    m_data_isSet = false;
    has_more = false;
...
void
OAISubscriptionItemCollection::cleanup() {
...
OAISubscriptionItemCollection::fromJson(QString json) {
...
void
OAISubscriptionItemCollection::fromJsonObject(QJsonObject pJson) {
    ::OpenAPI::setValue(&count, pJson["count"], "qint32", "");
    
    
    ::OpenAPI::setValue(&data, pJson["data"], "QList", "OAISubscriptionItem");
...
QString
OAISubscriptionItemCollection::asJson ()
{
...
QJsonObject
OAISubscriptionItemCollection::asJsonObject() {
    QJsonObject obj;
    if(m_count_isSet){
        obj.insert("count", QJsonValue(count));
    }
    if(data->size() > 0){
        toJsonArray((QList<void*>*)data, obj, "data", "OAISubscriptionItem");
    }
    if(m_has_more_isSet){
...
qint32
OAISubscriptionItemCollection::getCount() {
    return count;
}
void
OAISubscriptionItemCollection::setCount(qint32 count) {
    this->count = count;
    this->m_count_isSet = true;
}

QList<OAISubscriptionItem*>*
OAISubscriptionItemCollection::getData() {
    return data;
}
void
OAISubscriptionItemCollection::setData(QList<OAISubscriptionItem*>* data) {
    this->data = data;
    this->m_data_isSet = true;
}

bool
OAISubscriptionItemCollection::isHasMore() {
    return has_more;
}
void
OAISubscriptionItemCollection::setHasMore(bool has_more) {
    this->has_more = has_more;
    this->m_has_more_isSet = true;
}

OAIRequestOptions*
OAISubscriptionItemCollection::getRequestOptions() {
    return request_options;
}
void
OAISubscriptionItemCollection::setRequestOptions(OAIRequestOptions* request_options) {
    this->request_options = request_options;
    this->m_request_options_isSet = true;
}

QMap<QString, OAIObject*>*
OAISubscriptionItemCollection::getRequestParams() {
    return request_params;
}
void
OAISubscriptionItemCollection::setRequestParams(QMap<QString, OAIObject*>* request_params) {
    this->request_params = request_params;
    this->m_request_params_isSet = true;
}

qint32
OAISubscriptionItemCollection::getTotalCount() {
    return total_count;
}
void
OAISubscriptionItemCollection::setTotalCount(qint32 total_count) {
    this->total_count = total_count;
    this->m_total_count_isSet = true;
}

QString*
OAISubscriptionItemCollection::getUrl() {
    return url;
}
void
OAISubscriptionItemCollection::setUrl(QString* url) {
    this->url = url;
...
bool
OAISubscriptionItemCollection::isSet(){

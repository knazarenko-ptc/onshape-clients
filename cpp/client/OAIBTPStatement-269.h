...
/*
 * OAIBTPStatement-269.h
 *
 * 
 */

#ifndef OAIBTPStatement-269_H_
#define OAIBTPStatement-269_H_
...
class OAIBTPStatement-269: public OAIObject {
public:
    OAIBTPStatement-269();
    OAIBTPStatement-269(QString json);
    ~OAIBTPStatement-269();
    void init();
    void cleanup();
    ...
    OAIBTPStatement-269* fromJson(QString jsonString) override;

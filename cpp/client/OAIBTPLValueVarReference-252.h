...
/*
 * OAIBTPLValueVarReference-252.h
 *
 * 
 */

#ifndef OAIBTPLValueVarReference-252_H_
#define OAIBTPLValueVarReference-252_H_
...
class OAIBTPLValueVarReference-252: public OAIObject {
public:
    OAIBTPLValueVarReference-252();
    OAIBTPLValueVarReference-252(QString json);
    ~OAIBTPLValueVarReference-252();
    void init();
    void cleanup();
    ...
    OAIBTPLValueVarReference-252* fromJson(QString jsonString) override;
...
#endif /* OAIBTPLValueVarReference-252_H_ */

...
#ifndef OAIBTMFeature-134_H_
#define OAIBTMFeature-134_H_
...
class OAIBTMFeature-134: public OAIObject {
public:
    OAIBTMFeature-134();
    OAIBTMFeature-134(QString json);
    ~OAIBTMFeature-134();
    void init();
    void cleanup();
    ...
    OAIBTMFeature-134* fromJson(QString jsonString) override;

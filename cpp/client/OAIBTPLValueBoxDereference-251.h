...
/*
 * OAIBTPLValueBoxDereference-251.h
 *
 * 
 */

#ifndef OAIBTPLValueBoxDereference-251_H_
#define OAIBTPLValueBoxDereference-251_H_
...
class OAIBTPLValueBoxDereference-251: public OAIObject {
public:
    OAIBTPLValueBoxDereference-251();
    OAIBTPLValueBoxDereference-251(QString json);
    ~OAIBTPLValueBoxDereference-251();
    void init();
    void cleanup();
    ...
    OAIBTPLValueBoxDereference-251* fromJson(QString jsonString) override;
    ...
    OAIBTPExpression-9* getBox();
    void setBox(OAIBTPExpression-9* box);

    OAIBTPSpace-10* getSpaceInside();
    void setSpaceInside(OAIBTPSpace-10* space_inside);
...
private:
    ...
    OAIBTPExpression-9* box;
    bool m_box_isSet;

    OAIBTPSpace-10* space_inside;
    bool m_space_inside_isSet;

};

}

#endif /* OAIBTPLValueBoxDereference-251_H_ */

...
/*
 * OAIBTMIndividualQuery-138.h
 *
 * 
 */

#ifndef OAIBTMIndividualQuery-138_H_
#define OAIBTMIndividualQuery-138_H_
...
class OAIBTMIndividualQuery-138: public OAIObject {
public:
    OAIBTMIndividualQuery-138();
    OAIBTMIndividualQuery-138(QString json);
    ~OAIBTMIndividualQuery-138();
    void init();
    void cleanup();
    ...
    OAIBTMIndividualQuery-138* fromJson(QString jsonString) override;
...
#endif /* OAIBTMIndividualQuery-138_H_ */

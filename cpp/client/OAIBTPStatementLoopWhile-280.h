...
/*
 * OAIBTPStatementLoopWhile-280.h
 *
 * 
 */

#ifndef OAIBTPStatementLoopWhile-280_H_
#define OAIBTPStatementLoopWhile-280_H_
...
class OAIBTPStatementLoopWhile-280: public OAIObject {
public:
    OAIBTPStatementLoopWhile-280();
    OAIBTPStatementLoopWhile-280(QString json);
    ~OAIBTPStatementLoopWhile-280();
    void init();
    void cleanup();
    ...
    OAIBTPStatementLoopWhile-280* fromJson(QString jsonString) override;
...
#endif /* OAIBTPStatementLoopWhile-280_H_ */

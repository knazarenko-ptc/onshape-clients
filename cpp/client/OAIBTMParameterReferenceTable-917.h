...
/*
 * OAIBTMParameterReferenceTable-917.h
 *
 * 
 */

#ifndef OAIBTMParameterReferenceTable-917_H_
#define OAIBTMParameterReferenceTable-917_H_
...
class OAIBTMParameterReferenceTable-917: public OAIObject {
public:
    OAIBTMParameterReferenceTable-917();
    OAIBTMParameterReferenceTable-917(QString json);
    ~OAIBTMParameterReferenceTable-917();
    void init();
    void cleanup();
    ...
    OAIBTMParameterReferenceTable-917* fromJson(QString jsonString) override;
...
#endif /* OAIBTMParameterReferenceTable-917_H_ */

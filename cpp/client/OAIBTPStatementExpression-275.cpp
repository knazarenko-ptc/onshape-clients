...
OAIBTPStatementExpression-275::OAIBTPStatementExpression-275(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPStatementExpression-275::OAIBTPStatementExpression-275() {
    init();
}
...
void
OAIBTPStatementExpression-275::init() {
    atomic = false;
...
void
OAIBTPStatementExpression-275::cleanup() {
...
OAIBTPStatementExpression-275*
OAIBTPStatementExpression-275::fromJson(QString json) {
...
void
OAIBTPStatementExpression-275::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPStatementExpression-275::asJson ()
{
...
QJsonObject
OAIBTPStatementExpression-275::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPStatementExpression-275::isAtomic() {
    return atomic;
}
void
OAIBTPStatementExpression-275::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPStatementExpression-275::getBtType() {
    return bt_type;
}
void
OAIBTPStatementExpression-275::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPStatementExpression-275::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPStatementExpression-275::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPStatementExpression-275::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPStatementExpression-275::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPStatementExpression-275::getNodeId() {
    return node_id;
}
void
OAIBTPStatementExpression-275::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPStatementExpression-275::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPStatementExpression-275::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementExpression-275::getSpaceAfter() {
    return space_after;
}
void
OAIBTPStatementExpression-275::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementExpression-275::getSpaceBefore() {
    return space_before;
}
void
OAIBTPStatementExpression-275::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPStatementExpression-275::isSpaceDefault() {
    return space_default;
}
void
OAIBTPStatementExpression-275::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPStatementExpression-275::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPStatementExpression-275::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPStatementExpression-275::getAnnotation() {
    return annotation;
}
void
OAIBTPStatementExpression-275::setAnnotation(OAIBTPAnnotation-231* annotation) {
    this->annotation = annotation;
    this->m_annotation_isSet = true;
}

OAIBTPExpression-9*
OAIBTPStatementExpression-275::getExpression() {
    return expression;
}
void
OAIBTPStatementExpression-275::setExpression(OAIBTPExpression-9* expression) {
...
bool
OAIBTPStatementExpression-275::isSet(){

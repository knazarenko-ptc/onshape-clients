...
OAIBTMInContextQuery-2254::OAIBTMInContextQuery-2254(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMInContextQuery-2254::OAIBTMInContextQuery-2254() {
    init();
}
...
void
OAIBTMInContextQuery-2254::init() {
    bt_type = new QString("");
...
void
OAIBTMInContextQuery-2254::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMInContextQuery-2254*
OAIBTMInContextQuery-2254::fromJson(QString json) {
...
void
OAIBTMInContextQuery-2254::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTMInContextQuery-2254::asJson ()
{
...
QJsonObject
OAIBTMInContextQuery-2254::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMInContextQuery-2254::getBtType() {
    return bt_type;
}
void
OAIBTMInContextQuery-2254::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

OAIBTMIndividualQueryBase-139*
OAIBTMInContextQuery-2254::getDeterministicIdList() {
    return deterministic_id_list;
}
void
OAIBTMInContextQuery-2254::setDeterministicIdList(OAIBTMIndividualQueryBase-139* deterministic_id_list) {
    this->deterministic_id_list = deterministic_id_list;
    this->m_deterministic_id_list_isSet = true;
}

QList<QString*>*
OAIBTMInContextQuery-2254::getDeterministicIds() {
    return deterministic_ids;
}
void
OAIBTMInContextQuery-2254::setDeterministicIds(QList<QString*>* deterministic_ids) {
    this->deterministic_ids = deterministic_ids;
    this->m_deterministic_ids_isSet = true;
}

QString*
OAIBTMInContextQuery-2254::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMInContextQuery-2254::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMInContextQuery-2254::getNodeId() {
    return node_id;
}
void
OAIBTMInContextQuery-2254::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

OAIBTMIndividualQueryBase-139*
OAIBTMInContextQuery-2254::getQuery() {
    return query;
}
void
OAIBTMInContextQuery-2254::setQuery(OAIBTMIndividualQueryBase-139* query) {
    this->query = query;
    this->m_query_isSet = true;
}

QString*
OAIBTMInContextQuery-2254::getQueryString() {
    return query_string;
}
void
OAIBTMInContextQuery-2254::setQueryString(QString* query_string) {
    this->query_string = query_string;
    this->m_query_string_isSet = true;
}

QList<QString*>*
OAIBTMInContextQuery-2254::getPath() {
    return path;
}
void
OAIBTMInContextQuery-2254::setPath(QList<QString*>* path) {
    this->path = path;
...
bool
OAIBTMInContextQuery-2254::isSet(){

...
OAIBTParameterSpecReferenceAssembly-2821::OAIBTParameterSpecReferenceAssembly-2821(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecReferenceAssembly-2821::OAIBTParameterSpecReferenceAssembly-2821() {
    init();
}
...
void
OAIBTParameterSpecReferenceAssembly-2821::init() {
...
void
OAIBTParameterSpecReferenceAssembly-2821::cleanup() {
...
OAIBTParameterSpecReferenceAssembly-2821*
OAIBTParameterSpecReferenceAssembly-2821::fromJson(QString json) {
...
void
OAIBTParameterSpecReferenceAssembly-2821::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTParameterSpecReferenceAssembly-2821::asJson ()
{
...
QJsonObject
OAIBTParameterSpecReferenceAssembly-2821::asJsonObject() {
    QJsonObject obj;
...
qint32
OAIBTParameterSpecReferenceAssembly-2821::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecReferenceAssembly-2821::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecReferenceAssembly-2821::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecReferenceAssembly-2821::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecReferenceAssembly-2821::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecReferenceAssembly-2821::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceAssembly-2821::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceAssembly-2821::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecReferenceAssembly-2821::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceAssembly-2821::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecReferenceAssembly-2821::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceAssembly-2821::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecReferenceAssembly-2821::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecReferenceAssembly-2821::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
...
bool
OAIBTParameterSpecReferenceAssembly-2821::isSet(){

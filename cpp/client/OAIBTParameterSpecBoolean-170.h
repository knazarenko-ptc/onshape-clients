...
/*
 * OAIBTParameterSpecBoolean-170.h
 *
 * 
 */

#ifndef OAIBTParameterSpecBoolean-170_H_
#define OAIBTParameterSpecBoolean-170_H_
...
class OAIBTParameterSpecBoolean-170: public OAIObject {
public:
    OAIBTParameterSpecBoolean-170();
    OAIBTParameterSpecBoolean-170(QString json);
    ~OAIBTParameterSpecBoolean-170();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecBoolean-170* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecBoolean-170_H_ */

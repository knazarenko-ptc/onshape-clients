...
/*
 * OAIBTDocumentElementProcessingInfo.h
 *
 * 
 */

#ifndef OAIBTDocumentElementProcessingInfo_H_
#define OAIBTDocumentElementProcessingInfo_H_
...
class OAIBTDocumentElementProcessingInfo: public OAIObject {
public:
    OAIBTDocumentElementProcessingInfo();
    OAIBTDocumentElementProcessingInfo(QString json);
    ~OAIBTDocumentElementProcessingInfo();
    void init();
    void cleanup();
    ...
    OAIBTDocumentElementProcessingInfo* fromJson(QString jsonString) override;
...
#endif /* OAIBTDocumentElementProcessingInfo_H_ */

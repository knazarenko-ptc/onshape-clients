...
/*
 * OAIBTParameterSpecNullableQuantity-715.h
 *
 * 
 */

#ifndef OAIBTParameterSpecNullableQuantity-715_H_
#define OAIBTParameterSpecNullableQuantity-715_H_
...
class OAIBTParameterSpecNullableQuantity-715: public OAIObject {
public:
    OAIBTParameterSpecNullableQuantity-715();
    OAIBTParameterSpecNullableQuantity-715(QString json);
    ~OAIBTParameterSpecNullableQuantity-715();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecNullableQuantity-715* fromJson(QString jsonString) override;
    ...
    QList<OAIBTNullableQuantityRange-1340*>* getRanges();
    void setRanges(QList<OAIBTNullableQuantityRange-1340*>* ranges);
...
private:
    ...
    QList<OAIBTNullableQuantityRange-1340*>* ranges;
    bool m_ranges_isSet;
...
#endif /* OAIBTParameterSpecNullableQuantity-715_H_ */

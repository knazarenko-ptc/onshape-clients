...
OAIBTParameterSpecString-175::OAIBTParameterSpecString-175(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecString-175::OAIBTParameterSpecString-175() {
    init();
}
...
void
OAIBTParameterSpecString-175::init() {
    ...
    format_conditions = new QList<OAIBTStringFormatCondition-683*>();
    m_format_conditions_isSet = false;
}

void
OAIBTParameterSpecString-175::cleanup() {
    ...
    if(format_conditions != nullptr) { 
        auto arr = format_conditions;
        for(auto o: *arr) { 
            delete o;
        }
        delete format_conditions;
    }
}

OAIBTParameterSpecString-175*
OAIBTParameterSpecString-175::fromJson(QString json) {
...
void
OAIBTParameterSpecString-175::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&format_conditions, pJson["formatConditions"], "QList", "OAIBTStringFormatCondition-683");
}

QString
OAIBTParameterSpecString-175::asJson ()
{
...
QJsonObject
OAIBTParameterSpecString-175::asJsonObject() {
    QJsonObject obj;
    ...
    if(format_conditions->size() > 0){
        toJsonArray((QList<void*>*)format_conditions, obj, "formatConditions", "OAIBTStringFormatCondition-683");
    }
...
qint32
OAIBTParameterSpecString-175::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecString-175::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecString-175::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecString-175::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecString-175::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecString-175::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecString-175::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecString-175::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecString-175::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecString-175::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecString-175::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecString-175::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecString-175::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecString-175::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecString-175::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecString-175::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecString-175::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecString-175::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecString-175::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecString-175::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecString-175::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecString-175::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecString-175::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecString-175::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecString-175::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecString-175::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
    this->visibility_condition = visibility_condition;
    this->m_visibility_condition_isSet = true;
}

QList<OAIBTStringFormatCondition-683*>*
OAIBTParameterSpecString-175::getFormatConditions() {
    return format_conditions;
}
void
OAIBTParameterSpecString-175::setFormatConditions(QList<OAIBTStringFormatCondition-683*>* format_conditions) {
    this->format_conditions = format_conditions;
    this->m_format_conditions_isSet = true;
}


bool
OAIBTParameterSpecString-175::isSet(){
    ...
    do{
        ...
        if(format_conditions->size() > 0){ isObjectUpdated = true; break;}
    }while(false);

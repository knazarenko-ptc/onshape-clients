...
OAIBTPExpressionIs-242::OAIBTPExpressionIs-242(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPExpressionIs-242::OAIBTPExpressionIs-242() {
    init();
}
...
void
OAIBTPExpressionIs-242::cleanup() {
...
OAIBTPExpressionIs-242*
OAIBTPExpressionIs-242::fromJson(QString json) {
...
void
OAIBTPExpressionIs-242::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIBTPExpressionIs-242::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPExpressionIs-242::isAtomic() {
    return atomic;
}
void
OAIBTPExpressionIs-242::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPExpressionIs-242::getBtType() {
    return bt_type;
}
void
OAIBTPExpressionIs-242::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPExpressionIs-242::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPExpressionIs-242::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPExpressionIs-242::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPExpressionIs-242::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPExpressionIs-242::getNodeId() {
    return node_id;
}
void
OAIBTPExpressionIs-242::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPExpressionIs-242::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPExpressionIs-242::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpressionIs-242::getSpaceAfter() {
    return space_after;
}
void
OAIBTPExpressionIs-242::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpressionIs-242::getSpaceBefore() {
    return space_before;
}
void
OAIBTPExpressionIs-242::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPExpressionIs-242::isSpaceDefault() {
    return space_default;
}
void
OAIBTPExpressionIs-242::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPExpressionIs-242::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPExpressionIs-242::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPTypeName-290*
OAIBTPExpressionIs-242::getTypeName() {
    return type_name;
}
void
OAIBTPExpressionIs-242::setTypeName(OAIBTPTypeName-290* type_name) {
    this->type_name = type_name;
    this->m_type_name_isSet = true;
}

OAIBTPExpression-9*
OAIBTPExpressionIs-242::getOperand() {
    return operand;
}
void
OAIBTPExpressionIs-242::setOperand(OAIBTPExpression-9* operand) {

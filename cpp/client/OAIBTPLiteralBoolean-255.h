...
/*
 * OAIBTPLiteralBoolean-255.h
 *
 * 
 */

#ifndef OAIBTPLiteralBoolean-255_H_
#define OAIBTPLiteralBoolean-255_H_
...
class OAIBTPLiteralBoolean-255: public OAIObject {
public:
    OAIBTPLiteralBoolean-255();
    OAIBTPLiteralBoolean-255(QString json);
    ~OAIBTPLiteralBoolean-255();
    void init();
    void cleanup();
    ...
    OAIBTPLiteralBoolean-255* fromJson(QString jsonString) override;
...
#endif /* OAIBTPLiteralBoolean-255_H_ */

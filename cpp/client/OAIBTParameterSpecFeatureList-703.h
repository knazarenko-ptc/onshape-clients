...
/*
 * OAIBTParameterSpecFeatureList-703.h
 *
 * 
 */

#ifndef OAIBTParameterSpecFeatureList-703_H_
#define OAIBTParameterSpecFeatureList-703_H_
...
class OAIBTParameterSpecFeatureList-703: public OAIObject {
public:
    OAIBTParameterSpecFeatureList-703();
    OAIBTParameterSpecFeatureList-703(QString json);
    ~OAIBTParameterSpecFeatureList-703();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecFeatureList-703* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecFeatureList-703_H_ */

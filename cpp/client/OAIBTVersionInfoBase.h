...
/*
 * OAIBTVersionInfoBase.h
 *
 * 
 */

#ifndef OAIBTVersionInfoBase_H_
#define OAIBTVersionInfoBase_H_
...
class OAIBTVersionInfoBase: public OAIObject {
public:
    OAIBTVersionInfoBase();
    OAIBTVersionInfoBase(QString json);
    ~OAIBTVersionInfoBase();
    void init();
    void cleanup();
    ...
    OAIBTVersionInfoBase* fromJson(QString jsonString) override;

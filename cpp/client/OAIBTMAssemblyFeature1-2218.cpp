...
OAIBTMAssemblyFeature1-2218::OAIBTMAssemblyFeature1-2218(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMAssemblyFeature1-2218::OAIBTMAssemblyFeature1-2218() {
    init();
}
...
void
OAIBTMAssemblyFeature1-2218::init() {
    bt_type = new QString("");
...
void
OAIBTMAssemblyFeature1-2218::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMAssemblyFeature1-2218*
OAIBTMAssemblyFeature1-2218::fromJson(QString json) {
...
void
OAIBTMAssemblyFeature1-2218::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTMAssemblyFeature1-2218::asJson ()
{
...
QJsonObject
OAIBTMAssemblyFeature1-2218::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMAssemblyFeature1-2218::getBtType() {
    return bt_type;
}
void
OAIBTMAssemblyFeature1-2218::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMAssemblyFeature1-2218::getFeatureId() {
    return feature_id;
}
void
OAIBTMAssemblyFeature1-2218::setFeatureId(QString* feature_id) {
    this->feature_id = feature_id;
    this->m_feature_id_isSet = true;
}

QString*
OAIBTMAssemblyFeature1-2218::getFeatureType() {
    return feature_type;
}
void
OAIBTMAssemblyFeature1-2218::setFeatureType(QString* feature_type) {
    this->feature_type = feature_type;
    this->m_feature_type_isSet = true;
}

QString*
OAIBTMAssemblyFeature1-2218::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMAssemblyFeature1-2218::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMAssemblyFeature1-2218::getName() {
    return name;
}
void
OAIBTMAssemblyFeature1-2218::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString*
OAIBTMAssemblyFeature1-2218::getNamespace() {
    return _namespace;
}
void
OAIBTMAssemblyFeature1-2218::setNamespace(QString* _namespace) {
    this->_namespace = _namespace;
    this->m__namespace_isSet = true;
}

QString*
OAIBTMAssemblyFeature1-2218::getNodeId() {
    return node_id;
}
void
OAIBTMAssemblyFeature1-2218::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QList<OAIBTMParameter-1*>*
OAIBTMAssemblyFeature1-2218::getParameters() {
    return parameters;
}
void
OAIBTMAssemblyFeature1-2218::setParameters(QList<OAIBTMParameter-1*>* parameters) {
    this->parameters = parameters;
    this->m_parameters_isSet = true;
}

bool
OAIBTMAssemblyFeature1-2218::isReturnAfterSubfeatures() {
    return return_after_subfeatures;
}
void
OAIBTMAssemblyFeature1-2218::setReturnAfterSubfeatures(bool return_after_subfeatures) {
    this->return_after_subfeatures = return_after_subfeatures;
    this->m_return_after_subfeatures_isSet = true;
}

QList<OAIBTMFeature-134*>*
OAIBTMAssemblyFeature1-2218::getSubFeatures() {
    return sub_features;
}
void
OAIBTMAssemblyFeature1-2218::setSubFeatures(QList<OAIBTMFeature-134*>* sub_features) {
    this->sub_features = sub_features;
    this->m_sub_features_isSet = true;
}

bool
OAIBTMAssemblyFeature1-2218::isSuppressed() {
    return suppressed;
}
void
OAIBTMAssemblyFeature1-2218::setSuppressed(bool suppressed) {
    this->suppressed = suppressed;
    this->m_suppressed_isSet = true;
}

bool
OAIBTMAssemblyFeature1-2218::isAuxiliaryAssemblyFeature() {
    return auxiliary_assembly_feature;
}
void
OAIBTMAssemblyFeature1-2218::setAuxiliaryAssemblyFeature(bool auxiliary_assembly_feature) {
    this->auxiliary_assembly_feature = auxiliary_assembly_feature;
    this->m_auxiliary_assembly_feature_isSet = true;
}

qint32
OAIBTMAssemblyFeature1-2218::getFeatureListFieldIndex() {
    return feature_list_field_index;
}
void
OAIBTMAssemblyFeature1-2218::setFeatureListFieldIndex(qint32 feature_list_field_index) {
...
OAIBTMAssemblyFeature1-2218::getOccurrenceQueriesFromAllConfigurations() {
    return occurrence_queries_from_all_configurations;
}
void
OAIBTMAssemblyFeature1-2218::setOccurrenceQueriesFromAllConfigurations(QList<OAIBTMIndividualQueryWithOccurrenceBase-904*>* occurrence_queries_from_all_configurations) {
...
qint32
OAIBTMAssemblyFeature1-2218::getVersion() {
    return version;
}
void
OAIBTMAssemblyFeature1-2218::setVersion(qint32 version) {
...
bool
OAIBTMAssemblyFeature1-2218::isSet(){

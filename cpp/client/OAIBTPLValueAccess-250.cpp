...
OAIBTPLValueAccess-250::OAIBTPLValueAccess-250(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLValueAccess-250::OAIBTPLValueAccess-250() {
    init();
}
...
OAIBTPLValueAccess-250::init() {
    ...
    base = new OAIBTPLValue-249();
    m_base_isSet = false;
}

void
OAIBTPLValueAccess-250::cleanup() {
...
OAIBTPLValueAccess-250*
OAIBTPLValueAccess-250::fromJson(QString json) {
...
void
OAIBTPLValueAccess-250::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&base, pJson["base"], "OAIBTPLValue-249", "OAIBTPLValue-249");
    
}

QString
OAIBTPLValueAccess-250::asJson ()
{
...
QJsonObject
OAIBTPLValueAccess-250::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
    ...
    if((base != nullptr) && (base->isSet())){
        toJsonValue(QString("base"), base, obj, QString("OAIBTPLValue-249"));
    }
...
bool
OAIBTPLValueAccess-250::isAtomic() {
    return atomic;
}
void
OAIBTPLValueAccess-250::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLValueAccess-250::getBtType() {
    return bt_type;
}
void
OAIBTPLValueAccess-250::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLValueAccess-250::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLValueAccess-250::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLValueAccess-250::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLValueAccess-250::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPLValueAccess-250::getNodeId() {
    return node_id;
}
void
OAIBTPLValueAccess-250::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLValueAccess-250::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLValueAccess-250::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLValueAccess-250::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLValueAccess-250::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLValueAccess-250::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLValueAccess-250::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLValueAccess-250::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLValueAccess-250::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPLValueAccess-250::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLValueAccess-250::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPPropertyAccessor-23*
OAIBTPLValueAccess-250::getAccessor() {
    return accessor;
}
void
OAIBTPLValueAccess-250::setAccessor(OAIBTPPropertyAccessor-23* accessor) {
    this->accessor = accessor;
    this->m_accessor_isSet = true;
}

OAIBTPLValue-249*
OAIBTPLValueAccess-250::getBase() {
    return base;
}
void
OAIBTPLValueAccess-250::setBase(OAIBTPLValue-249* base) {
    this->base = base;

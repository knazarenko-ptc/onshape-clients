...
/*
 * OAIBTPProcedureDeclarationBase-266.h
 *
 * 
 */

#ifndef OAIBTPProcedureDeclarationBase-266_H_
#define OAIBTPProcedureDeclarationBase-266_H_
...
class OAIBTPProcedureDeclarationBase-266: public OAIObject {
public:
    OAIBTPProcedureDeclarationBase-266();
    OAIBTPProcedureDeclarationBase-266(QString json);
    ~OAIBTPProcedureDeclarationBase-266();
    void init();
    void cleanup();
    ...
    OAIBTPProcedureDeclarationBase-266* fromJson(QString jsonString) override;
...
#endif /* OAIBTPProcedureDeclarationBase-266_H_ */

...
/*
 * OAIBTMMateRelation-1412.h
 *
 * 
 */

#ifndef OAIBTMMateRelation-1412_H_
#define OAIBTMMateRelation-1412_H_
...
class OAIBTMMateRelation-1412: public OAIObject {
public:
    OAIBTMMateRelation-1412();
    OAIBTMMateRelation-1412(QString json);
    ~OAIBTMMateRelation-1412();
    void init();
    void cleanup();
    ...
    OAIBTMMateRelation-1412* fromJson(QString jsonString) override;
...
#endif /* OAIBTMMateRelation-1412_H_ */

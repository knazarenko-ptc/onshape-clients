...
OAIBTGlobalTreeMagicNodeInfo::OAIBTGlobalTreeMagicNodeInfo(QString json) {
    init();
    this->fromJson(json);
}

OAIBTGlobalTreeMagicNodeInfo::OAIBTGlobalTreeMagicNodeInfo() {
    init();
}
...
void
OAIBTGlobalTreeMagicNodeInfo::init() {
    can_move = false;
...
void
OAIBTGlobalTreeMagicNodeInfo::cleanup() {
...
OAIBTGlobalTreeMagicNodeInfo::fromJson(QString json) {
...
void
OAIBTGlobalTreeMagicNodeInfo::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&sub_type, pJson["subType"], "qint32", "");
    
}

QString
OAIBTGlobalTreeMagicNodeInfo::asJson ()
{
...
QJsonObject
OAIBTGlobalTreeMagicNodeInfo::asJsonObject() {
    QJsonObject obj;
    if(m_can_move_isSet){
    ...
    if(m_sub_type_isSet){
        obj.insert("subType", QJsonValue(sub_type));
    }
...
bool
OAIBTGlobalTreeMagicNodeInfo::isCanMove() {
    return can_move;
}
void
OAIBTGlobalTreeMagicNodeInfo::setCanMove(bool can_move) {
    this->can_move = can_move;
    this->m_can_move_isSet = true;
}

QDateTime*
OAIBTGlobalTreeMagicNodeInfo::getCreatedAt() {
    return created_at;
}
void
OAIBTGlobalTreeMagicNodeInfo::setCreatedAt(QDateTime* created_at) {
    this->created_at = created_at;
    this->m_created_at_isSet = true;
}

OAIBTUserBasicSummaryInfo*
OAIBTGlobalTreeMagicNodeInfo::getCreatedBy() {
    return created_by;
}
void
OAIBTGlobalTreeMagicNodeInfo::setCreatedBy(OAIBTUserBasicSummaryInfo* created_by) {
    this->created_by = created_by;
    this->m_created_by_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getDescription() {
    return description;
}
void
OAIBTGlobalTreeMagicNodeInfo::setDescription(QString* description) {
    this->description = description;
    this->m_description_isSet = true;
}

bool
OAIBTGlobalTreeMagicNodeInfo::isHasPendingOwner() {
    return has_pending_owner;
}
void
OAIBTGlobalTreeMagicNodeInfo::setHasPendingOwner(bool has_pending_owner) {
    this->has_pending_owner = has_pending_owner;
    this->m_has_pending_owner_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getHref() {
    return href;
}
void
OAIBTGlobalTreeMagicNodeInfo::setHref(QString* href) {
    this->href = href;
    this->m_href_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getId() {
    return id;
}
void
OAIBTGlobalTreeMagicNodeInfo::setId(QString* id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool
OAIBTGlobalTreeMagicNodeInfo::isIsContainer() {
    return is_container;
}
void
OAIBTGlobalTreeMagicNodeInfo::setIsContainer(bool is_container) {
    this->is_container = is_container;
    this->m_is_container_isSet = true;
}

bool
OAIBTGlobalTreeMagicNodeInfo::isIsEnterpriseOwned() {
    return is_enterprise_owned;
}
void
OAIBTGlobalTreeMagicNodeInfo::setIsEnterpriseOwned(bool is_enterprise_owned) {
    this->is_enterprise_owned = is_enterprise_owned;
    this->m_is_enterprise_owned_isSet = true;
}

bool
OAIBTGlobalTreeMagicNodeInfo::isIsMutable() {
    return is_mutable;
}
void
OAIBTGlobalTreeMagicNodeInfo::setIsMutable(bool is_mutable) {
    this->is_mutable = is_mutable;
    this->m_is_mutable_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getJsonType() {
    return json_type;
}
void
OAIBTGlobalTreeMagicNodeInfo::setJsonType(QString* json_type) {
    this->json_type = json_type;
    this->m_json_type_isSet = true;
}

QDateTime*
OAIBTGlobalTreeMagicNodeInfo::getModifiedAt() {
    return modified_at;
}
void
OAIBTGlobalTreeMagicNodeInfo::setModifiedAt(QDateTime* modified_at) {
    this->modified_at = modified_at;
    this->m_modified_at_isSet = true;
}

OAIBTUserBasicSummaryInfo*
OAIBTGlobalTreeMagicNodeInfo::getModifiedBy() {
    return modified_by;
}
void
OAIBTGlobalTreeMagicNodeInfo::setModifiedBy(OAIBTUserBasicSummaryInfo* modified_by) {
    this->modified_by = modified_by;
    this->m_modified_by_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getName() {
    return name;
}
void
OAIBTGlobalTreeMagicNodeInfo::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

OAIBTOwnerInfo*
OAIBTGlobalTreeMagicNodeInfo::getOwner() {
    return owner;
}
void
OAIBTGlobalTreeMagicNodeInfo::setOwner(OAIBTOwnerInfo* owner) {
    this->owner = owner;
    this->m_owner_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getProjectId() {
    return project_id;
}
void
OAIBTGlobalTreeMagicNodeInfo::setProjectId(QString* project_id) {
    this->project_id = project_id;
    this->m_project_id_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getResourceType() {
    return resource_type;
}
void
OAIBTGlobalTreeMagicNodeInfo::setResourceType(QString* resource_type) {
    this->resource_type = resource_type;
    this->m_resource_type_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getTreeHref() {
    return tree_href;
}
void
OAIBTGlobalTreeMagicNodeInfo::setTreeHref(QString* tree_href) {
    this->tree_href = tree_href;
    this->m_tree_href_isSet = true;
}

QString*
OAIBTGlobalTreeMagicNodeInfo::getViewRef() {
    return view_ref;
}
void
OAIBTGlobalTreeMagicNodeInfo::setViewRef(QString* view_ref) {
    this->view_ref = view_ref;
    this->m_view_ref_isSet = true;
}

qint32
OAIBTGlobalTreeMagicNodeInfo::getSubType() {
    return sub_type;
}
void
OAIBTGlobalTreeMagicNodeInfo::setSubType(qint32 sub_type) {
    this->sub_type = sub_type;
    this->m_sub_type_isSet = true;
}


bool
OAIBTGlobalTreeMagicNodeInfo::isSet(){
    ...
    do{
        ...
        if(m_sub_type_isSet){ isObjectUpdated = true; break;}
    }while(false);

...
/*
 * OAIBTParameterSpecEnum-171.h
 *
 * 
 */

#ifndef OAIBTParameterSpecEnum-171_H_
#define OAIBTParameterSpecEnum-171_H_
...
class OAIBTParameterSpecEnum-171: public OAIObject {
public:
    OAIBTParameterSpecEnum-171();
    OAIBTParameterSpecEnum-171(QString json);
    ~OAIBTParameterSpecEnum-171();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecEnum-171* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecEnum-171_H_ */

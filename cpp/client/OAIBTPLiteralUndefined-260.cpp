...
OAIBTPLiteralUndefined-260::OAIBTPLiteralUndefined-260(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLiteralUndefined-260::OAIBTPLiteralUndefined-260() {
    init();
}
...
void
OAIBTPLiteralUndefined-260::init() {
    atomic = false;
...
void
OAIBTPLiteralUndefined-260::cleanup() {
...
OAIBTPLiteralUndefined-260*
OAIBTPLiteralUndefined-260::fromJson(QString json) {
...
void
OAIBTPLiteralUndefined-260::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPLiteralUndefined-260::asJson ()
{
...
QJsonObject
OAIBTPLiteralUndefined-260::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPLiteralUndefined-260::isAtomic() {
    return atomic;
}
void
OAIBTPLiteralUndefined-260::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLiteralUndefined-260::getBtType() {
    return bt_type;
}
void
OAIBTPLiteralUndefined-260::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLiteralUndefined-260::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLiteralUndefined-260::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLiteralUndefined-260::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLiteralUndefined-260::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPLiteralUndefined-260::getNodeId() {
    return node_id;
}
void
OAIBTPLiteralUndefined-260::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLiteralUndefined-260::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLiteralUndefined-260::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralUndefined-260::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLiteralUndefined-260::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralUndefined-260::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLiteralUndefined-260::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLiteralUndefined-260::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLiteralUndefined-260::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPLiteralUndefined-260::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLiteralUndefined-260::setStartSourceLocation(qint32 start_source_location) {
...
bool
OAIBTPLiteralUndefined-260::isSet(){

...
/*
 * OAIBTParameterSpecReferenceAssembly-2821.h
 *
 * 
 */

#ifndef OAIBTParameterSpecReferenceAssembly-2821_H_
#define OAIBTParameterSpecReferenceAssembly-2821_H_
...
class OAIBTParameterSpecReferenceAssembly-2821: public OAIObject {
public:
    OAIBTParameterSpecReferenceAssembly-2821();
    OAIBTParameterSpecReferenceAssembly-2821(QString json);
    ~OAIBTParameterSpecReferenceAssembly-2821();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecReferenceAssembly-2821* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecReferenceAssembly-2821_H_ */

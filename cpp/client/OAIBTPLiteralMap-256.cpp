...
OAIBTPLiteralMap-256::OAIBTPLiteralMap-256(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLiteralMap-256::OAIBTPLiteralMap-256() {
    init();
}
...
OAIBTPLiteralMap-256::init() {
    ...
    entries = new QList<OAIBTPLiteralMapEntry-257*>();
...
OAIBTPLiteralMap-256::fromJson(QString json) {
...
void
OAIBTPLiteralMap-256::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&entries, pJson["entries"], "QList", "OAIBTPLiteralMapEntry-257");
...
QJsonObject
OAIBTPLiteralMap-256::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
    ...
    if(entries->size() > 0){
        toJsonArray((QList<void*>*)entries, obj, "entries", "OAIBTPLiteralMapEntry-257");
    }
...
bool
OAIBTPLiteralMap-256::isAtomic() {
    return atomic;
}
void
OAIBTPLiteralMap-256::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLiteralMap-256::getBtType() {
    return bt_type;
}
void
OAIBTPLiteralMap-256::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLiteralMap-256::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLiteralMap-256::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLiteralMap-256::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLiteralMap-256::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QList<OAIBTPLiteralMapEntry-257*>*
OAIBTPLiteralMap-256::getEntries() {
    return entries;
}
void
OAIBTPLiteralMap-256::setEntries(QList<OAIBTPLiteralMapEntry-257*>* entries) {
    this->entries = entries;
    this->m_entries_isSet = true;
}

QString*
OAIBTPLiteralMap-256::getNodeId() {
    return node_id;
}
void
OAIBTPLiteralMap-256::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLiteralMap-256::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLiteralMap-256::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralMap-256::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLiteralMap-256::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralMap-256::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLiteralMap-256::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLiteralMap-256::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLiteralMap-256::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralMap-256::getSpaceInEmptyList() {
    return space_in_empty_list;
}
void
OAIBTPLiteralMap-256::setSpaceInEmptyList(OAIBTPSpace-10* space_in_empty_list) {
    this->space_in_empty_list = space_in_empty_list;
    this->m_space_in_empty_list_isSet = true;
}

qint32
OAIBTPLiteralMap-256::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLiteralMap-256::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

bool
OAIBTPLiteralMap-256::isTrailingComma() {
    return trailing_comma;
}
void
OAIBTPLiteralMap-256::setTrailingComma(bool trailing_comma) {

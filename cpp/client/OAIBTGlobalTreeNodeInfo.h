...
/*
 * OAIBTGlobalTreeNodeInfo.h
 *
 * 
 */

#ifndef OAIBTGlobalTreeNodeInfo_H_
#define OAIBTGlobalTreeNodeInfo_H_
...
class OAIBTGlobalTreeNodeInfo: public OAIObject {
public:
    OAIBTGlobalTreeNodeInfo();
    OAIBTGlobalTreeNodeInfo(QString json);
    ~OAIBTGlobalTreeNodeInfo();
    void init();
    void cleanup();
    ...
    OAIBTGlobalTreeNodeInfo* fromJson(QString jsonString) override;
...
#endif /* OAIBTGlobalTreeNodeInfo_H_ */

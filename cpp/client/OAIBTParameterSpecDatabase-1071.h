...
/*
 * OAIBTParameterSpecDatabase-1071.h
 *
 * 
 */

#ifndef OAIBTParameterSpecDatabase-1071_H_
#define OAIBTParameterSpecDatabase-1071_H_
...
class OAIBTParameterSpecDatabase-1071: public OAIObject {
public:
    OAIBTParameterSpecDatabase-1071();
    OAIBTParameterSpecDatabase-1071(QString json);
    ~OAIBTParameterSpecDatabase-1071();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecDatabase-1071* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecDatabase-1071_H_ */

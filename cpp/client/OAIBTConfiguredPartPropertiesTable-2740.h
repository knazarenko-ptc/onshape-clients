...
/*
 * OAIBTConfiguredPartPropertiesTable-2740.h
 *
 * 
 */

#ifndef OAIBTConfiguredPartPropertiesTable-2740_H_
#define OAIBTConfiguredPartPropertiesTable-2740_H_
...
class OAIBTConfiguredPartPropertiesTable-2740: public OAIObject {
public:
    OAIBTConfiguredPartPropertiesTable-2740();
    OAIBTConfiguredPartPropertiesTable-2740(QString json);
    ~OAIBTConfiguredPartPropertiesTable-2740();
    void init();
    void cleanup();
    ...
    OAIBTConfiguredPartPropertiesTable-2740* fromJson(QString jsonString) override;
    ...
    QString* getPartDeterministicId();
    void setPartDeterministicId(QString* part_deterministic_id);

    QString* getPropertyNodeId();
    void setPropertyNodeId(QString* property_node_id);

    QList<QString*>* getPartDeterministicIds();
    void setPartDeterministicIds(QList<QString*>* part_deterministic_ids);
...
private:
    ...
    QString* part_deterministic_id;
    bool m_part_deterministic_id_isSet;

    QString* property_node_id;
    bool m_property_node_id_isSet;

    QList<QString*>* part_deterministic_ids;
    bool m_part_deterministic_ids_isSet;

};

}

#endif /* OAIBTConfiguredPartPropertiesTable-2740_H_ */

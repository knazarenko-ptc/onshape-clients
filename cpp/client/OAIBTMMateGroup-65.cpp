...
OAIBTMMateGroup-65::OAIBTMMateGroup-65(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMMateGroup-65::OAIBTMMateGroup-65() {
    init();
}
...
OAIBTMMateGroup-65*
OAIBTMMateGroup-65::fromJson(QString json) {
...
void
OAIBTMMateGroup-65::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIBTMMateGroup-65::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMMateGroup-65::getBtType() {
    return bt_type;
}
void
OAIBTMMateGroup-65::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMMateGroup-65::getFeatureId() {
    return feature_id;
}
void
OAIBTMMateGroup-65::setFeatureId(QString* feature_id) {
    this->feature_id = feature_id;
    this->m_feature_id_isSet = true;
}

QString*
OAIBTMMateGroup-65::getFeatureType() {
    return feature_type;
}
void
OAIBTMMateGroup-65::setFeatureType(QString* feature_type) {
    this->feature_type = feature_type;
    this->m_feature_type_isSet = true;
}

QString*
OAIBTMMateGroup-65::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMMateGroup-65::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMMateGroup-65::getName() {
    return name;
}
void
OAIBTMMateGroup-65::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString*
OAIBTMMateGroup-65::getNamespace() {
    return _namespace;
}
void
OAIBTMMateGroup-65::setNamespace(QString* _namespace) {
    this->_namespace = _namespace;
    this->m__namespace_isSet = true;
}

QString*
OAIBTMMateGroup-65::getNodeId() {
    return node_id;
}
void
OAIBTMMateGroup-65::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QList<OAIBTMParameter-1*>*
OAIBTMMateGroup-65::getParameters() {
    return parameters;
}
void
OAIBTMMateGroup-65::setParameters(QList<OAIBTMParameter-1*>* parameters) {
    this->parameters = parameters;
    this->m_parameters_isSet = true;
}

bool
OAIBTMMateGroup-65::isReturnAfterSubfeatures() {
    return return_after_subfeatures;
}
void
OAIBTMMateGroup-65::setReturnAfterSubfeatures(bool return_after_subfeatures) {
    this->return_after_subfeatures = return_after_subfeatures;
    this->m_return_after_subfeatures_isSet = true;
}

QList<OAIBTMFeature-134*>*
OAIBTMMateGroup-65::getSubFeatures() {
    return sub_features;
}
void
OAIBTMMateGroup-65::setSubFeatures(QList<OAIBTMFeature-134*>* sub_features) {
    this->sub_features = sub_features;
    this->m_sub_features_isSet = true;
}

bool
OAIBTMMateGroup-65::isSuppressed() {
    return suppressed;
}
void
OAIBTMMateGroup-65::setSuppressed(bool suppressed) {
    this->suppressed = suppressed;
    this->m_suppressed_isSet = true;
}

bool
OAIBTMMateGroup-65::isAuxiliaryAssemblyFeature() {
    return auxiliary_assembly_feature;
}
void
OAIBTMMateGroup-65::setAuxiliaryAssemblyFeature(bool auxiliary_assembly_feature) {
    this->auxiliary_assembly_feature = auxiliary_assembly_feature;
    this->m_auxiliary_assembly_feature_isSet = true;
}

qint32
OAIBTMMateGroup-65::getFeatureListFieldIndex() {
    return feature_list_field_index;
}
void
OAIBTMMateGroup-65::setFeatureListFieldIndex(qint32 feature_list_field_index) {
...
OAIBTMMateGroup-65::getOccurrenceQueriesFromAllConfigurations() {
    return occurrence_queries_from_all_configurations;
}
void
OAIBTMMateGroup-65::setOccurrenceQueriesFromAllConfigurations(QList<OAIBTMIndividualQueryWithOccurrenceBase-904*>* occurrence_queries_from_all_configurations) {
...
qint32
OAIBTMMateGroup-65::getVersion() {
    return version;
}
void
OAIBTMMateGroup-65::setVersion(qint32 version) {

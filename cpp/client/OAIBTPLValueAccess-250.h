...
/*
 * OAIBTPLValueAccess-250.h
 *
 * 
 */

#ifndef OAIBTPLValueAccess-250_H_
#define OAIBTPLValueAccess-250_H_
...
class OAIBTPLValueAccess-250: public OAIObject {
public:
    OAIBTPLValueAccess-250();
    OAIBTPLValueAccess-250(QString json);
    ~OAIBTPLValueAccess-250();
    void init();
    void cleanup();
    ...
    OAIBTPLValueAccess-250* fromJson(QString jsonString) override;
    ...
    OAIBTPLValue-249* getBase();
    void setBase(OAIBTPLValue-249* base);
...
#endif /* OAIBTPLValueAccess-250_H_ */

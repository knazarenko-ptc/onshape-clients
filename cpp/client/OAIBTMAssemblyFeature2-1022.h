...
/*
 * OAIBTMAssemblyFeature2-1022.h
 *
 * 
 */

#ifndef OAIBTMAssemblyFeature2-1022_H_
#define OAIBTMAssemblyFeature2-1022_H_
...
class OAIBTMAssemblyFeature2-1022: public OAIObject {
public:
    OAIBTMAssemblyFeature2-1022();
    OAIBTMAssemblyFeature2-1022(QString json);
    ~OAIBTMAssemblyFeature2-1022();
    void init();
    void cleanup();
    ...
    OAIBTMAssemblyFeature2-1022* fromJson(QString jsonString) override;
...
#endif /* OAIBTMAssemblyFeature2-1022_H_ */

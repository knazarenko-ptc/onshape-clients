...
OAIBTPPropertyAccessor-23::OAIBTPPropertyAccessor-23(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPPropertyAccessor-23::OAIBTPPropertyAccessor-23() {
    init();
}
...
void
OAIBTPPropertyAccessor-23::init() {
    atomic = false;
...
void
OAIBTPPropertyAccessor-23::cleanup() {
...
OAIBTPPropertyAccessor-23::fromJson(QString json) {
...
void
OAIBTPPropertyAccessor-23::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPPropertyAccessor-23::asJson ()
{
...
QJsonObject
OAIBTPPropertyAccessor-23::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPPropertyAccessor-23::isAtomic() {
    return atomic;
}
void
OAIBTPPropertyAccessor-23::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPPropertyAccessor-23::getBtType() {
    return bt_type;
}
void
OAIBTPPropertyAccessor-23::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPPropertyAccessor-23::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPPropertyAccessor-23::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPPropertyAccessor-23::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPPropertyAccessor-23::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPPropertyAccessor-23::getNodeId() {
    return node_id;
}
void
OAIBTPPropertyAccessor-23::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPPropertyAccessor-23::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPPropertyAccessor-23::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPPropertyAccessor-23::getSpaceAfter() {
    return space_after;
}
void
OAIBTPPropertyAccessor-23::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPPropertyAccessor-23::getSpaceBefore() {
    return space_before;
}
void
OAIBTPPropertyAccessor-23::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPPropertyAccessor-23::isSpaceDefault() {
    return space_default;
}
void
OAIBTPPropertyAccessor-23::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPPropertyAccessor-23::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPPropertyAccessor-23::setStartSourceLocation(qint32 start_source_location) {
...
bool
OAIBTPPropertyAccessor-23::isSet(){

...
OAIBTParameterSpecReferenceJSON-1816::OAIBTParameterSpecReferenceJSON-1816(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecReferenceJSON-1816::OAIBTParameterSpecReferenceJSON-1816() {
    init();
}
...
void
OAIBTParameterSpecReferenceJSON-1816::init() {
...
void
OAIBTParameterSpecReferenceJSON-1816::cleanup() {
...
OAIBTParameterSpecReferenceJSON-1816*
OAIBTParameterSpecReferenceJSON-1816::fromJson(QString json) {
...
void
OAIBTParameterSpecReferenceJSON-1816::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTParameterSpecReferenceJSON-1816::asJson ()
{
...
QJsonObject
OAIBTParameterSpecReferenceJSON-1816::asJsonObject() {
    QJsonObject obj;
...
qint32
OAIBTParameterSpecReferenceJSON-1816::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecReferenceJSON-1816::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecReferenceJSON-1816::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecReferenceJSON-1816::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecReferenceJSON-1816::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecReferenceJSON-1816::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecReferenceJSON-1816::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecReferenceJSON-1816::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecReferenceJSON-1816::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecReferenceJSON-1816::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecReferenceJSON-1816::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecReferenceJSON-1816::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceJSON-1816::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecReferenceJSON-1816::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceJSON-1816::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecReferenceJSON-1816::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecReferenceJSON-1816::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecReferenceJSON-1816::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceJSON-1816::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecReferenceJSON-1816::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecReferenceJSON-1816::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecReferenceJSON-1816::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceJSON-1816::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecReferenceJSON-1816::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecReferenceJSON-1816::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecReferenceJSON-1816::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
...
bool
OAIBTParameterSpecReferenceJSON-1816::isSet(){

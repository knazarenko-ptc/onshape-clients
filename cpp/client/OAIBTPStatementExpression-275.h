...
/*
 * OAIBTPStatementExpression-275.h
 *
 * 
 */

#ifndef OAIBTPStatementExpression-275_H_
#define OAIBTPStatementExpression-275_H_
...
class OAIBTPStatementExpression-275: public OAIObject {
public:
    OAIBTPStatementExpression-275();
    OAIBTPStatementExpression-275(QString json);
    ~OAIBTPStatementExpression-275();
    void init();
    void cleanup();
    ...
    OAIBTPStatementExpression-275* fromJson(QString jsonString) override;
...
#endif /* OAIBTPStatementExpression-275_H_ */

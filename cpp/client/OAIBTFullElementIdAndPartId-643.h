...
/*
 * OAIBTFullElementIdAndPartId-643.h
 *
 * 
 */

#ifndef OAIBTFullElementIdAndPartId-643_H_
#define OAIBTFullElementIdAndPartId-643_H_
...
class OAIBTFullElementIdAndPartId-643: public OAIObject {
public:
    OAIBTFullElementIdAndPartId-643();
    OAIBTFullElementIdAndPartId-643(QString json);
    ~OAIBTFullElementIdAndPartId-643();
    void init();
    void cleanup();
    ...
    OAIBTFullElementIdAndPartId-643* fromJson(QString jsonString) override;
...
#endif /* OAIBTFullElementIdAndPartId-643_H_ */

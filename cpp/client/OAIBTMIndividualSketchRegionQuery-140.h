...
/*
 * OAIBTMIndividualSketchRegionQuery-140.h
 *
 * 
 */

#ifndef OAIBTMIndividualSketchRegionQuery-140_H_
#define OAIBTMIndividualSketchRegionQuery-140_H_
...
class OAIBTMIndividualSketchRegionQuery-140: public OAIObject {
public:
    OAIBTMIndividualSketchRegionQuery-140();
    OAIBTMIndividualSketchRegionQuery-140(QString json);
    ~OAIBTMIndividualSketchRegionQuery-140();
    void init();
    void cleanup();
    ...
    OAIBTMIndividualSketchRegionQuery-140* fromJson(QString jsonString) override;
    ...
    bool isFilterInnerLoops();
    void setFilterInnerLoops(bool filter_inner_loops);
...
private:
    ...
    bool filter_inner_loops;
    bool m_filter_inner_loops_isSet;

};

}

#endif /* OAIBTMIndividualSketchRegionQuery-140_H_ */

...
/*
 * OAIBTMAssemblyFeature1-2218.h
 *
 * 
 */

#ifndef OAIBTMAssemblyFeature1-2218_H_
#define OAIBTMAssemblyFeature1-2218_H_
...
class OAIBTMAssemblyFeature1-2218: public OAIObject {
public:
    OAIBTMAssemblyFeature1-2218();
    OAIBTMAssemblyFeature1-2218(QString json);
    ~OAIBTMAssemblyFeature1-2218();
    void init();
    void cleanup();
    ...
    OAIBTMAssemblyFeature1-2218* fromJson(QString jsonString) override;
...
#endif /* OAIBTMAssemblyFeature1-2218_H_ */

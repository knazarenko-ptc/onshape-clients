...
OAIBTMParameterReferenceBlob-3281::OAIBTMParameterReferenceBlob-3281(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMParameterReferenceBlob-3281::OAIBTMParameterReferenceBlob-3281() {
    init();
}
...
void
OAIBTMParameterReferenceBlob-3281::init() {
    bt_type = new QString("");
...
void
OAIBTMParameterReferenceBlob-3281::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMParameterReferenceBlob-3281::fromJson(QString json) {
...
void
OAIBTMParameterReferenceBlob-3281::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTMParameterReferenceBlob-3281::asJson ()
{
...
QJsonObject
OAIBTMParameterReferenceBlob-3281::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMParameterReferenceBlob-3281::getBtType() {
    return bt_type;
}
void
OAIBTMParameterReferenceBlob-3281::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMParameterReferenceBlob-3281::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMParameterReferenceBlob-3281::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMParameterReferenceBlob-3281::getNodeId() {
    return node_id;
}
void
OAIBTMParameterReferenceBlob-3281::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTMParameterReferenceBlob-3281::getParameterId() {
    return parameter_id;
}
void
OAIBTMParameterReferenceBlob-3281::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTMParameterReferenceBlob-3281::getElementId() {
    return element_id;
}
void
OAIBTMParameterReferenceBlob-3281::setElementId(QString* element_id) {
    this->element_id = element_id;
    this->m_element_id_isSet = true;
}

QString*
OAIBTMParameterReferenceBlob-3281::getFeatureScriptType() {
    return feature_script_type;
}
void
OAIBTMParameterReferenceBlob-3281::setFeatureScriptType(QString* feature_script_type) {
    this->feature_script_type = feature_script_type;
    this->m_feature_script_type_isSet = true;
}

QString*
OAIBTMParameterReferenceBlob-3281::getNamespace() {
    return _namespace;
}
void
OAIBTMParameterReferenceBlob-3281::setNamespace(QString* _namespace) {
...
bool
OAIBTMParameterReferenceBlob-3281::isSet(){

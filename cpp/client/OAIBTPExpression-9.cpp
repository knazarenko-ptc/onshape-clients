...
OAIBTPExpression-9::OAIBTPExpression-9(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPExpression-9::OAIBTPExpression-9() {
    init();
}
...
OAIBTPExpression-9*
OAIBTPExpression-9::fromJson(QString json) {
...
void
OAIBTPExpression-9::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIBTPExpression-9::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPExpression-9::isAtomic() {
    return atomic;
}
void
OAIBTPExpression-9::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPExpression-9::getBtType() {
    return bt_type;
}
void
OAIBTPExpression-9::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPExpression-9::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPExpression-9::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPExpression-9::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPExpression-9::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPExpression-9::getNodeId() {
    return node_id;
}
void
OAIBTPExpression-9::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPExpression-9::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPExpression-9::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpression-9::getSpaceAfter() {
    return space_after;
}
void
OAIBTPExpression-9::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpression-9::getSpaceBefore() {
    return space_before;
}
void
OAIBTPExpression-9::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPExpression-9::isSpaceDefault() {
    return space_default;
}
void
OAIBTPExpression-9::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPExpression-9::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPExpression-9::setStartSourceLocation(qint32 start_source_location) {

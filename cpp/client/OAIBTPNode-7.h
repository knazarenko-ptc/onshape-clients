...
#ifndef OAIBTPNode-7_H_
#define OAIBTPNode-7_H_
...
class OAIBTPNode-7: public OAIObject {
public:
    OAIBTPNode-7();
    OAIBTPNode-7(QString json);
    ~OAIBTPNode-7();
    void init();
    void cleanup();
    ...
    OAIBTPNode-7* fromJson(QString jsonString) override;

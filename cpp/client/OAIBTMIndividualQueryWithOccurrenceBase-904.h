...
/*
 * OAIBTMIndividualQueryWithOccurrenceBase-904.h
 *
 * 
 */

#ifndef OAIBTMIndividualQueryWithOccurrenceBase-904_H_
#define OAIBTMIndividualQueryWithOccurrenceBase-904_H_
...
class OAIBTMIndividualQueryWithOccurrenceBase-904: public OAIObject {
public:
    OAIBTMIndividualQueryWithOccurrenceBase-904();
    OAIBTMIndividualQueryWithOccurrenceBase-904(QString json);
    ~OAIBTMIndividualQueryWithOccurrenceBase-904();
    void init();
    void cleanup();
    ...
    OAIBTMIndividualQueryWithOccurrenceBase-904* fromJson(QString jsonString) override;
...
#endif /* OAIBTMIndividualQueryWithOccurrenceBase-904_H_ */

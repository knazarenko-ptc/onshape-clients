...
/*
 * OAIBTParameterSpec-6.h
 *
 * 
 */

#ifndef OAIBTParameterSpec-6_H_
#define OAIBTParameterSpec-6_H_
...
class OAIBTParameterSpec-6: public OAIObject {
public:
    OAIBTParameterSpec-6();
    OAIBTParameterSpec-6(QString json);
    ~OAIBTParameterSpec-6();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpec-6* fromJson(QString jsonString) override;

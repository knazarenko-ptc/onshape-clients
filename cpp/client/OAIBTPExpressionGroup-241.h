...
/*
 * OAIBTPExpressionGroup-241.h
 *
 * 
 */

#ifndef OAIBTPExpressionGroup-241_H_
#define OAIBTPExpressionGroup-241_H_
...
class OAIBTPExpressionGroup-241: public OAIObject {
public:
    OAIBTPExpressionGroup-241();
    OAIBTPExpressionGroup-241(QString json);
    ~OAIBTPExpressionGroup-241();
    void init();
    void cleanup();
    ...
    OAIBTPExpressionGroup-241* fromJson(QString jsonString) override;
    ...
    OAIBTPExpression-9* getContent();
    void setContent(OAIBTPExpression-9* content);
...
#endif /* OAIBTPExpressionGroup-241_H_ */

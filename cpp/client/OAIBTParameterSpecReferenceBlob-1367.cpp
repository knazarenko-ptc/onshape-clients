...
OAIBTParameterSpecReferenceBlob-1367::OAIBTParameterSpecReferenceBlob-1367(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecReferenceBlob-1367::OAIBTParameterSpecReferenceBlob-1367() {
    init();
}
...
void
OAIBTParameterSpecReferenceBlob-1367::init() {
...
void
OAIBTParameterSpecReferenceBlob-1367::cleanup() {
...
OAIBTParameterSpecReferenceBlob-1367*
OAIBTParameterSpecReferenceBlob-1367::fromJson(QString json) {
...
void
OAIBTParameterSpecReferenceBlob-1367::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTParameterSpecReferenceBlob-1367::asJson ()
{
...
QJsonObject
OAIBTParameterSpecReferenceBlob-1367::asJsonObject() {
    QJsonObject obj;
...
qint32
OAIBTParameterSpecReferenceBlob-1367::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecReferenceBlob-1367::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecReferenceBlob-1367::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecReferenceBlob-1367::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecReferenceBlob-1367::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecReferenceBlob-1367::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecReferenceBlob-1367::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecReferenceBlob-1367::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecReferenceBlob-1367::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecReferenceBlob-1367::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecReferenceBlob-1367::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecReferenceBlob-1367::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceBlob-1367::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecReferenceBlob-1367::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceBlob-1367::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecReferenceBlob-1367::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecReferenceBlob-1367::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecReferenceBlob-1367::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceBlob-1367::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecReferenceBlob-1367::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecReferenceBlob-1367::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecReferenceBlob-1367::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceBlob-1367::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecReferenceBlob-1367::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecReferenceBlob-1367::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecReferenceBlob-1367::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
...
bool
OAIBTParameterSpecReferenceBlob-1367::isSet(){

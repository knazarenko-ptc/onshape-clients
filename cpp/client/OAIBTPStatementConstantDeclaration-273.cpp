...
OAIBTPStatementConstantDeclaration-273::OAIBTPStatementConstantDeclaration-273(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPStatementConstantDeclaration-273::OAIBTPStatementConstantDeclaration-273() {
    init();
}
...
void
OAIBTPStatementConstantDeclaration-273::init() {
    atomic = false;
...
void
OAIBTPStatementConstantDeclaration-273::cleanup() {
...
OAIBTPStatementConstantDeclaration-273::fromJson(QString json) {
...
void
OAIBTPStatementConstantDeclaration-273::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPStatementConstantDeclaration-273::asJson ()
{
...
QJsonObject
OAIBTPStatementConstantDeclaration-273::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPStatementConstantDeclaration-273::isAtomic() {
    return atomic;
}
void
OAIBTPStatementConstantDeclaration-273::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPStatementConstantDeclaration-273::getBtType() {
    return bt_type;
}
void
OAIBTPStatementConstantDeclaration-273::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPStatementConstantDeclaration-273::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPStatementConstantDeclaration-273::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPStatementConstantDeclaration-273::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPStatementConstantDeclaration-273::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPStatementConstantDeclaration-273::getNodeId() {
    return node_id;
}
void
OAIBTPStatementConstantDeclaration-273::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPStatementConstantDeclaration-273::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPStatementConstantDeclaration-273::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementConstantDeclaration-273::getSpaceAfter() {
    return space_after;
}
void
OAIBTPStatementConstantDeclaration-273::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementConstantDeclaration-273::getSpaceBefore() {
    return space_before;
}
void
OAIBTPStatementConstantDeclaration-273::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPStatementConstantDeclaration-273::isSpaceDefault() {
    return space_default;
}
void
OAIBTPStatementConstantDeclaration-273::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPStatementConstantDeclaration-273::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPStatementConstantDeclaration-273::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPStatementConstantDeclaration-273::getAnnotation() {
    return annotation;
}
void
OAIBTPStatementConstantDeclaration-273::setAnnotation(OAIBTPAnnotation-231* annotation) {
    this->annotation = annotation;
    this->m_annotation_isSet = true;
}

QString*
OAIBTPStatementConstantDeclaration-273::getStandardType() {
    return standard_type;
}
void
OAIBTPStatementConstantDeclaration-273::setStandardType(QString* standard_type) {
    this->standard_type = standard_type;
    this->m_standard_type_isSet = true;
}

QString*
OAIBTPStatementConstantDeclaration-273::getTypeName() {
    return type_name;
}
void
OAIBTPStatementConstantDeclaration-273::setTypeName(QString* type_name) {
    this->type_name = type_name;
    this->m_type_name_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPStatementConstantDeclaration-273::getName() {
    return name;
}
void
OAIBTPStatementConstantDeclaration-273::setName(OAIBTPIdentifier-8* name) {
    this->name = name;
    this->m_name_isSet = true;
}

OAIBTPTypeName-290*
OAIBTPStatementConstantDeclaration-273::getType() {
    return type;
}
void
OAIBTPStatementConstantDeclaration-273::setType(OAIBTPTypeName-290* type) {
    this->type = type;
    this->m_type_isSet = true;
}

OAIBTPExpression-9*
OAIBTPStatementConstantDeclaration-273::getValue() {
    return value;
}
void
OAIBTPStatementConstantDeclaration-273::setValue(OAIBTPExpression-9* value) {
    this->value = value;
...
bool
OAIBTPStatementConstantDeclaration-273::isSet(){

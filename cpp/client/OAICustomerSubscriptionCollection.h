...
/*
 * OAICustomerSubscriptionCollection.h
 *
 * 
 */

#ifndef OAICustomerSubscriptionCollection_H_
#define OAICustomerSubscriptionCollection_H_
...
class OAICustomerSubscriptionCollection: public OAIObject {
public:
    OAICustomerSubscriptionCollection();
    OAICustomerSubscriptionCollection(QString json);
    ~OAICustomerSubscriptionCollection();
    void init();
    void cleanup();
    ...
    OAICustomerSubscriptionCollection* fromJson(QString jsonString) override;

    qint32 getCount();
    void setCount(qint32 count);

    QList<OAISubscription*>* getData();
    void setData(QList<OAISubscription*>* data);
...
#endif /* OAICustomerSubscriptionCollection_H_ */

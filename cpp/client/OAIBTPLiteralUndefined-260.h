...
/*
 * OAIBTPLiteralUndefined-260.h
 *
 * 
 */

#ifndef OAIBTPLiteralUndefined-260_H_
#define OAIBTPLiteralUndefined-260_H_
...
class OAIBTPLiteralUndefined-260: public OAIObject {
public:
    OAIBTPLiteralUndefined-260();
    OAIBTPLiteralUndefined-260(QString json);
    ~OAIBTPLiteralUndefined-260();
    void init();
    void cleanup();
    ...
    OAIBTPLiteralUndefined-260* fromJson(QString jsonString) override;
...
#endif /* OAIBTPLiteralUndefined-260_H_ */

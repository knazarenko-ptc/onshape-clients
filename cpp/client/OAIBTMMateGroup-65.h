...
/*
 * OAIBTMMateGroup-65.h
 *
 * 
 */

#ifndef OAIBTMMateGroup-65_H_
#define OAIBTMMateGroup-65_H_
...
class OAIBTMMateGroup-65: public OAIObject {
public:
    OAIBTMMateGroup-65();
    OAIBTMMateGroup-65(QString json);
    ~OAIBTMMateGroup-65();
    void init();
    void cleanup();
    ...
    OAIBTMMateGroup-65* fromJson(QString jsonString) override;

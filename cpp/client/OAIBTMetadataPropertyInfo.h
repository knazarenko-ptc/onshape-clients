...
/*
 * OAIBTMetadataPropertyInfo.h
 *
 * 
 */

#ifndef OAIBTMetadataPropertyInfo_H_
#define OAIBTMetadataPropertyInfo_H_
...
class OAIBTMetadataPropertyInfo: public OAIObject {
public:
    OAIBTMetadataPropertyInfo();
    OAIBTMetadataPropertyInfo(QString json);
    ~OAIBTMetadataPropertyInfo();
    void init();
    void cleanup();
    ...
    OAIBTMetadataPropertyInfo* fromJson(QString jsonString) override;
...
#endif /* OAIBTMetadataPropertyInfo_H_ */

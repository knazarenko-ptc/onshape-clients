...
/*
 * OAIBTPStatementReturn-281.h
 *
 * 
 */

#ifndef OAIBTPStatementReturn-281_H_
#define OAIBTPStatementReturn-281_H_
...
class OAIBTPStatementReturn-281: public OAIObject {
public:
    OAIBTPStatementReturn-281();
    OAIBTPStatementReturn-281(QString json);
    ~OAIBTPStatementReturn-281();
    void init();
    void cleanup();
    ...
    OAIBTPStatementReturn-281* fromJson(QString jsonString) override;
    ...
    OAIBTPSpace-10* getSpaceAfterReturn();
    void setSpaceAfterReturn(OAIBTPSpace-10* space_after_return);
...
private:
    ...
    OAIBTPSpace-10* space_after_return;
    bool m_space_after_return_isSet;
...
#endif /* OAIBTPStatementReturn-281_H_ */

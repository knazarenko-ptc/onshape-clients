...
OAIBTPStatementBlock-271::OAIBTPStatementBlock-271(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPStatementBlock-271::OAIBTPStatementBlock-271() {
    init();
}
...
OAIBTPStatementBlock-271::init() {
    ...
    space_after_open = new OAIBTPSpace-10();
    m_space_after_open_isSet = false;
}

void
OAIBTPStatementBlock-271::cleanup() {
    ...
    if(space_after_open != nullptr) { 
        delete space_after_open;
    }
}

OAIBTPStatementBlock-271*
OAIBTPStatementBlock-271::fromJson(QString json) {
...
void
OAIBTPStatementBlock-271::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&space_after_open, pJson["spaceAfterOpen"], "OAIBTPSpace-10", "OAIBTPSpace-10");
    
}

QString
OAIBTPStatementBlock-271::asJson ()
{
...
QJsonObject
OAIBTPStatementBlock-271::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
    ...
    if((space_after_open != nullptr) && (space_after_open->isSet())){
        toJsonValue(QString("spaceAfterOpen"), space_after_open, obj, QString("OAIBTPSpace-10"));
    }
...
bool
OAIBTPStatementBlock-271::isAtomic() {
    return atomic;
}
void
OAIBTPStatementBlock-271::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPStatementBlock-271::getBtType() {
    return bt_type;
}
void
OAIBTPStatementBlock-271::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPStatementBlock-271::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPStatementBlock-271::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPStatementBlock-271::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPStatementBlock-271::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPStatementBlock-271::getNodeId() {
    return node_id;
}
void
OAIBTPStatementBlock-271::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPStatementBlock-271::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPStatementBlock-271::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementBlock-271::getSpaceAfter() {
    return space_after;
}
void
OAIBTPStatementBlock-271::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementBlock-271::getSpaceBefore() {
    return space_before;
}
void
OAIBTPStatementBlock-271::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPStatementBlock-271::isSpaceDefault() {
    return space_default;
}
void
OAIBTPStatementBlock-271::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPStatementBlock-271::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPStatementBlock-271::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPStatementBlock-271::getAnnotation() {
    return annotation;
}
void
OAIBTPStatementBlock-271::setAnnotation(OAIBTPAnnotation-231* annotation) {
    this->annotation = annotation;
    this->m_annotation_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementBlock-271::getSpaceAfterOpen() {
    return space_after_open;
}
void
OAIBTPStatementBlock-271::setSpaceAfterOpen(OAIBTPSpace-10* space_after_open) {
    this->space_after_open = space_after_open;
    this->m_space_after_open_isSet = true;
}


bool
OAIBTPStatementBlock-271::isSet(){
    ...
    do{
        ...
        if(space_after_open != nullptr && space_after_open->isSet()){ isObjectUpdated = true; break;}
    }while(false);

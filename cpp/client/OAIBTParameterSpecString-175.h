...
/*
 * OAIBTParameterSpecString-175.h
 *
 * 
 */

#ifndef OAIBTParameterSpecString-175_H_
#define OAIBTParameterSpecString-175_H_
...
class OAIBTParameterSpecString-175: public OAIObject {
public:
    OAIBTParameterSpecString-175();
    OAIBTParameterSpecString-175(QString json);
    ~OAIBTParameterSpecString-175();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecString-175* fromJson(QString jsonString) override;
    ...
    QList<OAIBTStringFormatCondition-683*>* getFormatConditions();
    void setFormatConditions(QList<OAIBTStringFormatCondition-683*>* format_conditions);
...
private:
    ...
    QList<OAIBTStringFormatCondition-683*>* format_conditions;
    bool m_format_conditions_isSet;

};

}

#endif /* OAIBTParameterSpecString-175_H_ */

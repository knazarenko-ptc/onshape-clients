...
OAIBTMParameterInvalid-1664::OAIBTMParameterInvalid-1664(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMParameterInvalid-1664::OAIBTMParameterInvalid-1664() {
    init();
}
...
void
OAIBTMParameterInvalid-1664::init() {
    bt_type = new QString("");
...
void
OAIBTMParameterInvalid-1664::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMParameterInvalid-1664::fromJson(QString json) {
...
void
OAIBTMParameterInvalid-1664::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTMParameterInvalid-1664::asJson ()
{
...
QJsonObject
OAIBTMParameterInvalid-1664::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMParameterInvalid-1664::getBtType() {
    return bt_type;
}
void
OAIBTMParameterInvalid-1664::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMParameterInvalid-1664::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMParameterInvalid-1664::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMParameterInvalid-1664::getNodeId() {
    return node_id;
}
void
OAIBTMParameterInvalid-1664::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTMParameterInvalid-1664::getParameterId() {
    return parameter_id;
}
void
OAIBTMParameterInvalid-1664::setParameterId(QString* parameter_id) {
...
bool
OAIBTMParameterInvalid-1664::isSet(){

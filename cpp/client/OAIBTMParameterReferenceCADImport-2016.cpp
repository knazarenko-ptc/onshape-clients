...
OAIBTMParameterReferenceCADImport-2016::OAIBTMParameterReferenceCADImport-2016(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMParameterReferenceCADImport-2016::OAIBTMParameterReferenceCADImport-2016() {
    init();
}
...
void
OAIBTMParameterReferenceCADImport-2016::init() {
    bt_type = new QString("");
...
void
OAIBTMParameterReferenceCADImport-2016::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMParameterReferenceCADImport-2016::fromJson(QString json) {
...
void
OAIBTMParameterReferenceCADImport-2016::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTMParameterReferenceCADImport-2016::asJson ()
{
...
QJsonObject
OAIBTMParameterReferenceCADImport-2016::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMParameterReferenceCADImport-2016::getBtType() {
    return bt_type;
}
void
OAIBTMParameterReferenceCADImport-2016::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMParameterReferenceCADImport-2016::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMParameterReferenceCADImport-2016::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMParameterReferenceCADImport-2016::getNodeId() {
    return node_id;
}
void
OAIBTMParameterReferenceCADImport-2016::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTMParameterReferenceCADImport-2016::getParameterId() {
    return parameter_id;
}
void
OAIBTMParameterReferenceCADImport-2016::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTMParameterReferenceCADImport-2016::getElementId() {
    return element_id;
}
void
OAIBTMParameterReferenceCADImport-2016::setElementId(QString* element_id) {
    this->element_id = element_id;
    this->m_element_id_isSet = true;
}

QString*
OAIBTMParameterReferenceCADImport-2016::getFeatureScriptType() {
    return feature_script_type;
}
void
OAIBTMParameterReferenceCADImport-2016::setFeatureScriptType(QString* feature_script_type) {
    this->feature_script_type = feature_script_type;
    this->m_feature_script_type_isSet = true;
}

QString*
OAIBTMParameterReferenceCADImport-2016::getNamespace() {
    return _namespace;
}
void
OAIBTMParameterReferenceCADImport-2016::setNamespace(QString* _namespace) {
...
bool
OAIBTMParameterReferenceCADImport-2016::isSet(){

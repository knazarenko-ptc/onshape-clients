...
/*
 * OAIBTPExpressionNew-243.h
 *
 * 
 */

#ifndef OAIBTPExpressionNew-243_H_
#define OAIBTPExpressionNew-243_H_
...
class OAIBTPExpressionNew-243: public OAIObject {
public:
    OAIBTPExpressionNew-243();
    OAIBTPExpressionNew-243(QString json);
    ~OAIBTPExpressionNew-243();
    void init();
    void cleanup();
    ...
    OAIBTPExpressionNew-243* fromJson(QString jsonString) override;
    ...
    OAIBTPSpace-10* getSpaceBetweenNewBox();
    void setSpaceBetweenNewBox(OAIBTPSpace-10* space_between_new_box);

    OAIBTPSpace-10* getSpaceAfterBox();
    void setSpaceAfterBox(OAIBTPSpace-10* space_after_box);
...
private:
    ...
    OAIBTPSpace-10* space_between_new_box;
    bool m_space_between_new_box_isSet;

    OAIBTPSpace-10* space_after_box;
    bool m_space_after_box_isSet;
...
#endif /* OAIBTPExpressionNew-243_H_ */

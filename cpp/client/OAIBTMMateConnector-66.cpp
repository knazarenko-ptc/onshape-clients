...
OAIBTMMateConnector-66::OAIBTMMateConnector-66(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMMateConnector-66::OAIBTMMateConnector-66() {
    init();
}
...
OAIBTMMateConnector-66::init() {
    ...
    saved_feature_type = new QString("");
    m_saved_feature_type_isSet = false;
    is_hidden = false;
...
void
OAIBTMMateConnector-66::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
    ...
    if(saved_feature_type != nullptr) { 
        delete saved_feature_type;
    }


}

OAIBTMMateConnector-66*
OAIBTMMateConnector-66::fromJson(QString json) {
...
void
OAIBTMMateConnector-66::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&saved_feature_type, pJson["savedFeatureType"], "QString", "QString");
    
    ::OpenAPI::setValue(&is_hidden, pJson["isHidden"], "bool", "");
    
    ::OpenAPI::setValue(&implicit, pJson["implicit"], "bool", "");
    
}

QString
OAIBTMMateConnector-66::asJson ()
{
...
QJsonObject
OAIBTMMateConnector-66::asJsonObject() {
    QJsonObject obj;
    ...
    if(saved_feature_type != nullptr && *saved_feature_type != QString("")){
        toJsonValue(QString("savedFeatureType"), saved_feature_type, obj, QString("QString"));
    }
    if(m_is_hidden_isSet){
        obj.insert("isHidden", QJsonValue(is_hidden));
    }
    if(m_implicit_isSet){
        obj.insert("implicit", QJsonValue(implicit));
    }
...
QString*
OAIBTMMateConnector-66::getBtType() {
    return bt_type;
}
void
OAIBTMMateConnector-66::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMMateConnector-66::getFeatureId() {
    return feature_id;
}
void
OAIBTMMateConnector-66::setFeatureId(QString* feature_id) {
    this->feature_id = feature_id;
    this->m_feature_id_isSet = true;
}

QString*
OAIBTMMateConnector-66::getFeatureType() {
    return feature_type;
}
void
OAIBTMMateConnector-66::setFeatureType(QString* feature_type) {
    this->feature_type = feature_type;
    this->m_feature_type_isSet = true;
}

QString*
OAIBTMMateConnector-66::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMMateConnector-66::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMMateConnector-66::getName() {
    return name;
}
void
OAIBTMMateConnector-66::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString*
OAIBTMMateConnector-66::getNamespace() {
    return _namespace;
}
void
OAIBTMMateConnector-66::setNamespace(QString* _namespace) {
    this->_namespace = _namespace;
    this->m__namespace_isSet = true;
}

QString*
OAIBTMMateConnector-66::getNodeId() {
    return node_id;
}
void
OAIBTMMateConnector-66::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QList<OAIBTMParameter-1*>*
OAIBTMMateConnector-66::getParameters() {
    return parameters;
}
void
OAIBTMMateConnector-66::setParameters(QList<OAIBTMParameter-1*>* parameters) {
    this->parameters = parameters;
    this->m_parameters_isSet = true;
}

bool
OAIBTMMateConnector-66::isReturnAfterSubfeatures() {
    return return_after_subfeatures;
}
void
OAIBTMMateConnector-66::setReturnAfterSubfeatures(bool return_after_subfeatures) {
    this->return_after_subfeatures = return_after_subfeatures;
    this->m_return_after_subfeatures_isSet = true;
}

QList<OAIBTMFeature-134*>*
OAIBTMMateConnector-66::getSubFeatures() {
    return sub_features;
}
void
OAIBTMMateConnector-66::setSubFeatures(QList<OAIBTMFeature-134*>* sub_features) {
    this->sub_features = sub_features;
    this->m_sub_features_isSet = true;
}

bool
OAIBTMMateConnector-66::isSuppressed() {
    return suppressed;
}
void
OAIBTMMateConnector-66::setSuppressed(bool suppressed) {
    this->suppressed = suppressed;
    this->m_suppressed_isSet = true;
}

bool
OAIBTMMateConnector-66::isAuxiliaryAssemblyFeature() {
    return auxiliary_assembly_feature;
}
void
OAIBTMMateConnector-66::setAuxiliaryAssemblyFeature(bool auxiliary_assembly_feature) {
    this->auxiliary_assembly_feature = auxiliary_assembly_feature;
    this->m_auxiliary_assembly_feature_isSet = true;
}

qint32
OAIBTMMateConnector-66::getFeatureListFieldIndex() {
    return feature_list_field_index;
}
void
OAIBTMMateConnector-66::setFeatureListFieldIndex(qint32 feature_list_field_index) {
...
OAIBTMMateConnector-66::getOccurrenceQueriesFromAllConfigurations() {
    return occurrence_queries_from_all_configurations;
}
void
OAIBTMMateConnector-66::setOccurrenceQueriesFromAllConfigurations(QList<OAIBTMIndividualQueryWithOccurrenceBase-904*>* occurrence_queries_from_all_configurations) {
...
qint32
OAIBTMMateConnector-66::getVersion() {
    return version;
}
void
OAIBTMMateConnector-66::setVersion(qint32 version) {
    this->version = version;
    this->m_version_isSet = true;
}

QString*
OAIBTMMateConnector-66::getSavedFeatureType() {
    return saved_feature_type;
}
void
OAIBTMMateConnector-66::setSavedFeatureType(QString* saved_feature_type) {
    this->saved_feature_type = saved_feature_type;
    this->m_saved_feature_type_isSet = true;
}

bool
OAIBTMMateConnector-66::isIsHidden() {
    return is_hidden;
}
void
OAIBTMMateConnector-66::setIsHidden(bool is_hidden) {
    this->is_hidden = is_hidden;
    this->m_is_hidden_isSet = true;
}

bool
OAIBTMMateConnector-66::isImplicit() {
    return implicit;
}
void
OAIBTMMateConnector-66::setImplicit(bool implicit) {
...
OAIBTMMateConnector-66::isSet(){
    ...
    do{
        ...
        if(saved_feature_type != nullptr && *saved_feature_type != QString("")){ isObjectUpdated = true; break;}
        if(m_is_hidden_isSet){ isObjectUpdated = true; break;}
        if(m_implicit_isSet){ isObjectUpdated = true; break;}
    }while(false);

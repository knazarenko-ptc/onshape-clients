...
/*
 * OAIBTPFunctionOrPredicateDeclaration-247.h
 *
 * 
 */

#ifndef OAIBTPFunctionOrPredicateDeclaration-247_H_
#define OAIBTPFunctionOrPredicateDeclaration-247_H_
...
class OAIBTPFunctionOrPredicateDeclaration-247: public OAIObject {
public:
    OAIBTPFunctionOrPredicateDeclaration-247();
    OAIBTPFunctionOrPredicateDeclaration-247(QString json);
    ~OAIBTPFunctionOrPredicateDeclaration-247();
    void init();
    void cleanup();
    ...
    OAIBTPFunctionOrPredicateDeclaration-247* fromJson(QString jsonString) override;
...
#endif /* OAIBTPFunctionOrPredicateDeclaration-247_H_ */

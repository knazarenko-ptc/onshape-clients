...
OAIBTExplosionStepFeature-3008::OAIBTExplosionStepFeature-3008(QString json) {
    init();
    this->fromJson(json);
}

OAIBTExplosionStepFeature-3008::OAIBTExplosionStepFeature-3008() {
    init();
}
...
void
OAIBTExplosionStepFeature-3008::init() {
    bt_type = new QString("");
...
void
OAIBTExplosionStepFeature-3008::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTExplosionStepFeature-3008*
OAIBTExplosionStepFeature-3008::fromJson(QString json) {
...
void
OAIBTExplosionStepFeature-3008::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTExplosionStepFeature-3008::asJson ()
{
...
QJsonObject
OAIBTExplosionStepFeature-3008::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTExplosionStepFeature-3008::getBtType() {
    return bt_type;
}
void
OAIBTExplosionStepFeature-3008::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTExplosionStepFeature-3008::getFeatureId() {
    return feature_id;
}
void
OAIBTExplosionStepFeature-3008::setFeatureId(QString* feature_id) {
    this->feature_id = feature_id;
    this->m_feature_id_isSet = true;
}

QString*
OAIBTExplosionStepFeature-3008::getFeatureType() {
    return feature_type;
}
void
OAIBTExplosionStepFeature-3008::setFeatureType(QString* feature_type) {
    this->feature_type = feature_type;
    this->m_feature_type_isSet = true;
}

QString*
OAIBTExplosionStepFeature-3008::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTExplosionStepFeature-3008::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTExplosionStepFeature-3008::getName() {
    return name;
}
void
OAIBTExplosionStepFeature-3008::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString*
OAIBTExplosionStepFeature-3008::getNamespace() {
    return _namespace;
}
void
OAIBTExplosionStepFeature-3008::setNamespace(QString* _namespace) {
    this->_namespace = _namespace;
    this->m__namespace_isSet = true;
}

QString*
OAIBTExplosionStepFeature-3008::getNodeId() {
    return node_id;
}
void
OAIBTExplosionStepFeature-3008::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QList<OAIBTMParameter-1*>*
OAIBTExplosionStepFeature-3008::getParameters() {
    return parameters;
}
void
OAIBTExplosionStepFeature-3008::setParameters(QList<OAIBTMParameter-1*>* parameters) {
    this->parameters = parameters;
    this->m_parameters_isSet = true;
}

bool
OAIBTExplosionStepFeature-3008::isReturnAfterSubfeatures() {
    return return_after_subfeatures;
}
void
OAIBTExplosionStepFeature-3008::setReturnAfterSubfeatures(bool return_after_subfeatures) {
    this->return_after_subfeatures = return_after_subfeatures;
    this->m_return_after_subfeatures_isSet = true;
}

QList<OAIBTMFeature-134*>*
OAIBTExplosionStepFeature-3008::getSubFeatures() {
    return sub_features;
}
void
OAIBTExplosionStepFeature-3008::setSubFeatures(QList<OAIBTMFeature-134*>* sub_features) {
    this->sub_features = sub_features;
    this->m_sub_features_isSet = true;
}

bool
OAIBTExplosionStepFeature-3008::isSuppressed() {
    return suppressed;
}
void
OAIBTExplosionStepFeature-3008::setSuppressed(bool suppressed) {
    this->suppressed = suppressed;
    this->m_suppressed_isSet = true;
}

bool
OAIBTExplosionStepFeature-3008::isAuxiliaryAssemblyFeature() {
    return auxiliary_assembly_feature;
}
void
OAIBTExplosionStepFeature-3008::setAuxiliaryAssemblyFeature(bool auxiliary_assembly_feature) {
    this->auxiliary_assembly_feature = auxiliary_assembly_feature;
    this->m_auxiliary_assembly_feature_isSet = true;
}

qint32
OAIBTExplosionStepFeature-3008::getFeatureListFieldIndex() {
    return feature_list_field_index;
}
void
OAIBTExplosionStepFeature-3008::setFeatureListFieldIndex(qint32 feature_list_field_index) {
...
OAIBTExplosionStepFeature-3008::getOccurrenceQueriesFromAllConfigurations() {
    return occurrence_queries_from_all_configurations;
}
void
OAIBTExplosionStepFeature-3008::setOccurrenceQueriesFromAllConfigurations(QList<OAIBTMIndividualQueryWithOccurrenceBase-904*>* occurrence_queries_from_all_configurations) {
...
qint32
OAIBTExplosionStepFeature-3008::getVersion() {
    return version;
}
void
OAIBTExplosionStepFeature-3008::setVersion(qint32 version) {
...
bool
OAIBTExplosionStepFeature-3008::isSet(){

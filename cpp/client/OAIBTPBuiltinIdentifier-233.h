...
/*
 * OAIBTPBuiltinIdentifier-233.h
 *
 * 
 */

#ifndef OAIBTPBuiltinIdentifier-233_H_
#define OAIBTPBuiltinIdentifier-233_H_
...
class OAIBTPBuiltinIdentifier-233: public OAIObject {
public:
    OAIBTPBuiltinIdentifier-233();
    OAIBTPBuiltinIdentifier-233(QString json);
    ~OAIBTPBuiltinIdentifier-233();
    void init();
    void cleanup();
    ...
    OAIBTPBuiltinIdentifier-233* fromJson(QString jsonString) override;
...
#endif /* OAIBTPBuiltinIdentifier-233_H_ */

...
OAIBTParameterSpecReferenceTable-1520::OAIBTParameterSpecReferenceTable-1520(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecReferenceTable-1520::OAIBTParameterSpecReferenceTable-1520() {
    init();
}
...
void
OAIBTParameterSpecReferenceTable-1520::init() {
...
void
OAIBTParameterSpecReferenceTable-1520::cleanup() {
...
OAIBTParameterSpecReferenceTable-1520*
OAIBTParameterSpecReferenceTable-1520::fromJson(QString json) {
...
void
OAIBTParameterSpecReferenceTable-1520::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTParameterSpecReferenceTable-1520::asJson ()
{
...
QJsonObject
OAIBTParameterSpecReferenceTable-1520::asJsonObject() {
    QJsonObject obj;
...
qint32
OAIBTParameterSpecReferenceTable-1520::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecReferenceTable-1520::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecReferenceTable-1520::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecReferenceTable-1520::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecReferenceTable-1520::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecReferenceTable-1520::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecReferenceTable-1520::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecReferenceTable-1520::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecReferenceTable-1520::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecReferenceTable-1520::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecReferenceTable-1520::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecReferenceTable-1520::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceTable-1520::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecReferenceTable-1520::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecReferenceTable-1520::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecReferenceTable-1520::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecReferenceTable-1520::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecReferenceTable-1520::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceTable-1520::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecReferenceTable-1520::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecReferenceTable-1520::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecReferenceTable-1520::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReferenceTable-1520::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecReferenceTable-1520::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecReferenceTable-1520::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecReferenceTable-1520::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
...
bool
OAIBTParameterSpecReferenceTable-1520::isSet(){

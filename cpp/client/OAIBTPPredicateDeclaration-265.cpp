...
OAIBTPPredicateDeclaration-265::OAIBTPPredicateDeclaration-265(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPPredicateDeclaration-265::OAIBTPPredicateDeclaration-265() {
    init();
}
...
void
OAIBTPPredicateDeclaration-265::init() {
    atomic = false;
...
void
OAIBTPPredicateDeclaration-265::cleanup() {
...
OAIBTPPredicateDeclaration-265*
OAIBTPPredicateDeclaration-265::fromJson(QString json) {
...
void
OAIBTPPredicateDeclaration-265::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPPredicateDeclaration-265::asJson ()
{
...
QJsonObject
OAIBTPPredicateDeclaration-265::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPPredicateDeclaration-265::isAtomic() {
    return atomic;
}
void
OAIBTPPredicateDeclaration-265::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPPredicateDeclaration-265::getBtType() {
    return bt_type;
}
void
OAIBTPPredicateDeclaration-265::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPPredicateDeclaration-265::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPPredicateDeclaration-265::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPPredicateDeclaration-265::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPPredicateDeclaration-265::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPPredicateDeclaration-265::getNodeId() {
    return node_id;
}
void
OAIBTPPredicateDeclaration-265::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPPredicateDeclaration-265::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPPredicateDeclaration-265::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPPredicateDeclaration-265::getSpaceAfter() {
    return space_after;
}
void
OAIBTPPredicateDeclaration-265::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPPredicateDeclaration-265::getSpaceBefore() {
    return space_before;
}
void
OAIBTPPredicateDeclaration-265::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPPredicateDeclaration-265::isSpaceDefault() {
    return space_default;
}
void
OAIBTPPredicateDeclaration-265::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPPredicateDeclaration-265::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPPredicateDeclaration-265::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

bool
OAIBTPPredicateDeclaration-265::isDeprecated() {
    return deprecated;
}
void
OAIBTPPredicateDeclaration-265::setDeprecated(bool deprecated) {
    this->deprecated = deprecated;
    this->m_deprecated_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPPredicateDeclaration-265::getSymbolName() {
    return symbol_name;
}
void
OAIBTPPredicateDeclaration-265::setSymbolName(OAIBTPIdentifier-8* symbol_name) {
    this->symbol_name = symbol_name;
    this->m_symbol_name_isSet = true;
}

QList<OAIBTPArgumentDeclaration-232*>*
OAIBTPPredicateDeclaration-265::getArgumentsToDocument() {
    return arguments_to_document;
}
void
OAIBTPPredicateDeclaration-265::setArgumentsToDocument(QList<OAIBTPArgumentDeclaration-232*>* arguments_to_document) {
    this->arguments_to_document = arguments_to_document;
    this->m_arguments_to_document_isSet = true;
}

QString*
OAIBTPPredicateDeclaration-265::getDeprecatedExplanation() {
    return deprecated_explanation;
}
void
OAIBTPPredicateDeclaration-265::setDeprecatedExplanation(QString* deprecated_explanation) {
    this->deprecated_explanation = deprecated_explanation;
    this->m_deprecated_explanation_isSet = true;
}

bool
OAIBTPPredicateDeclaration-265::isForExport() {
    return for_export;
}
void
OAIBTPPredicateDeclaration-265::setForExport(bool for_export) {
    this->for_export = for_export;
    this->m_for_export_isSet = true;
}

OAIBTPSpace-10*
OAIBTPPredicateDeclaration-265::getSpaceAfterExport() {
    return space_after_export;
}
void
OAIBTPPredicateDeclaration-265::setSpaceAfterExport(OAIBTPSpace-10* space_after_export) {
    this->space_after_export = space_after_export;
    this->m_space_after_export_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPPredicateDeclaration-265::getAnnotation() {
    return annotation;
}
void
OAIBTPPredicateDeclaration-265::setAnnotation(OAIBTPAnnotation-231* annotation) {
    this->annotation = annotation;
    this->m_annotation_isSet = true;
}

OAIBTPStatementBlock-271*
OAIBTPPredicateDeclaration-265::getBody() {
    return body;
}
void
OAIBTPPredicateDeclaration-265::setBody(OAIBTPStatementBlock-271* body) {
    this->body = body;
    this->m_body_isSet = true;
}

QList<OAIBTPArgumentDeclaration-232*>*
OAIBTPPredicateDeclaration-265::getArguments() {
    return arguments;
}
void
OAIBTPPredicateDeclaration-265::setArguments(QList<OAIBTPArgumentDeclaration-232*>* arguments) {
    this->arguments = arguments;
    this->m_arguments_isSet = true;
}

OAIBTPStatement-269*
OAIBTPPredicateDeclaration-265::getPrecondition() {
    return precondition;
}
void
OAIBTPPredicateDeclaration-265::setPrecondition(OAIBTPStatement-269* precondition) {
    this->precondition = precondition;
    this->m_precondition_isSet = true;
}

OAIBTPSpace-10*
OAIBTPPredicateDeclaration-265::getSpaceAfterArglist() {
    return space_after_arglist;
}
void
OAIBTPPredicateDeclaration-265::setSpaceAfterArglist(OAIBTPSpace-10* space_after_arglist) {
    this->space_after_arglist = space_after_arglist;
    this->m_space_after_arglist_isSet = true;
}

OAIBTPSpace-10*
OAIBTPPredicateDeclaration-265::getSpaceInEmptyList() {
    return space_in_empty_list;
}
void
OAIBTPPredicateDeclaration-265::setSpaceInEmptyList(OAIBTPSpace-10* space_in_empty_list) {
    this->space_in_empty_list = space_in_empty_list;
    this->m_space_in_empty_list_isSet = true;
}

OAIBTPTypeName-290*
OAIBTPPredicateDeclaration-265::getReturnType() {
    return return_type;
}
void
OAIBTPPredicateDeclaration-265::setReturnType(OAIBTPTypeName-290* return_type) {
    this->return_type = return_type;
    this->m_return_type_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPPredicateDeclaration-265::getName() {
    return name;
}
void
OAIBTPPredicateDeclaration-265::setName(OAIBTPIdentifier-8* name) {
    this->name = name;
...
bool
OAIBTPPredicateDeclaration-265::isSet(){

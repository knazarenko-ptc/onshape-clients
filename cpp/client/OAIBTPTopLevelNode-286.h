...
/*
 * OAIBTPTopLevelNode-286.h
 *
 * 
 */

#ifndef OAIBTPTopLevelNode-286_H_
#define OAIBTPTopLevelNode-286_H_
...
class OAIBTPTopLevelNode-286: public OAIObject {
public:
    OAIBTPTopLevelNode-286();
    OAIBTPTopLevelNode-286(QString json);
    ~OAIBTPTopLevelNode-286();
    void init();
    void cleanup();
    ...
    OAIBTPTopLevelNode-286* fromJson(QString jsonString) override;
...
#endif /* OAIBTPTopLevelNode-286_H_ */

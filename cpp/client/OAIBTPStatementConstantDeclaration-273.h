...
/*
 * OAIBTPStatementConstantDeclaration-273.h
 *
 * 
 */

#ifndef OAIBTPStatementConstantDeclaration-273_H_
#define OAIBTPStatementConstantDeclaration-273_H_
...
class OAIBTPStatementConstantDeclaration-273: public OAIObject {
public:
    OAIBTPStatementConstantDeclaration-273();
    OAIBTPStatementConstantDeclaration-273(QString json);
    ~OAIBTPStatementConstantDeclaration-273();
    void init();
    void cleanup();
    ...
    OAIBTPStatementConstantDeclaration-273* fromJson(QString jsonString) override;
    ...
    OAIBTPTypeName-290* getType();
    void setType(OAIBTPTypeName-290* type);
...
#endif /* OAIBTPStatementConstantDeclaration-273_H_ */

...
/*
 * OAIBTTableSpec-915.h
 *
 * 
 */

#ifndef OAIBTTableSpec-915_H_
#define OAIBTTableSpec-915_H_
...
class OAIBTTableSpec-915: public OAIObject {
public:
    OAIBTTableSpec-915();
    OAIBTTableSpec-915(QString json);
    ~OAIBTTableSpec-915();
    void init();
    void cleanup();
    ...
    OAIBTTableSpec-915* fromJson(QString jsonString) override;

...
OAIBTPLiteral-253::OAIBTPLiteral-253(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLiteral-253::OAIBTPLiteral-253() {
    init();
}
...
OAIBTPLiteral-253*
OAIBTPLiteral-253::fromJson(QString json) {
...
void
OAIBTPLiteral-253::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIBTPLiteral-253::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPLiteral-253::isAtomic() {
    return atomic;
}
void
OAIBTPLiteral-253::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLiteral-253::getBtType() {
    return bt_type;
}
void
OAIBTPLiteral-253::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLiteral-253::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLiteral-253::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLiteral-253::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLiteral-253::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPLiteral-253::getNodeId() {
    return node_id;
}
void
OAIBTPLiteral-253::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLiteral-253::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLiteral-253::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteral-253::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLiteral-253::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteral-253::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLiteral-253::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLiteral-253::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLiteral-253::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPLiteral-253::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLiteral-253::setStartSourceLocation(qint32 start_source_location) {

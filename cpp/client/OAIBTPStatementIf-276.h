...
/*
 * OAIBTPStatementIf-276.h
 *
 * 
 */

#ifndef OAIBTPStatementIf-276_H_
#define OAIBTPStatementIf-276_H_
...
class OAIBTPStatementIf-276: public OAIObject {
public:
    OAIBTPStatementIf-276();
    OAIBTPStatementIf-276(QString json);
    ~OAIBTPStatementIf-276();
    void init();
    void cleanup();
    ...
    OAIBTPStatementIf-276* fromJson(QString jsonString) override;
    ...
    OAIBTPSpace-10* getSpaceAfterIf();
    void setSpaceAfterIf(OAIBTPSpace-10* space_after_if);

    OAIBTPStatement-269* getThenBody();
    void setThenBody(OAIBTPStatement-269* then_body);

    OAIBTPStatement-269* getElseBody();
    void setElseBody(OAIBTPStatement-269* else_body);
...
private:
    ...
    OAIBTPSpace-10* space_after_if;
    bool m_space_after_if_isSet;

    OAIBTPStatement-269* then_body;
    bool m_then_body_isSet;

    OAIBTPStatement-269* else_body;
    bool m_else_body_isSet;

};

}

#endif /* OAIBTPStatementIf-276_H_ */

...
OAIBTPLiteralNumber-258::OAIBTPLiteralNumber-258(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLiteralNumber-258::OAIBTPLiteralNumber-258() {
    init();
}
...
void
OAIBTPLiteralNumber-258::cleanup() {
...
OAIBTPLiteralNumber-258::fromJson(QString json) {
...
void
OAIBTPLiteralNumber-258::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPLiteralNumber-258::asJson ()
{
...
QJsonObject
OAIBTPLiteralNumber-258::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPLiteralNumber-258::isAtomic() {
    return atomic;
}
void
OAIBTPLiteralNumber-258::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLiteralNumber-258::getBtType() {
    return bt_type;
}
void
OAIBTPLiteralNumber-258::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLiteralNumber-258::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLiteralNumber-258::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLiteralNumber-258::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLiteralNumber-258::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPLiteralNumber-258::getNodeId() {
    return node_id;
}
void
OAIBTPLiteralNumber-258::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLiteralNumber-258::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLiteralNumber-258::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralNumber-258::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLiteralNumber-258::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLiteralNumber-258::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLiteralNumber-258::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLiteralNumber-258::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLiteralNumber-258::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPLiteralNumber-258::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLiteralNumber-258::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

QString*
OAIBTPLiteralNumber-258::getText() {
    return text;
}
void
OAIBTPLiteralNumber-258::setText(QString* text) {
    this->text = text;
    this->m_text_isSet = true;
}

double
OAIBTPLiteralNumber-258::getValue() {
    return value;
}
void
OAIBTPLiteralNumber-258::setValue(double value) {
    this->value = value;

...
OAIBTPLValueVarReference-252::OAIBTPLValueVarReference-252(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLValueVarReference-252::OAIBTPLValueVarReference-252() {
    init();
}
...
void
OAIBTPLValueVarReference-252::init() {
    atomic = false;
...
void
OAIBTPLValueVarReference-252::cleanup() {
...
OAIBTPLValueVarReference-252*
OAIBTPLValueVarReference-252::fromJson(QString json) {
...
void
OAIBTPLValueVarReference-252::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPLValueVarReference-252::asJson ()
{
...
QJsonObject
OAIBTPLValueVarReference-252::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPLValueVarReference-252::isAtomic() {
    return atomic;
}
void
OAIBTPLValueVarReference-252::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLValueVarReference-252::getBtType() {
    return bt_type;
}
void
OAIBTPLValueVarReference-252::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLValueVarReference-252::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLValueVarReference-252::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLValueVarReference-252::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLValueVarReference-252::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPLValueVarReference-252::getNodeId() {
    return node_id;
}
void
OAIBTPLValueVarReference-252::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLValueVarReference-252::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLValueVarReference-252::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLValueVarReference-252::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLValueVarReference-252::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLValueVarReference-252::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLValueVarReference-252::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLValueVarReference-252::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLValueVarReference-252::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPLValueVarReference-252::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLValueVarReference-252::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPLValueVarReference-252::getName() {
    return name;
}
void
OAIBTPLValueVarReference-252::setName(OAIBTPIdentifier-8* name) {
    this->name = name;
...
bool
OAIBTPLValueVarReference-252::isSet(){

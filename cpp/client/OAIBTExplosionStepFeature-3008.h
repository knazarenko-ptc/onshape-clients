...
/*
 * OAIBTExplosionStepFeature-3008.h
 *
 * 
 */

#ifndef OAIBTExplosionStepFeature-3008_H_
#define OAIBTExplosionStepFeature-3008_H_
...
class OAIBTExplosionStepFeature-3008: public OAIObject {
public:
    OAIBTExplosionStepFeature-3008();
    OAIBTExplosionStepFeature-3008(QString json);
    ~OAIBTExplosionStepFeature-3008();
    void init();
    void cleanup();
    ...
    OAIBTExplosionStepFeature-3008* fromJson(QString jsonString) override;
...
#endif /* OAIBTExplosionStepFeature-3008_H_ */

...
/*
 * OAIBTMParameterBoolean-144.h
 *
 * 
 */

#ifndef OAIBTMParameterBoolean-144_H_
#define OAIBTMParameterBoolean-144_H_
...
class OAIBTMParameterBoolean-144: public OAIObject {
public:
    OAIBTMParameterBoolean-144();
    OAIBTMParameterBoolean-144(QString json);
    ~OAIBTMParameterBoolean-144();
    void init();
    void cleanup();
    ...
    OAIBTMParameterBoolean-144* fromJson(QString jsonString) override;
...
#endif /* OAIBTMParameterBoolean-144_H_ */

...
/*
 * OAIBTParameterSpecDerived-736.h
 *
 * 
 */

#ifndef OAIBTParameterSpecDerived-736_H_
#define OAIBTParameterSpecDerived-736_H_
...
class OAIBTParameterSpecDerived-736: public OAIObject {
public:
    OAIBTParameterSpecDerived-736();
    OAIBTParameterSpecDerived-736(QString json);
    ~OAIBTParameterSpecDerived-736();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecDerived-736* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecDerived-736_H_ */

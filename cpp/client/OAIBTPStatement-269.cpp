...
OAIBTPStatement-269::OAIBTPStatement-269(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPStatement-269::OAIBTPStatement-269() {
    init();
}
...
OAIBTPStatement-269*
OAIBTPStatement-269::fromJson(QString json) {
...
void
OAIBTPStatement-269::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIBTPStatement-269::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPStatement-269::isAtomic() {
    return atomic;
}
void
OAIBTPStatement-269::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPStatement-269::getBtType() {
    return bt_type;
}
void
OAIBTPStatement-269::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPStatement-269::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPStatement-269::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPStatement-269::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPStatement-269::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPStatement-269::getNodeId() {
    return node_id;
}
void
OAIBTPStatement-269::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPStatement-269::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPStatement-269::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatement-269::getSpaceAfter() {
    return space_after;
}
void
OAIBTPStatement-269::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatement-269::getSpaceBefore() {
    return space_before;
}
void
OAIBTPStatement-269::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPStatement-269::isSpaceDefault() {
    return space_default;
}
void
OAIBTPStatement-269::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPStatement-269::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPStatement-269::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPStatement-269::getAnnotation() {
    return annotation;
}
void
OAIBTPStatement-269::setAnnotation(OAIBTPAnnotation-231* annotation) {

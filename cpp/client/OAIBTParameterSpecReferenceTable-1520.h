...
/*
 * OAIBTParameterSpecReferenceTable-1520.h
 *
 * 
 */

#ifndef OAIBTParameterSpecReferenceTable-1520_H_
#define OAIBTParameterSpecReferenceTable-1520_H_
...
class OAIBTParameterSpecReferenceTable-1520: public OAIObject {
public:
    OAIBTParameterSpecReferenceTable-1520();
    OAIBTParameterSpecReferenceTable-1520(QString json);
    ~OAIBTParameterSpecReferenceTable-1520();
    void init();
    void cleanup();
    ...
    OAIBTParameterSpecReferenceTable-1520* fromJson(QString jsonString) override;
...
#endif /* OAIBTParameterSpecReferenceTable-1520_H_ */

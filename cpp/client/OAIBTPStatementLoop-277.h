...
/*
 * OAIBTPStatementLoop-277.h
 *
 * 
 */

#ifndef OAIBTPStatementLoop-277_H_
#define OAIBTPStatementLoop-277_H_
...
class OAIBTPStatementLoop-277: public OAIObject {
public:
    OAIBTPStatementLoop-277();
    OAIBTPStatementLoop-277(QString json);
    ~OAIBTPStatementLoop-277();
    void init();
    void cleanup();
    ...
    OAIBTPStatementLoop-277* fromJson(QString jsonString) override;
...
#endif /* OAIBTPStatementLoop-277_H_ */

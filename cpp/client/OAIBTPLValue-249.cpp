...
OAIBTPLValue-249::OAIBTPLValue-249(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPLValue-249::OAIBTPLValue-249() {
    init();
}
...
OAIBTPLValue-249*
OAIBTPLValue-249::fromJson(QString json) {
...
void
OAIBTPLValue-249::fromJsonObject(QJsonObject pJson) {
...
bool
OAIBTPLValue-249::isAtomic() {
    return atomic;
}
void
OAIBTPLValue-249::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPLValue-249::getBtType() {
    return bt_type;
}
void
OAIBTPLValue-249::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPLValue-249::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPLValue-249::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPLValue-249::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPLValue-249::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPLValue-249::getNodeId() {
    return node_id;
}
void
OAIBTPLValue-249::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPLValue-249::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPLValue-249::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLValue-249::getSpaceAfter() {
    return space_after;
}
void
OAIBTPLValue-249::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPLValue-249::getSpaceBefore() {
    return space_before;
}
void
OAIBTPLValue-249::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPLValue-249::isSpaceDefault() {
    return space_default;
}
void
OAIBTPLValue-249::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPLValue-249::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPLValue-249::setStartSourceLocation(qint32 start_source_location) {

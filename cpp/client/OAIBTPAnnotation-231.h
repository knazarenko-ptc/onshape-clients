...
/*
 * OAIBTPAnnotation-231.h
 *
 * 
 */

#ifndef OAIBTPAnnotation-231_H_
#define OAIBTPAnnotation-231_H_
...
class OAIBTPAnnotation-231: public OAIObject {
public:
    OAIBTPAnnotation-231();
    OAIBTPAnnotation-231(QString json);
    ~OAIBTPAnnotation-231();
    void init();
    void cleanup();
    ...
    OAIBTPAnnotation-231* fromJson(QString jsonString) override;
    ...
    OAIBTPLiteralMap-256* getValue();
    void setValue(OAIBTPLiteralMap-256* value);

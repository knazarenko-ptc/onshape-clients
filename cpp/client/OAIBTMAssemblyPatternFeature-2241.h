...
/*
 * OAIBTMAssemblyPatternFeature-2241.h
 *
 * 
 */

#ifndef OAIBTMAssemblyPatternFeature-2241_H_
#define OAIBTMAssemblyPatternFeature-2241_H_
...
class OAIBTMAssemblyPatternFeature-2241: public OAIObject {
public:
    OAIBTMAssemblyPatternFeature-2241();
    OAIBTMAssemblyPatternFeature-2241(QString json);
    ~OAIBTMAssemblyPatternFeature-2241();
    void init();
    void cleanup();
    ...
    OAIBTMAssemblyPatternFeature-2241* fromJson(QString jsonString) override;
    ...
    QString* getPatternType();
    void setPatternType(QString* pattern_type);
...
private:
    ...
    bool m_pattern_type_isSet;

};

}

#endif /* OAIBTMAssemblyPatternFeature-2241_H_ */

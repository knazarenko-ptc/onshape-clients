...
#ifndef OAIBTPLiteral-253_H_
#define OAIBTPLiteral-253_H_
...
class OAIBTPLiteral-253: public OAIObject {
public:
    OAIBTPLiteral-253();
    OAIBTPLiteral-253(QString json);
    ~OAIBTPLiteral-253();
    void init();
    void cleanup();
    ...
    OAIBTPLiteral-253* fromJson(QString jsonString) override;

...
OAIBTParameterSpecMaterial-2700::OAIBTParameterSpecMaterial-2700(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecMaterial-2700::OAIBTParameterSpecMaterial-2700() {
    init();
}
...
void
OAIBTParameterSpecMaterial-2700::init() {
...
void
OAIBTParameterSpecMaterial-2700::cleanup() {
...
OAIBTParameterSpecMaterial-2700*
OAIBTParameterSpecMaterial-2700::fromJson(QString json) {
...
void
OAIBTParameterSpecMaterial-2700::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTParameterSpecMaterial-2700::asJson ()
{
...
QJsonObject
OAIBTParameterSpecMaterial-2700::asJsonObject() {
    QJsonObject obj;
...
qint32
OAIBTParameterSpecMaterial-2700::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecMaterial-2700::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecMaterial-2700::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecMaterial-2700::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecMaterial-2700::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecMaterial-2700::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecMaterial-2700::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecMaterial-2700::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecMaterial-2700::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecMaterial-2700::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecMaterial-2700::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecMaterial-2700::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecMaterial-2700::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecMaterial-2700::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecMaterial-2700::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecMaterial-2700::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecMaterial-2700::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecMaterial-2700::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecMaterial-2700::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecMaterial-2700::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecMaterial-2700::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecMaterial-2700::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecMaterial-2700::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecMaterial-2700::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecMaterial-2700::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecMaterial-2700::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
...
bool
OAIBTParameterSpecMaterial-2700::isSet(){

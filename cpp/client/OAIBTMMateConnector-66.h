...
/*
 * OAIBTMMateConnector-66.h
 *
 * 
 */

#ifndef OAIBTMMateConnector-66_H_
#define OAIBTMMateConnector-66_H_
...
class OAIBTMMateConnector-66: public OAIObject {
public:
    OAIBTMMateConnector-66();
    OAIBTMMateConnector-66(QString json);
    ~OAIBTMMateConnector-66();
    void init();
    void cleanup();
    ...
    OAIBTMMateConnector-66* fromJson(QString jsonString) override;
    ...
    QString* getSavedFeatureType();
    void setSavedFeatureType(QString* saved_feature_type);
...
private:
    ...
    QString* saved_feature_type;
    bool m_saved_feature_type_isSet;
...
#endif /* OAIBTMMateConnector-66_H_ */

...
/*
 * OAIBTPPredicateDeclaration-265.h
 *
 * 
 */

#ifndef OAIBTPPredicateDeclaration-265_H_
#define OAIBTPPredicateDeclaration-265_H_
...
class OAIBTPPredicateDeclaration-265: public OAIObject {
public:
    OAIBTPPredicateDeclaration-265();
    OAIBTPPredicateDeclaration-265(QString json);
    ~OAIBTPPredicateDeclaration-265();
    void init();
    void cleanup();
    ...
    OAIBTPPredicateDeclaration-265* fromJson(QString jsonString) override;
...
#endif /* OAIBTPPredicateDeclaration-265_H_ */

...
OAIBTParameterSpec-6::OAIBTParameterSpec-6(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpec-6::OAIBTParameterSpec-6() {
    init();
}
...
OAIBTParameterSpec-6::fromJson(QString json) {
...
void
OAIBTParameterSpec-6::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIBTParameterSpec-6::asJsonObject() {
    QJsonObject obj;
...
qint32
OAIBTParameterSpec-6::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpec-6::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpec-6::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpec-6::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpec-6::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpec-6::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpec-6::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpec-6::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpec-6::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpec-6::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpec-6::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpec-6::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpec-6::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpec-6::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpec-6::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpec-6::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpec-6::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpec-6::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpec-6::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpec-6::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpec-6::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpec-6::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpec-6::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpec-6::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpec-6::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpec-6::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {

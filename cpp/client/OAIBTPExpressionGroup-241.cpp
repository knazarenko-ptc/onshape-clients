...
OAIBTPExpressionGroup-241::OAIBTPExpressionGroup-241(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPExpressionGroup-241::OAIBTPExpressionGroup-241() {
    init();
}
...
void
OAIBTPExpressionGroup-241::init() {
    atomic = false;
    ...
    content = new OAIBTPExpression-9();
    m_content_isSet = false;
}

void
OAIBTPExpressionGroup-241::cleanup() {
...
OAIBTPExpressionGroup-241*
OAIBTPExpressionGroup-241::fromJson(QString json) {
...
void
OAIBTPExpressionGroup-241::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&content, pJson["content"], "OAIBTPExpression-9", "OAIBTPExpression-9");
    
}

QString
OAIBTPExpressionGroup-241::asJson ()
{
...
QJsonObject
OAIBTPExpressionGroup-241::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
    ...
    if((content != nullptr) && (content->isSet())){
        toJsonValue(QString("content"), content, obj, QString("OAIBTPExpression-9"));
    }
...
bool
OAIBTPExpressionGroup-241::isAtomic() {
    return atomic;
}
void
OAIBTPExpressionGroup-241::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPExpressionGroup-241::getBtType() {
    return bt_type;
}
void
OAIBTPExpressionGroup-241::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPExpressionGroup-241::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPExpressionGroup-241::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPExpressionGroup-241::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPExpressionGroup-241::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPExpressionGroup-241::getNodeId() {
    return node_id;
}
void
OAIBTPExpressionGroup-241::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPExpressionGroup-241::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPExpressionGroup-241::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpressionGroup-241::getSpaceAfter() {
    return space_after;
}
void
OAIBTPExpressionGroup-241::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPExpressionGroup-241::getSpaceBefore() {
    return space_before;
}
void
OAIBTPExpressionGroup-241::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPExpressionGroup-241::isSpaceDefault() {
    return space_default;
}
void
OAIBTPExpressionGroup-241::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPExpressionGroup-241::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPExpressionGroup-241::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPExpression-9*
OAIBTPExpressionGroup-241::getContent() {
    return content;
}
void
OAIBTPExpressionGroup-241::setContent(OAIBTPExpression-9* content) {
...
bool
OAIBTPExpressionGroup-241::isSet(){

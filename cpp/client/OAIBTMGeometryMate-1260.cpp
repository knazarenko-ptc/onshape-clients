...
OAIBTMGeometryMate-1260::OAIBTMGeometryMate-1260(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMGeometryMate-1260::OAIBTMGeometryMate-1260() {
    init();
}
...
void
OAIBTMGeometryMate-1260::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMGeometryMate-1260*
OAIBTMGeometryMate-1260::fromJson(QString json) {
...
void
OAIBTMGeometryMate-1260::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTMGeometryMate-1260::asJson ()
{
...
QJsonObject
OAIBTMGeometryMate-1260::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIBTMGeometryMate-1260::getBtType() {
    return bt_type;
}
void
OAIBTMGeometryMate-1260::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMGeometryMate-1260::getFeatureId() {
    return feature_id;
}
void
OAIBTMGeometryMate-1260::setFeatureId(QString* feature_id) {
    this->feature_id = feature_id;
    this->m_feature_id_isSet = true;
}

QString*
OAIBTMGeometryMate-1260::getFeatureType() {
    return feature_type;
}
void
OAIBTMGeometryMate-1260::setFeatureType(QString* feature_type) {
    this->feature_type = feature_type;
    this->m_feature_type_isSet = true;
}

QString*
OAIBTMGeometryMate-1260::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMGeometryMate-1260::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMGeometryMate-1260::getName() {
    return name;
}
void
OAIBTMGeometryMate-1260::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString*
OAIBTMGeometryMate-1260::getNamespace() {
    return _namespace;
}
void
OAIBTMGeometryMate-1260::setNamespace(QString* _namespace) {
    this->_namespace = _namespace;
    this->m__namespace_isSet = true;
}

QString*
OAIBTMGeometryMate-1260::getNodeId() {
    return node_id;
}
void
OAIBTMGeometryMate-1260::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QList<OAIBTMParameter-1*>*
OAIBTMGeometryMate-1260::getParameters() {
    return parameters;
}
void
OAIBTMGeometryMate-1260::setParameters(QList<OAIBTMParameter-1*>* parameters) {
    this->parameters = parameters;
    this->m_parameters_isSet = true;
}

bool
OAIBTMGeometryMate-1260::isReturnAfterSubfeatures() {
    return return_after_subfeatures;
}
void
OAIBTMGeometryMate-1260::setReturnAfterSubfeatures(bool return_after_subfeatures) {
    this->return_after_subfeatures = return_after_subfeatures;
    this->m_return_after_subfeatures_isSet = true;
}

QList<OAIBTMFeature-134*>*
OAIBTMGeometryMate-1260::getSubFeatures() {
    return sub_features;
}
void
OAIBTMGeometryMate-1260::setSubFeatures(QList<OAIBTMFeature-134*>* sub_features) {
    this->sub_features = sub_features;
    this->m_sub_features_isSet = true;
}

bool
OAIBTMGeometryMate-1260::isSuppressed() {
    return suppressed;
}
void
OAIBTMGeometryMate-1260::setSuppressed(bool suppressed) {
    this->suppressed = suppressed;
    this->m_suppressed_isSet = true;
}

bool
OAIBTMGeometryMate-1260::isAuxiliaryAssemblyFeature() {
    return auxiliary_assembly_feature;
}
void
OAIBTMGeometryMate-1260::setAuxiliaryAssemblyFeature(bool auxiliary_assembly_feature) {
    this->auxiliary_assembly_feature = auxiliary_assembly_feature;
    this->m_auxiliary_assembly_feature_isSet = true;
}

qint32
OAIBTMGeometryMate-1260::getFeatureListFieldIndex() {
    return feature_list_field_index;
}
void
OAIBTMGeometryMate-1260::setFeatureListFieldIndex(qint32 feature_list_field_index) {
...
OAIBTMGeometryMate-1260::getOccurrenceQueriesFromAllConfigurations() {
    return occurrence_queries_from_all_configurations;
}
void
OAIBTMGeometryMate-1260::setOccurrenceQueriesFromAllConfigurations(QList<OAIBTMIndividualQueryWithOccurrenceBase-904*>* occurrence_queries_from_all_configurations) {
...
qint32
OAIBTMGeometryMate-1260::getVersion() {
    return version;
}
void
OAIBTMGeometryMate-1260::setVersion(qint32 version) {

...
/*
 * OAIBTPExpressionIs-242.h
 *
 * 
 */

#ifndef OAIBTPExpressionIs-242_H_
#define OAIBTPExpressionIs-242_H_
...
class OAIBTPExpressionIs-242: public OAIObject {
public:
    OAIBTPExpressionIs-242();
    OAIBTPExpressionIs-242(QString json);
    ~OAIBTPExpressionIs-242();
    void init();
    void cleanup();
    ...
    OAIBTPExpressionIs-242* fromJson(QString jsonString) override;
...
#endif /* OAIBTPExpressionIs-242_H_ */

...
OAIBTParameterSpecReference-2789::OAIBTParameterSpecReference-2789(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecReference-2789::OAIBTParameterSpecReference-2789() {
    init();
}
...
void
OAIBTParameterSpecReference-2789::init() {
...
void
OAIBTParameterSpecReference-2789::cleanup() {
...
OAIBTParameterSpecReference-2789*
OAIBTParameterSpecReference-2789::fromJson(QString json) {
...
void
OAIBTParameterSpecReference-2789::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTParameterSpecReference-2789::asJson ()
{
...
QJsonObject
OAIBTParameterSpecReference-2789::asJsonObject() {
    QJsonObject obj;
...
qint32
OAIBTParameterSpecReference-2789::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecReference-2789::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecReference-2789::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecReference-2789::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecReference-2789::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecReference-2789::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecReference-2789::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecReference-2789::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecReference-2789::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecReference-2789::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecReference-2789::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecReference-2789::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecReference-2789::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecReference-2789::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecReference-2789::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecReference-2789::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecReference-2789::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecReference-2789::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReference-2789::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecReference-2789::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecReference-2789::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecReference-2789::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecReference-2789::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecReference-2789::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecReference-2789::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecReference-2789::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
...
bool
OAIBTParameterSpecReference-2789::isSet(){

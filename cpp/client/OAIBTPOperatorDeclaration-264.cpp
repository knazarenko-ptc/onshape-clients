...
OAIBTPOperatorDeclaration-264::OAIBTPOperatorDeclaration-264(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPOperatorDeclaration-264::OAIBTPOperatorDeclaration-264() {
    init();
}
...
void
OAIBTPOperatorDeclaration-264::init() {
    atomic = false;
...
void
OAIBTPOperatorDeclaration-264::cleanup() {
...
OAIBTPOperatorDeclaration-264*
OAIBTPOperatorDeclaration-264::fromJson(QString json) {
...
void
OAIBTPOperatorDeclaration-264::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPOperatorDeclaration-264::asJson ()
{
...
QJsonObject
OAIBTPOperatorDeclaration-264::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPOperatorDeclaration-264::isAtomic() {
    return atomic;
}
void
OAIBTPOperatorDeclaration-264::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPOperatorDeclaration-264::getBtType() {
    return bt_type;
}
void
OAIBTPOperatorDeclaration-264::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPOperatorDeclaration-264::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPOperatorDeclaration-264::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPOperatorDeclaration-264::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPOperatorDeclaration-264::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPOperatorDeclaration-264::getNodeId() {
    return node_id;
}
void
OAIBTPOperatorDeclaration-264::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPOperatorDeclaration-264::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPOperatorDeclaration-264::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPOperatorDeclaration-264::getSpaceAfter() {
    return space_after;
}
void
OAIBTPOperatorDeclaration-264::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPOperatorDeclaration-264::getSpaceBefore() {
    return space_before;
}
void
OAIBTPOperatorDeclaration-264::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPOperatorDeclaration-264::isSpaceDefault() {
    return space_default;
}
void
OAIBTPOperatorDeclaration-264::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPOperatorDeclaration-264::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPOperatorDeclaration-264::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

bool
OAIBTPOperatorDeclaration-264::isDeprecated() {
    return deprecated;
}
void
OAIBTPOperatorDeclaration-264::setDeprecated(bool deprecated) {
    this->deprecated = deprecated;
    this->m_deprecated_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPOperatorDeclaration-264::getSymbolName() {
    return symbol_name;
}
void
OAIBTPOperatorDeclaration-264::setSymbolName(OAIBTPIdentifier-8* symbol_name) {
    this->symbol_name = symbol_name;
    this->m_symbol_name_isSet = true;
}

QList<OAIBTPArgumentDeclaration-232*>*
OAIBTPOperatorDeclaration-264::getArgumentsToDocument() {
    return arguments_to_document;
}
void
OAIBTPOperatorDeclaration-264::setArgumentsToDocument(QList<OAIBTPArgumentDeclaration-232*>* arguments_to_document) {
    this->arguments_to_document = arguments_to_document;
    this->m_arguments_to_document_isSet = true;
}

QString*
OAIBTPOperatorDeclaration-264::getDeprecatedExplanation() {
    return deprecated_explanation;
}
void
OAIBTPOperatorDeclaration-264::setDeprecatedExplanation(QString* deprecated_explanation) {
    this->deprecated_explanation = deprecated_explanation;
    this->m_deprecated_explanation_isSet = true;
}

bool
OAIBTPOperatorDeclaration-264::isForExport() {
    return for_export;
}
void
OAIBTPOperatorDeclaration-264::setForExport(bool for_export) {
    this->for_export = for_export;
    this->m_for_export_isSet = true;
}

OAIBTPSpace-10*
OAIBTPOperatorDeclaration-264::getSpaceAfterExport() {
    return space_after_export;
}
void
OAIBTPOperatorDeclaration-264::setSpaceAfterExport(OAIBTPSpace-10* space_after_export) {
    this->space_after_export = space_after_export;
    this->m_space_after_export_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPOperatorDeclaration-264::getAnnotation() {
    return annotation;
}
void
OAIBTPOperatorDeclaration-264::setAnnotation(OAIBTPAnnotation-231* annotation) {
    this->annotation = annotation;
    this->m_annotation_isSet = true;
}

OAIBTPStatementBlock-271*
OAIBTPOperatorDeclaration-264::getBody() {
    return body;
}
void
OAIBTPOperatorDeclaration-264::setBody(OAIBTPStatementBlock-271* body) {
    this->body = body;
    this->m_body_isSet = true;
}

QList<OAIBTPArgumentDeclaration-232*>*
OAIBTPOperatorDeclaration-264::getArguments() {
    return arguments;
}
void
OAIBTPOperatorDeclaration-264::setArguments(QList<OAIBTPArgumentDeclaration-232*>* arguments) {
    this->arguments = arguments;
    this->m_arguments_isSet = true;
}

OAIBTPStatement-269*
OAIBTPOperatorDeclaration-264::getPrecondition() {
    return precondition;
}
void
OAIBTPOperatorDeclaration-264::setPrecondition(OAIBTPStatement-269* precondition) {
    this->precondition = precondition;
    this->m_precondition_isSet = true;
}

OAIBTPSpace-10*
OAIBTPOperatorDeclaration-264::getSpaceAfterArglist() {
    return space_after_arglist;
}
void
OAIBTPOperatorDeclaration-264::setSpaceAfterArglist(OAIBTPSpace-10* space_after_arglist) {
    this->space_after_arglist = space_after_arglist;
    this->m_space_after_arglist_isSet = true;
}

OAIBTPSpace-10*
OAIBTPOperatorDeclaration-264::getSpaceInEmptyList() {
    return space_in_empty_list;
}
void
OAIBTPOperatorDeclaration-264::setSpaceInEmptyList(OAIBTPSpace-10* space_in_empty_list) {
    this->space_in_empty_list = space_in_empty_list;
    this->m_space_in_empty_list_isSet = true;
}

OAIBTPTypeName-290*
OAIBTPOperatorDeclaration-264::getReturnType() {
    return return_type;
}
void
OAIBTPOperatorDeclaration-264::setReturnType(OAIBTPTypeName-290* return_type) {
    this->return_type = return_type;
    this->m_return_type_isSet = true;
}

QString*
OAIBTPOperatorDeclaration-264::getOperator() {
    return _operator;
}
void
OAIBTPOperatorDeclaration-264::setOperator(QString* _operator) {
    this->_operator = _operator;
    this->m__operator_isSet = true;
}

OAIBTPSpace-10*
OAIBTPOperatorDeclaration-264::getSpaceBeforeOperator() {
    return space_before_operator;
}
void
OAIBTPOperatorDeclaration-264::setSpaceBeforeOperator(OAIBTPSpace-10* space_before_operator) {
    this->space_before_operator = space_before_operator;
    this->m_space_before_operator_isSet = true;
}

OAIBTPSpace-10*
OAIBTPOperatorDeclaration-264::getSpaceAfterOperator() {
    return space_after_operator;
}
void
OAIBTPOperatorDeclaration-264::setSpaceAfterOperator(OAIBTPSpace-10* space_after_operator) {
...
bool
OAIBTPOperatorDeclaration-264::isSet(){

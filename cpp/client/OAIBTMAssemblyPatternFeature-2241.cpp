...
OAIBTMAssemblyPatternFeature-2241::OAIBTMAssemblyPatternFeature-2241(QString json) {
    init();
    this->fromJson(json);
}

OAIBTMAssemblyPatternFeature-2241::OAIBTMAssemblyPatternFeature-2241() {
    init();
}
...
void
OAIBTMAssemblyPatternFeature-2241::init() {
    bt_type = new QString("");
    ...
    pattern_type = new QString("");
    m_pattern_type_isSet = false;
}

void
OAIBTMAssemblyPatternFeature-2241::cleanup() {
    if(bt_type != nullptr) { 
        delete bt_type;
    }
...
OAIBTMAssemblyPatternFeature-2241*
OAIBTMAssemblyPatternFeature-2241::fromJson(QString json) {
...
void
OAIBTMAssemblyPatternFeature-2241::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&pattern_type, pJson["patternType"], "QString", "QString");
    
}

QString
OAIBTMAssemblyPatternFeature-2241::asJson ()
{
...
QJsonObject
OAIBTMAssemblyPatternFeature-2241::asJsonObject() {
    QJsonObject obj;
    ...
    if(pattern_type != nullptr && *pattern_type != QString("")){
        toJsonValue(QString("patternType"), pattern_type, obj, QString("QString"));
    }
...
QString*
OAIBTMAssemblyPatternFeature-2241::getBtType() {
    return bt_type;
}
void
OAIBTMAssemblyPatternFeature-2241::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTMAssemblyPatternFeature-2241::getFeatureId() {
    return feature_id;
}
void
OAIBTMAssemblyPatternFeature-2241::setFeatureId(QString* feature_id) {
    this->feature_id = feature_id;
    this->m_feature_id_isSet = true;
}

QString*
OAIBTMAssemblyPatternFeature-2241::getFeatureType() {
    return feature_type;
}
void
OAIBTMAssemblyPatternFeature-2241::setFeatureType(QString* feature_type) {
    this->feature_type = feature_type;
    this->m_feature_type_isSet = true;
}

QString*
OAIBTMAssemblyPatternFeature-2241::getImportMicroversion() {
    return import_microversion;
}
void
OAIBTMAssemblyPatternFeature-2241::setImportMicroversion(QString* import_microversion) {
    this->import_microversion = import_microversion;
    this->m_import_microversion_isSet = true;
}

QString*
OAIBTMAssemblyPatternFeature-2241::getName() {
    return name;
}
void
OAIBTMAssemblyPatternFeature-2241::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString*
OAIBTMAssemblyPatternFeature-2241::getNamespace() {
    return _namespace;
}
void
OAIBTMAssemblyPatternFeature-2241::setNamespace(QString* _namespace) {
    this->_namespace = _namespace;
    this->m__namespace_isSet = true;
}

QString*
OAIBTMAssemblyPatternFeature-2241::getNodeId() {
    return node_id;
}
void
OAIBTMAssemblyPatternFeature-2241::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QList<OAIBTMParameter-1*>*
OAIBTMAssemblyPatternFeature-2241::getParameters() {
    return parameters;
}
void
OAIBTMAssemblyPatternFeature-2241::setParameters(QList<OAIBTMParameter-1*>* parameters) {
    this->parameters = parameters;
    this->m_parameters_isSet = true;
}

bool
OAIBTMAssemblyPatternFeature-2241::isReturnAfterSubfeatures() {
    return return_after_subfeatures;
}
void
OAIBTMAssemblyPatternFeature-2241::setReturnAfterSubfeatures(bool return_after_subfeatures) {
    this->return_after_subfeatures = return_after_subfeatures;
    this->m_return_after_subfeatures_isSet = true;
}

QList<OAIBTMFeature-134*>*
OAIBTMAssemblyPatternFeature-2241::getSubFeatures() {
    return sub_features;
}
void
OAIBTMAssemblyPatternFeature-2241::setSubFeatures(QList<OAIBTMFeature-134*>* sub_features) {
    this->sub_features = sub_features;
    this->m_sub_features_isSet = true;
}

bool
OAIBTMAssemblyPatternFeature-2241::isSuppressed() {
    return suppressed;
}
void
OAIBTMAssemblyPatternFeature-2241::setSuppressed(bool suppressed) {
    this->suppressed = suppressed;
    this->m_suppressed_isSet = true;
}

bool
OAIBTMAssemblyPatternFeature-2241::isAuxiliaryAssemblyFeature() {
    return auxiliary_assembly_feature;
}
void
OAIBTMAssemblyPatternFeature-2241::setAuxiliaryAssemblyFeature(bool auxiliary_assembly_feature) {
    this->auxiliary_assembly_feature = auxiliary_assembly_feature;
    this->m_auxiliary_assembly_feature_isSet = true;
}

qint32
OAIBTMAssemblyPatternFeature-2241::getFeatureListFieldIndex() {
    return feature_list_field_index;
}
void
OAIBTMAssemblyPatternFeature-2241::setFeatureListFieldIndex(qint32 feature_list_field_index) {
...
OAIBTMAssemblyPatternFeature-2241::getOccurrenceQueriesFromAllConfigurations() {
    return occurrence_queries_from_all_configurations;
}
void
OAIBTMAssemblyPatternFeature-2241::setOccurrenceQueriesFromAllConfigurations(QList<OAIBTMIndividualQueryWithOccurrenceBase-904*>* occurrence_queries_from_all_configurations) {
...
qint32
OAIBTMAssemblyPatternFeature-2241::getVersion() {
    return version;
}
void
OAIBTMAssemblyPatternFeature-2241::setVersion(qint32 version) {
    this->version = version;
    this->m_version_isSet = true;
}

QString*
OAIBTMAssemblyPatternFeature-2241::getPatternType() {
    return pattern_type;
}
void
OAIBTMAssemblyPatternFeature-2241::setPatternType(QString* pattern_type) {
    this->pattern_type = pattern_type;
    this->m_pattern_type_isSet = true;
}


bool
OAIBTMAssemblyPatternFeature-2241::isSet(){
    ...
    do{
        ...
        if(pattern_type != nullptr && *pattern_type != QString("")){ isObjectUpdated = true; break;}
    }while(false);

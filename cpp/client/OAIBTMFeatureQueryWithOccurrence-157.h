...
/*
 * OAIBTMFeatureQueryWithOccurrence-157.h
 *
 * 
 */

#ifndef OAIBTMFeatureQueryWithOccurrence-157_H_
#define OAIBTMFeatureQueryWithOccurrence-157_H_
...
class OAIBTMFeatureQueryWithOccurrence-157: public OAIObject {
public:
    OAIBTMFeatureQueryWithOccurrence-157();
    OAIBTMFeatureQueryWithOccurrence-157(QString json);
    ~OAIBTMFeatureQueryWithOccurrence-157();
    void init();
    void cleanup();
    ...
    OAIBTMFeatureQueryWithOccurrence-157* fromJson(QString jsonString) override;
...
#endif /* OAIBTMFeatureQueryWithOccurrence-157_H_ */

...
/*
 * OAIBTPLiteralNumber-258.h
 *
 * 
 */

#ifndef OAIBTPLiteralNumber-258_H_
#define OAIBTPLiteralNumber-258_H_
...
class OAIBTPLiteralNumber-258: public OAIObject {
public:
    OAIBTPLiteralNumber-258();
    OAIBTPLiteralNumber-258(QString json);
    ~OAIBTPLiteralNumber-258();
    void init();
    void cleanup();
    ...
    OAIBTPLiteralNumber-258* fromJson(QString jsonString) override;
...
#endif /* OAIBTPLiteralNumber-258_H_ */

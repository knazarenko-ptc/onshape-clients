...
OAIBTPTopLevelTypeDeclaration-287::OAIBTPTopLevelTypeDeclaration-287(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPTopLevelTypeDeclaration-287::OAIBTPTopLevelTypeDeclaration-287() {
    init();
}
...
void
OAIBTPTopLevelTypeDeclaration-287::init() {
    atomic = false;
...
void
OAIBTPTopLevelTypeDeclaration-287::cleanup() {
...
OAIBTPTopLevelTypeDeclaration-287::fromJson(QString json) {
...
void
OAIBTPTopLevelTypeDeclaration-287::fromJsonObject(QJsonObject pJson) {
...
QString
OAIBTPTopLevelTypeDeclaration-287::asJson ()
{
...
QJsonObject
OAIBTPTopLevelTypeDeclaration-287::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
...
bool
OAIBTPTopLevelTypeDeclaration-287::isAtomic() {
    return atomic;
}
void
OAIBTPTopLevelTypeDeclaration-287::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPTopLevelTypeDeclaration-287::getBtType() {
    return bt_type;
}
void
OAIBTPTopLevelTypeDeclaration-287::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPTopLevelTypeDeclaration-287::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPTopLevelTypeDeclaration-287::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPTopLevelTypeDeclaration-287::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPTopLevelTypeDeclaration-287::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPTopLevelTypeDeclaration-287::getNodeId() {
    return node_id;
}
void
OAIBTPTopLevelTypeDeclaration-287::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPTopLevelTypeDeclaration-287::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPTopLevelTypeDeclaration-287::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPTopLevelTypeDeclaration-287::getSpaceAfter() {
    return space_after;
}
void
OAIBTPTopLevelTypeDeclaration-287::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPTopLevelTypeDeclaration-287::getSpaceBefore() {
    return space_before;
}
void
OAIBTPTopLevelTypeDeclaration-287::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPTopLevelTypeDeclaration-287::isSpaceDefault() {
    return space_default;
}
void
OAIBTPTopLevelTypeDeclaration-287::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPTopLevelTypeDeclaration-287::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPTopLevelTypeDeclaration-287::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

bool
OAIBTPTopLevelTypeDeclaration-287::isDeprecated() {
    return deprecated;
}
void
OAIBTPTopLevelTypeDeclaration-287::setDeprecated(bool deprecated) {
    this->deprecated = deprecated;
    this->m_deprecated_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPTopLevelTypeDeclaration-287::getSymbolName() {
    return symbol_name;
}
void
OAIBTPTopLevelTypeDeclaration-287::setSymbolName(OAIBTPIdentifier-8* symbol_name) {
    this->symbol_name = symbol_name;
    this->m_symbol_name_isSet = true;
}

QList<OAIBTPArgumentDeclaration-232*>*
OAIBTPTopLevelTypeDeclaration-287::getArgumentsToDocument() {
    return arguments_to_document;
}
void
OAIBTPTopLevelTypeDeclaration-287::setArgumentsToDocument(QList<OAIBTPArgumentDeclaration-232*>* arguments_to_document) {
    this->arguments_to_document = arguments_to_document;
    this->m_arguments_to_document_isSet = true;
}

QString*
OAIBTPTopLevelTypeDeclaration-287::getDeprecatedExplanation() {
    return deprecated_explanation;
}
void
OAIBTPTopLevelTypeDeclaration-287::setDeprecatedExplanation(QString* deprecated_explanation) {
    this->deprecated_explanation = deprecated_explanation;
    this->m_deprecated_explanation_isSet = true;
}

bool
OAIBTPTopLevelTypeDeclaration-287::isForExport() {
    return for_export;
}
void
OAIBTPTopLevelTypeDeclaration-287::setForExport(bool for_export) {
    this->for_export = for_export;
    this->m_for_export_isSet = true;
}

OAIBTPSpace-10*
OAIBTPTopLevelTypeDeclaration-287::getSpaceAfterExport() {
    return space_after_export;
}
void
OAIBTPTopLevelTypeDeclaration-287::setSpaceAfterExport(OAIBTPSpace-10* space_after_export) {
    this->space_after_export = space_after_export;
    this->m_space_after_export_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPTopLevelTypeDeclaration-287::getAnnotation() {
    return annotation;
}
void
OAIBTPTopLevelTypeDeclaration-287::setAnnotation(OAIBTPAnnotation-231* annotation) {
    this->annotation = annotation;
    this->m_annotation_isSet = true;
}

OAIBTPSpace-10*
OAIBTPTopLevelTypeDeclaration-287::getSpaceAfterVersion() {
    return space_after_version;
}
void
OAIBTPTopLevelTypeDeclaration-287::setSpaceAfterVersion(OAIBTPSpace-10* space_after_version) {
    this->space_after_version = space_after_version;
    this->m_space_after_version_isSet = true;
}

OAIBTPLiteralNumber-258*
OAIBTPTopLevelTypeDeclaration-287::getVersion() {
    return version;
}
void
OAIBTPTopLevelTypeDeclaration-287::setVersion(OAIBTPLiteralNumber-258* version) {
    this->version = version;
    this->m_version_isSet = true;
}

OAIBTPIdentifier-8*
OAIBTPTopLevelTypeDeclaration-287::getName() {
    return name;
}
void
OAIBTPTopLevelTypeDeclaration-287::setName(OAIBTPIdentifier-8* name) {
    this->name = name;
...
bool
OAIBTPTopLevelTypeDeclaration-287::isSet(){

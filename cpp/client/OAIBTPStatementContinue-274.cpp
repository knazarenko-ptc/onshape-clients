...
OAIBTPStatementContinue-274::OAIBTPStatementContinue-274(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPStatementContinue-274::OAIBTPStatementContinue-274() {
    init();
}
...
void
OAIBTPStatementContinue-274::init() {
    atomic = false;
    ...
    space_after_continue = new OAIBTPSpace-10();
    m_space_after_continue_isSet = false;
}

void
OAIBTPStatementContinue-274::cleanup() {
    ...
    if(space_after_continue != nullptr) { 
        delete space_after_continue;
    }
}

OAIBTPStatementContinue-274*
OAIBTPStatementContinue-274::fromJson(QString json) {
...
void
OAIBTPStatementContinue-274::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&space_after_continue, pJson["spaceAfterContinue"], "OAIBTPSpace-10", "OAIBTPSpace-10");
    
}

QString
OAIBTPStatementContinue-274::asJson ()
{
...
QJsonObject
OAIBTPStatementContinue-274::asJsonObject() {
    QJsonObject obj;
    if(m_atomic_isSet){
    ...
    if((space_after_continue != nullptr) && (space_after_continue->isSet())){
        toJsonValue(QString("spaceAfterContinue"), space_after_continue, obj, QString("OAIBTPSpace-10"));
    }
...
bool
OAIBTPStatementContinue-274::isAtomic() {
    return atomic;
}
void
OAIBTPStatementContinue-274::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPStatementContinue-274::getBtType() {
    return bt_type;
}
void
OAIBTPStatementContinue-274::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPStatementContinue-274::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPStatementContinue-274::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPStatementContinue-274::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPStatementContinue-274::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPStatementContinue-274::getNodeId() {
    return node_id;
}
void
OAIBTPStatementContinue-274::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPStatementContinue-274::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPStatementContinue-274::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementContinue-274::getSpaceAfter() {
    return space_after;
}
void
OAIBTPStatementContinue-274::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementContinue-274::getSpaceBefore() {
    return space_before;
}
void
OAIBTPStatementContinue-274::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPStatementContinue-274::isSpaceDefault() {
    return space_default;
}
void
OAIBTPStatementContinue-274::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPStatementContinue-274::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPStatementContinue-274::setStartSourceLocation(qint32 start_source_location) {
    this->start_source_location = start_source_location;
    this->m_start_source_location_isSet = true;
}

OAIBTPAnnotation-231*
OAIBTPStatementContinue-274::getAnnotation() {
    return annotation;
}
void
OAIBTPStatementContinue-274::setAnnotation(OAIBTPAnnotation-231* annotation) {
    this->annotation = annotation;
    this->m_annotation_isSet = true;
}

OAIBTPSpace-10*
OAIBTPStatementContinue-274::getSpaceAfterContinue() {
    return space_after_continue;
}
void
OAIBTPStatementContinue-274::setSpaceAfterContinue(OAIBTPSpace-10* space_after_continue) {
    this->space_after_continue = space_after_continue;
    this->m_space_after_continue_isSet = true;
}


bool
OAIBTPStatementContinue-274::isSet(){
    ...
    do{
        ...
        if(space_after_continue != nullptr && space_after_continue->isSet()){ isObjectUpdated = true; break;}
    }while(false);

...
OAIBTPNode-7::OAIBTPNode-7(QString json) {
    init();
    this->fromJson(json);
}

OAIBTPNode-7::OAIBTPNode-7() {
    init();
}
...
OAIBTPNode-7*
OAIBTPNode-7::fromJson(QString json) {
...
void
OAIBTPNode-7::fromJsonObject(QJsonObject pJson) {
...
bool
OAIBTPNode-7::isAtomic() {
    return atomic;
}
void
OAIBTPNode-7::setAtomic(bool atomic) {
    this->atomic = atomic;
    this->m_atomic_isSet = true;
}

QString*
OAIBTPNode-7::getBtType() {
    return bt_type;
}
void
OAIBTPNode-7::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTPNode-7::getDocumentationType() {
    return documentation_type;
}
void
OAIBTPNode-7::setDocumentationType(QString* documentation_type) {
    this->documentation_type = documentation_type;
    this->m_documentation_type_isSet = true;
}

qint32
OAIBTPNode-7::getEndSourceLocation() {
    return end_source_location;
}
void
OAIBTPNode-7::setEndSourceLocation(qint32 end_source_location) {
    this->end_source_location = end_source_location;
    this->m_end_source_location_isSet = true;
}

QString*
OAIBTPNode-7::getNodeId() {
    return node_id;
}
void
OAIBTPNode-7::setNodeId(QString* node_id) {
    this->node_id = node_id;
    this->m_node_id_isSet = true;
}

QString*
OAIBTPNode-7::getShortDescriptor() {
    return short_descriptor;
}
void
OAIBTPNode-7::setShortDescriptor(QString* short_descriptor) {
    this->short_descriptor = short_descriptor;
    this->m_short_descriptor_isSet = true;
}

OAIBTPSpace-10*
OAIBTPNode-7::getSpaceAfter() {
    return space_after;
}
void
OAIBTPNode-7::setSpaceAfter(OAIBTPSpace-10* space_after) {
    this->space_after = space_after;
    this->m_space_after_isSet = true;
}

OAIBTPSpace-10*
OAIBTPNode-7::getSpaceBefore() {
    return space_before;
}
void
OAIBTPNode-7::setSpaceBefore(OAIBTPSpace-10* space_before) {
    this->space_before = space_before;
    this->m_space_before_isSet = true;
}

bool
OAIBTPNode-7::isSpaceDefault() {
    return space_default;
}
void
OAIBTPNode-7::setSpaceDefault(bool space_default) {
    this->space_default = space_default;
    this->m_space_default_isSet = true;
}

qint32
OAIBTPNode-7::getStartSourceLocation() {
    return start_source_location;
}
void
OAIBTPNode-7::setStartSourceLocation(qint32 start_source_location) {

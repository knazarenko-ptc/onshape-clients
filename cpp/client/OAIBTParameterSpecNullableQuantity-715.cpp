...
OAIBTParameterSpecNullableQuantity-715::OAIBTParameterSpecNullableQuantity-715(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecNullableQuantity-715::OAIBTParameterSpecNullableQuantity-715() {
    init();
}
...
void
OAIBTParameterSpecNullableQuantity-715::init() {
    ...
    ranges = new QList<OAIBTNullableQuantityRange-1340*>();
    m_ranges_isSet = false;
}

void
OAIBTParameterSpecNullableQuantity-715::cleanup() {
...
OAIBTParameterSpecNullableQuantity-715*
OAIBTParameterSpecNullableQuantity-715::fromJson(QString json) {
...
void
OAIBTParameterSpecNullableQuantity-715::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&ranges, pJson["ranges"], "QList", "OAIBTNullableQuantityRange-1340");
}

QString
OAIBTParameterSpecNullableQuantity-715::asJson ()
{
...
QJsonObject
OAIBTParameterSpecNullableQuantity-715::asJsonObject() {
    QJsonObject obj;
    ...
    if(ranges->size() > 0){
        toJsonArray((QList<void*>*)ranges, obj, "ranges", "OAIBTNullableQuantityRange-1340");
    }
...
qint32
OAIBTParameterSpecNullableQuantity-715::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecNullableQuantity-715::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecNullableQuantity-715::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecNullableQuantity-715::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecNullableQuantity-715::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecNullableQuantity-715::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecNullableQuantity-715::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecNullableQuantity-715::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecNullableQuantity-715::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecNullableQuantity-715::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecNullableQuantity-715::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecNullableQuantity-715::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecNullableQuantity-715::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecNullableQuantity-715::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecNullableQuantity-715::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecNullableQuantity-715::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecNullableQuantity-715::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecNullableQuantity-715::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
    this->visibility_condition = visibility_condition;
    this->m_visibility_condition_isSet = true;
}

QString*
OAIBTParameterSpecNullableQuantity-715::getQuantityType() {
    return quantity_type;
}
void
OAIBTParameterSpecNullableQuantity-715::setQuantityType(QString* quantity_type) {
    this->quantity_type = quantity_type;
    this->m_quantity_type_isSet = true;
}

QList<OAIBTNullableQuantityRange-1340*>*
OAIBTParameterSpecNullableQuantity-715::getRanges() {
    return ranges;
}
void
OAIBTParameterSpecNullableQuantity-715::setRanges(QList<OAIBTNullableQuantityRange-1340*>* ranges) {
    this->ranges = ranges;
...
bool
OAIBTParameterSpecNullableQuantity-715::isSet(){

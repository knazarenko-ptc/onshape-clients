...
OAIBTParameterSpecArray-2600::OAIBTParameterSpecArray-2600(QString json) {
    init();
    this->fromJson(json);
}

OAIBTParameterSpecArray-2600::OAIBTParameterSpecArray-2600() {
    init();
}
...
void
OAIBTParameterSpecArray-2600::init() {
    ...
    item_label_template = new QString("");
    m_item_label_template_isSet = false;
    driven_query = new QString("");
    m_driven_query_isSet = false;
}

void
OAIBTParameterSpecArray-2600::cleanup() {
    ...
    if(item_label_template != nullptr) { 
        delete item_label_template;
    }
    if(driven_query != nullptr) { 
        delete driven_query;
    }
}

OAIBTParameterSpecArray-2600*
OAIBTParameterSpecArray-2600::fromJson(QString json) {
...
void
OAIBTParameterSpecArray-2600::fromJsonObject(QJsonObject pJson) {
    ...
    ::OpenAPI::setValue(&item_name, pJson["itemName"], "QString", "QString");
    
    ::OpenAPI::setValue(&item_label_template, pJson["itemLabelTemplate"], "QString", "QString");
    
    ::OpenAPI::setValue(&driven_query, pJson["drivenQuery"], "QString", "QString");
    
}

QString
OAIBTParameterSpecArray-2600::asJson ()
{
...
QJsonObject
OAIBTParameterSpecArray-2600::asJsonObject() {
    QJsonObject obj;
    ...
    if(item_name != nullptr && *item_name != QString("")){
        toJsonValue(QString("itemName"), item_name, obj, QString("QString"));
    }
    if(item_label_template != nullptr && *item_label_template != QString("")){
        toJsonValue(QString("itemLabelTemplate"), item_label_template, obj, QString("QString"));
    }
    if(driven_query != nullptr && *driven_query != QString("")){
        toJsonValue(QString("drivenQuery"), driven_query, obj, QString("QString"));
    }
...
qint32
OAIBTParameterSpecArray-2600::getAdditionalLocalizedStrings() {
    return additional_localized_strings;
}
void
OAIBTParameterSpecArray-2600::setAdditionalLocalizedStrings(qint32 additional_localized_strings) {
    this->additional_localized_strings = additional_localized_strings;
    this->m_additional_localized_strings_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getBtType() {
    return bt_type;
}
void
OAIBTParameterSpecArray-2600::setBtType(QString* bt_type) {
    this->bt_type = bt_type;
    this->m_bt_type_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getColumnName() {
    return column_name;
}
void
OAIBTParameterSpecArray-2600::setColumnName(QString* column_name) {
    this->column_name = column_name;
    this->m_column_name_isSet = true;
}

OAIBTMParameter-1*
OAIBTParameterSpecArray-2600::getDefaultValue() {
    return default_value;
}
void
OAIBTParameterSpecArray-2600::setDefaultValue(OAIBTMParameter-1* default_value) {
    this->default_value = default_value;
    this->m_default_value_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getIconUri() {
    return icon_uri;
}
void
OAIBTParameterSpecArray-2600::setIconUri(QString* icon_uri) {
    this->icon_uri = icon_uri;
    this->m_icon_uri_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getLocalizableName() {
    return localizable_name;
}
void
OAIBTParameterSpecArray-2600::setLocalizableName(QString* localizable_name) {
    this->localizable_name = localizable_name;
    this->m_localizable_name_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getLocalizedName() {
    return localized_name;
}
void
OAIBTParameterSpecArray-2600::setLocalizedName(QString* localized_name) {
    this->localized_name = localized_name;
    this->m_localized_name_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getParameterId() {
    return parameter_id;
}
void
OAIBTParameterSpecArray-2600::setParameterId(QString* parameter_id) {
    this->parameter_id = parameter_id;
    this->m_parameter_id_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getParameterName() {
    return parameter_name;
}
void
OAIBTParameterSpecArray-2600::setParameterName(QString* parameter_name) {
    this->parameter_name = parameter_name;
    this->m_parameter_name_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecArray-2600::getStringsToLocalize() {
    return strings_to_localize;
}
void
OAIBTParameterSpecArray-2600::setStringsToLocalize(QList<QString*>* strings_to_localize) {
    this->strings_to_localize = strings_to_localize;
    this->m_strings_to_localize_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getUiHint() {
    return ui_hint;
}
void
OAIBTParameterSpecArray-2600::setUiHint(QString* ui_hint) {
    this->ui_hint = ui_hint;
    this->m_ui_hint_isSet = true;
}

QList<QString*>*
OAIBTParameterSpecArray-2600::getUiHints() {
    return ui_hints;
}
void
OAIBTParameterSpecArray-2600::setUiHints(QList<QString*>* ui_hints) {
    this->ui_hints = ui_hints;
    this->m_ui_hints_isSet = true;
}

OAIBTParameterVisibilityCondition-177*
OAIBTParameterSpecArray-2600::getVisibilityCondition() {
    return visibility_condition;
}
void
OAIBTParameterSpecArray-2600::setVisibilityCondition(OAIBTParameterVisibilityCondition-177* visibility_condition) {
    this->visibility_condition = visibility_condition;
    this->m_visibility_condition_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getItemName() {
    return item_name;
}
void
OAIBTParameterSpecArray-2600::setItemName(QString* item_name) {
    this->item_name = item_name;
    this->m_item_name_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getItemLabelTemplate() {
    return item_label_template;
}
void
OAIBTParameterSpecArray-2600::setItemLabelTemplate(QString* item_label_template) {
    this->item_label_template = item_label_template;
    this->m_item_label_template_isSet = true;
}

QString*
OAIBTParameterSpecArray-2600::getDrivenQuery() {
    return driven_query;
}
void
OAIBTParameterSpecArray-2600::setDrivenQuery(QString* driven_query) {
    this->driven_query = driven_query;
    this->m_driven_query_isSet = true;
}


bool
OAIBTParameterSpecArray-2600::isSet(){
    ...
    do{
        ...
        if(item_name != nullptr && *item_name != QString("")){ isObjectUpdated = true; break;}
        if(item_label_template != nullptr && *item_label_template != QString("")){ isObjectUpdated = true; break;}
        if(driven_query != nullptr && *driven_query != QString("")){ isObjectUpdated = true; break;}
    }while(false);
